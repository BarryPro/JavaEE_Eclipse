...
public class OdrLineContVO {
	
	//String gsTableSuffix;
	String gsTopicId;
	byte[] gbContent;
	String gsLoginAct;
	//String gsOpTime;
	...
	public String getGsTimeDelay() {
		return gsTimeDelay;
	}
	public void setGsTimeDelay(String gsTimeDelay) {
		this.gsTimeDelay = gsTimeDelay;
	}
