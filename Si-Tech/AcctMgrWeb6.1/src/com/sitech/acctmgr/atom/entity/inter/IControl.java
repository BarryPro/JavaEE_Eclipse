...
public interface IControl {
	...
	/**
	 * 名称：取公共配置表pub_codedef_dict中多个code_id 功能：用户配置某一类编码，外层调用后直接使用Set.contains()判断值是否存在
	 *
	 */
	 ...
	 */
	boolean isOnLineBill(long id, String sAppName);
	...
	ServerInfo getIdRouteConf(String sIdType, long id, String appType);
