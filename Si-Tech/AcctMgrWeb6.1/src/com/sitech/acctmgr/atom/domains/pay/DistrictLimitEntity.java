...
*  <p>修改日期    修改人   修改目的<p>
*/
public class DistrictLimitEntity {
	
	@JSONField(name="REGION_GROUP")
	@ParamDesc(path="REGION_GROUP",cons=ConsType.CT001,type="String",len="20",desc="地市group",memo="略")
	private String regionGroup;
	
	@JSONField(name="DISTRICT_GROUP")
	@ParamDesc(path="DISTRICT_GROUP",cons=ConsType.CT001,type="String",len="20",desc="区县group",memo="略")
	private String districtGroup;
	
	@JSONField(name="DISTRICT_GROUP_NAME")
	@ParamDesc(path="DISTRICT_GROUP_NAME",cons=ConsType.CT001,type="String",len="100",desc="区县名称",memo="略")
	...
	public String toString() {
		return "DistrictLimitEntity [regionGroup=" + regionGroup
				+ ", districtGroup=" + districtGroup + ", districtGroupName="
				+ districtGroupName + ", limitDayFee=" + limitDayFee
				+ ", limitMonthFee=" + limitMonthFee + ", backedDayFee="
				+ backedDayFee + ", backedMonthFee=" + backedMonthFee
				+ ", limitDayNum=" + limitDayNum + ", limitMonthNum="
				+ limitMonthNum + ", backedDayNum=" + backedDayNum
				+ ", backedMonthNum=" + backedMonthNum + ", limitType="
				+ limitType + ", limitCycle=" + limitCycle + ", opCode="
				+ opCode + ", msgPhone=" + msgPhone + ", msgDayFlag="
				+ msgDayFlag + ", msgMonthFlag=" + msgMonthFlag + "]";
	}
