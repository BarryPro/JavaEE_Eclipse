 ...
 * @version 1.0
 */
public class S8248SubConInvcOutDTO extends CommonOutDTO {
	...
	@JSONField(name = "INVFEE_CFVAL")
	@ParamDesc(path = "INVFEE_CFVAL", cons = ConsType.CT001, type = "long", len = "10", desc = "拆分阀值", memo = "略")
	private long invFeeCfval;

	public long getInvFeeCfval() {
		return invFeeCfval;
	}

	public void setInvFeeCfval(long invFeeCfval) {
		this.invFeeCfval = invFeeCfval;
	}
	...
	public MBean encode() {
		...
		result.setRoot(getPathByProperName("invFeeCfval"), invFeeCfval);
		return result;
	}
}
