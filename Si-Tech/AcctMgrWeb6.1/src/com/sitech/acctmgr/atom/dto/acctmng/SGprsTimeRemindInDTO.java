...
public class SGprsTimeRemindInDTO extends CommonInDTO{
	...
	@ParamDesc(path="BUSI_INFO.CALL_CYCLE",cons=ConsType.QUES,type="String",len="1",desc="提醒周期",memo="略")
	...
	public void decode(MBean arg0){
		...
		setCallCycle(arg0.getObject(getPathByProperName("callCycle")).toString());
	}
	...
	/**
	 * @param callCycle the callCycle to set
	 */
