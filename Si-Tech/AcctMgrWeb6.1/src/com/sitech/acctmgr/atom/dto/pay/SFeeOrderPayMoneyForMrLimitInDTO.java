 ...
 * @version 1.0
 */
public class SFeeOrderPayMoneyForMrLimitInDTO extends CommonInDTO{

	private static final long serialVersionUID = 4307034454736720727L;
	...
	@ParamDesc(path="BUSI_INFO.MKT_PAY_METHOD",cons=ConsType.CT001,type="String",len="20",desc="支付方式",
			memo="正常办理 1 ; D账本转入 2  从默认账户D账本转; 集团统付 4; 统一d帐本转入 5; 转账模式 3  从默认账户现金类账本转")
	private String mktPayMethod;
	...
	public void decode(MBean arg0){
		...
		mktPayMethod = arg0.getStr(getPathByProperName("mktPayMethod"));
	...
	public String getMktPayMethod() {
		return mktPayMethod;
	}


	public void setMktPayMethod(String mktPayMethod) {
		this.mktPayMethod = mktPayMethod;
	}
