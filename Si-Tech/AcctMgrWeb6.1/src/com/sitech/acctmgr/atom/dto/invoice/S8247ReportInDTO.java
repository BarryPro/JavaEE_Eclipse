...
public class S8247ReportInDTO extends CommonInDTO {
	...
	@ParamDesc(path = "BUSI_INFO.INV_NO", cons = ConsType.CT001, type = "string", len = "20", desc = "发票号码", memo = "")
	private String invNo;
	
	@ParamDesc(path = "BUSI_INFO.INV_CODE", cons = ConsType.CT001, type = "string", len = "20", desc = "发票代码", memo = "略")
	private String invCode;
	
	@ParamDesc(path = "BUSI_INFO.REDINV_ORDER_NO", cons = ConsType.CT001, type = "string", len = "20", desc = "红字发票申请单", memo = "略")
