...
public final class CommonConst {
	...
	public static final String USERTYPE_TTBROAD = "4";// 铁通类宽带号码
	...
	public static final String ELE_YC_TYPE = "EPM3001";
	public static final String ELE_MONTH_TYPE = "EMM3001";
	...
	/* 电子发票 */
	public static final String EYCFP_TYPE = "EP"; // E 电子 P 预存
	public static final String EXFFP_TYPE = "EM"; // E 电子 M 月结消费
	public static final String ECHFP_TYPE = "ER"; // E 电子 R 红票
	public static final String EZDYFP_TYPE = "EF"; // E 电子 P 预存
	public static final String USERNAME = "13310101"; // 平台编码
	public static final String PASSWORD = "29829888"; // 密码
	...
	/* 未出帐信息查询代码 */
	public static final String UNBILL_TYPE_VM = "0";
	public static final String UNBILL_TYPE_PRE = "1";
	public static final String UNBILL_TYPE_BILL_TOT = "20";
	public static final String UNBILL_TYPE_BILL_DET = "30";
	public static final String UNBILL_TYPE_BILL_DET_PRE = "4";
	public static final String UNBILL_TYPE_BILL_TOT_PRE = "5";
	
	/** 合帐分享主副号关系 */
	public static final String HZFXZFHGX = "60";
	
	/** 校园资费手机宽带绑定付费 */
	public static final String XYZFSJKDBDFF = "61";
	
	/** 流量伴侣卡 */
	public static final String LLBLK = "62";
	
	/** 时间变量格式 */
	public static final String DATE_FOMART_1 = "yyyy/MM/dd HH:mm:ss";
	public static final String DATE_FOMART_2 = "yyyyMMddHHmmss";
	public static final String DATE_FOMART_3 = "yyyy-MM-dd HH:mm:ss";
