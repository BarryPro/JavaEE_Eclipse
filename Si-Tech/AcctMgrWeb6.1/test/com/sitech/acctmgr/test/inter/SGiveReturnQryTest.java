...
public class SGiveReturnQryTest extends BaseTestCase{
	@Test
	public void testQuery() {
		try {
			IGiveReturn iGiveReturn = (IGiveReturn) getBean("giveReturnSvc");
			...
			InDTO in = parseInDTO(inMBean, SGiveReturnQryInDTO.class);
			SGiveReturnQryOutDTO out = (SGiveReturnQryOutDTO)iGiveReturn.query(in);
