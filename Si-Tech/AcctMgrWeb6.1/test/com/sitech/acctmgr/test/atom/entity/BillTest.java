...
//		System.out.println(bill.getSumDeadFee(idNo, 0, "1,4"));
	...
	@Test
	public void testGetUnbillBillDetList() throws Exception {

		long con = 230370003021721794L;
		long id = 230370003021721799L;
		System.out.println(bill.getUnbillBillDetList(con, id));
	}
	...
	@Test
	public void testgetUnbillPreList() throws Exception {

		long con = 230360003006528602L;
		long id = 0;
		System.out.println(bill.getUnbillPreList(con, id));
	}

	@Test
	public void testGetUnbillDxInfo() throws Exception {
		long idNo = 230300003002776000L;
		System.out.println(bill.getUnbillDxInfo(230370003021721794L, idNo));
	}
