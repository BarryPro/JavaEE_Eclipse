...
public class SDetailTest extends BaseTestCase{
    ...
    private String getArgStringForChannelQuery() {
        ...
        busiMap.put("BEGIN_TIME", "20170401");
        busiMap.put("END_TIME", "20170523");
...
//        busiMap.put("PHONE_NO", "13944161239");
    ...
    private String getArgStringForCityOldQuery() {
        ArgumentBuilder builder = new ArgumentBuilder();
        Map<String, Object> busiMap = new HashMap<>();
//        busiMap.put("PHONE_NO", "13944161239");
        busiMap.put("PHONE_NO", "13904841348");
        ...
        busiMap.put("CONTACT_PHONE", "");
        busiMap.put("IS_PAGE", "Y");
        busiMap.put("PAGE_NO", "10");
        busiMap.put("PAGE_SIZE", "10");

        builder.setBusiargs(busiMap);

        Map<String, Object> oprMap = new HashMap<>();
        oprMap.put("LOGIN_NO", "aan70W");
        oprMap.put("OP_CODE", "8440"); //8110 地市详单查询； 8440地市安保详单
        oprMap.put("GROUP_ID", "13436");
        builder.setOperargs(oprMap);
    ...
    @Test
    public void testCityQueryOld() throws Exception {
        String inStr = this.getArgStringForCityOldQuery();
        InDTO inDTO = parseInDTO(inStr, SDetailCityQueryOldInDTO.class);

        OutDTO outDTO = bean.cityQueryOld(inDTO);
    ...
    @Test
    public void testDynamicSpQuery() throws Exception {
        String inStr = this.getArgStringForSpQuery();
        InDTO inDTO = parseInDTO(inStr, SDetailDynamicSpQueryInDTO.class);

        OutDTO outDTO = bean.dynamicSpQuery(inDTO);
