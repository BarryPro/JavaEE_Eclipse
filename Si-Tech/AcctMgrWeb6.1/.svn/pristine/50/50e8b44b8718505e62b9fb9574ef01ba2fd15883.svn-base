...
import com.sitech.acctmgr.atom.busi.pay.trans.TransAccountDead;
...
* @version 1.0
*/
public class TransAirPayAccountCloseDead extends TransAccountDead {
...
//		}
		/* TODO 如果账户密码输入不为空,验证密码是否正确，如果密码为空的话不进行验证*/
