...
public class SUnifyPortalInitInDTO extends CommonInDTO{
	@ParamDesc(path="BUSI_INFO.PHONE_NO",cons=ConsType.QUES,type="String",len="20",desc="服务号码",memo="略")
	protected String phoneNo = "";
	
	@ParamDesc(path="BUSI_INFO.TOTAL_DATE",cons=ConsType.QUES,type="String",len="6",desc="查询月份",memo="略")
	...
	public void decode(MBean arg0){
		...
		setTotalDate(arg0.getObject(getPathByProperName("totalDate")).toString());
