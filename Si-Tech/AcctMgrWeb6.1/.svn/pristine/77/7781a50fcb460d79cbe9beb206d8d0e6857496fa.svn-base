...
*  <p>修改日期    修改人   修改目的<p>
 */
public class BatchPayRecdEntity implements Serializable {
	...
	@ParamDesc(path="ACT_ID",cons=ConsType.QUES,type="String",len="18",desc="活动id",memo="略")
	...
	@ParamDesc(path="SEND_MONTH",cons=ConsType.QUES,type="String",len="8",desc="赠送月数",memo="略")
	...
	@ParamDesc(path="DOCUMENT_NAME",cons=ConsType.QUES,type="string",len="18",desc="公文名",memo="略")
	private String documentName;
	
	@JSONField(name="DOCUMENT_NO")
	@ParamDesc(path="DOCUMENT_NO",cons=ConsType.QUES,type="string",len="18",desc="公文号",memo="略")
	private String documentNo;
	
	@JSONField(name="FACTOR_ONE")
	@ParamDesc(path="FACTOR_ONE",cons=ConsType.QUES,type="string",len="100",desc="短信模版1",memo="略")
	private String factorOne;
	
	@JSONField(name="FACTOR_TWO")
	@ParamDesc(path="FACTOR_TWO",cons=ConsType.QUES,type="string",len="100",desc="短信模版2",memo="略")
	private String factorTwo;
	
	@Override
	public String toString() {
		return "BatchPayRecdEntity [regionId=" + regionId + ", batchSn=" + batchSn + ", actId=" + actId + ", actName="
				+ actName + ", sendDate=" + sendDate + ", smsFlag=" + smsFlag + ", sendMonth=" + sendMonth + ", opTime="
				+ opTime + ", yearMonth=" + yearMonth + ", loginNo=" + loginNo + ", opCode=" + opCode + ", opNote="
				+ opNote + ", fileName=" + fileName + ", auditTime=" + auditTime + ", auditLogin=" + auditLogin
				+ ", auditInfo=" + auditInfo + ", auditFlag=" + auditFlag + ", auditName=" + auditName + ", totalNum="
				+ totalNum + ", invalidNum=" + invalidNum + ", totalFee=" + totalFee + ", invalidFee=" + invalidFee
				+ ", userPhone=" + userPhone + ", documentName=" + documentName + ", documentNo=" + documentNo
				+ ", factorOne=" + factorOne + ", factorTwo=" + factorTwo + "]";
	}
