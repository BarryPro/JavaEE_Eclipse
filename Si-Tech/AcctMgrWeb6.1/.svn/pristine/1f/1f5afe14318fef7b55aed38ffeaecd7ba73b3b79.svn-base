 ...
 * @version 1.0
 */
public class S8056CfmOutDTO extends CommonOutDTO{

	private static final long serialVersionUID = -1702327482142658109L;
	
	@JSONField(name = "PAY_SN" )
	@ParamDesc(path="PAY_SN",cons=ConsType.CT001,type="long",len="14",desc="缴费冲正流水",memo="略")
	protected long paybackPaysn;  //缴费冲正流水
	...
	public S8056CfmOutDTO(){}
	
	public S8056CfmOutDTO(String sJson){
