...
public class VolumeBookPreHoldingInDTO extends CommonInDTO {
	...
	@ParamDesc(path = "BUSI_INFO.ACCT_ID", cons = ConsType.CT001, type = "string", len = "18", desc = "流量帐户", memo = "Balance_id为空时，acct_id与acct_type不可同时为空")
	private String acctId;
	@ParamDesc(path = "BUSI_INFO.ACCT_TYPE", cons = ConsType.CT001, type = "string", len = "2", desc = "账户类型", memo = "Balance_id为空时，acct_id与acct_type不可同时为空")
	private String acctType;
	@ParamDesc(path = "BUSI_INFO.BALANCE_ID", cons = ConsType.CT001, type = "string", len = "18", desc = "流量帐本", memo = "不为空，则不判断acct_type，acct_id，Balance_type，ADD_ATTR_CODE，直接预占balance_id对应的账本；")
	...
	@ParamDesc(path = "BUSI_INFO.CHARGE_VALUE", cons = ConsType.CT001, type = "string", len = "18", desc = "预占流量额度", memo = "单位:KB")
	private String chargeValue;
	@ParamDesc(path = "BUSI_INFO.EFF_DATE", cons = ConsType.CT001, type = "string", len = "14", desc = "流量预占生效时间", memo = "不可空， 格式：YYYYMMDDHH24MISS")
	private String effDate;
	@ParamDesc(path = "BUSI_INFO.EXP_DATE", cons = ConsType.CT001, type = "string", len = "14", desc = "流量预占失效时间", memo = "不可空 格式：YYYYMMDDHH24MISS")
