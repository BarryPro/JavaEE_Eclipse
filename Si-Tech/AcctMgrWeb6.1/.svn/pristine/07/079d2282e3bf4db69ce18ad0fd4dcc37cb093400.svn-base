...
public interface I8000Ao {
	...
	*/
	...
	/** 
	* 名称：8000家庭业务缴费用户信息查询	<br/>
	* 功能：根据家庭内任何一个号码、账户查询家庭内号码、账户等信息，供用户选择后进行缴费<br/>
	* @param IN_NO	：服务号码/账户号码
	* @param FLAG 	：查询方式 0按服务号码，1按帐户号码
	* @return 
	* <ul>
	* 	<li>CNT  	</li>
	* 	<li>USERINFO_LIST</li>
	...
	* 			<li>CONTRACT_NO					</li>
	* 			<li>CONTRACT_NAME				</li>
	* 			<li>CONTRACTTYPE_NAME：账户类型		</li>
	* 		</ul>
	* </ul>
	 */
	OutDTO familyQuery(InDTO inParam);
