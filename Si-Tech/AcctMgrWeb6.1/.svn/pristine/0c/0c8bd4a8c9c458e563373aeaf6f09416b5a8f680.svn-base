...
public class SInsRemindCtrlInDTO extends CommonInDTO{
	...
	@ParamDesc(path="BUSI_INFO.OP_TYPE",cons=ConsType.QUES,type="String",len="1",desc="操作类型",memo="QXDXTX:取消短信提醒；KTDXTX:开通短信提醒")
