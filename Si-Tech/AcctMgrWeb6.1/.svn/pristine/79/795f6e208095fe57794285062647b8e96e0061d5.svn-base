...
public class SpecialTransRollBackInDTO extends CommonInDTO{
	...
	@ParamDesc(path="OPR_INFO.ORDER_LINE_ID",cons=ConsType.CT001,type="String",len="40",desc="原始订单行号",memo="略")
	private String foreignSnTmp;
	...
	public void decode(MBean arg0) {
		...
		if(StringUtils.isNotEmptyOrNull(arg0.getObject(getPathByProperName("foreignSnTmp")))){
			this.foreignSn = arg0.getStr(getPathByProperName("foreignSnTmp"));
		}
	...
	public String getForeignSnTmp() {
		return foreignSnTmp;
	}

	public void setForeignSnTmp(String foreignSnTmp) {
		this.foreignSnTmp = foreignSnTmp;
	}
