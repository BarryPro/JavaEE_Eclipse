...
public class SRemindTest extends BaseTestCase {
	IRemind remind = null;

	@Before
	public void setUp() throws Exception {
		remind = (IRemind) getBean("remindSvc");
	}
	...
	public void testQuery() throws Exception {
		...
		InDTO inDto = parseInDTO(mbean, SQryShortRemindAuthInDTO.class);

		OutDTO outDto = remind.queryShortRemindAuth(inDto);
