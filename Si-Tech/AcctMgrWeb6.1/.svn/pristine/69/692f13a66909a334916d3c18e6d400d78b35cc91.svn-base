...
public class VolumeBookRollbackInDTO extends CommonInDTO {
	...
	@ParamDesc(path = "BUSI_INFO.OPER_SESSION", cons = ConsType.CT001, type = "string", len = "40", desc = "充入流水", memo = "")
	...
	public void decode(MBean arg0) {
		...
		setOperSession(arg0.getStr(getPathByProperName("operSession")));
	}
