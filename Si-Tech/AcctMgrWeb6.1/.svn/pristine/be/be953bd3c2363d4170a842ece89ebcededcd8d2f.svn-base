 ...
 */
public class SEchargeCardTest extends BaseTestCase {
	IEchargeCard bean = null;

	@Before
	public void setUp() throws Exception {
		bean = (IEchargeCard) getBean("echargeCardSvc");
	}

	private String getInArgsString() {
		ArgumentBuilder builder = new ArgumentBuilder();
		Map<String, Object> busiMap = new HashMap<>();
		busiMap.put("PHONE_NO", "15945728568");
		busiMap.put("BEGIN_TIME", "20170601000000");
		busiMap.put("END_TIME", "20170620000000");
	...
	public void testQuery() throws Exception {
		...
		InDTO inDto = parseInDTO(mbean, SEchargeCardInDTO.class);
