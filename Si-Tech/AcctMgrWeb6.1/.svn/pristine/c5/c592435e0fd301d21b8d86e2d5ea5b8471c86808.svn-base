...
public class SWxPayQryInDTO extends CommonInDTO {
	/**
	 * 
	 */
	...
	@ParamDesc(path="BUSI_INFO.BEGIN_DATE",cons=ConsType.CT001,type="int",len="6",desc="开始时间",memo="年月日，可空")
	private int beginDate = 0;
	@ParamDesc(path="BUSI_INFO.END_DATE",cons=ConsType.CT001,type="int",len="6",desc="结束时间",memo="年月日，可空")
