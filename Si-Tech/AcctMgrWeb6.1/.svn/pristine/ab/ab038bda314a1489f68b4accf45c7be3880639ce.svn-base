...
public class VolumeBookShareChangeInDTO extends CommonInDTO {
	//消息头部分
	...
	@ParamDesc(path = "BUSI_INFO.MEMBER_PHONE", cons = ConsType.CT001, desc = "成员号码 对应msisdn", len = "15", memo = "不可空")
	private String memberPhone;
	
	@ParamDesc(path = "BUSI_INFO.MEMBER_ID", cons = ConsType.CT001, desc = "成员用户id 对应user_id", len = "18", memo = "不可空")
	...
	@ParamDesc(path = "BUSI_INFO.CHANGE_FLAG", cons = ConsType.CT001, desc = "变更标识", len = "1", memo = "不可空 0:成员删除 1:成员增加")
	...
	public void decode(MBean arg0) {
		...
		setMemberPhone(arg0.getStr(getPathByProperName("memberPhone")));
		setMemberId(arg0.getStr(getPathByProperName("memberId")));
		...
		setChangeFlag(arg0.getStr(getPathByProperName("changeFlag")));
