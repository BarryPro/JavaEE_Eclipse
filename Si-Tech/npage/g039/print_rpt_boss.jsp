...
//String url="http://10.110.0.121:11000/cgi-bin/PubWebPrn.sh"; //这个和生产上一样
//String url="http://"+request.getServerName().trim()+":28001/cgi-bin/PubWebPrn.sh";
 // String url="http://"+request.getServerName().trim()+":28001/cgi-bin/PubWebPrnBoss.sh";
String url="http://10.110.0.100/cgi-bin/PubWebPrnBoss.sh"; //这个和生产上一样
