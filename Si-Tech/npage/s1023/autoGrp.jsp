...
%>
<%
	System.out.println("------------autoGrp.jsp------------hjw---------\n");
	...
	String PARENT_GROUP_ID = request.getParameter("PARENT_GROUP_ID");
	String regionCode = "";
	System.out.println("------------nopass------------hjw---------"+nopass);
System.out.println("------------PARENT_GROUP_ID------------hjw---------"+PARENT_GROUP_ID);
System.out.println("------------OWNER_CODE------------hjw---------"+OWNER_CODE);
System.out.println("------------check------------hjw---------"+check);
System.out.println("------------check2------------hjw---------"+check2);
System.out.println("------------user------------hjw---------"+user);
System.out.println("------------cDate------------hjw---------"+cDate);
System.out.println("------------targeturl------------hjw---------"+targeturl);
System.out.println("------------random------------hjw---------"+random);
System.out.println("------------selfIp------------hjw---------"+selfIp);
...
%>
	...
	<wtc:service name="sLoginCheck" outnum="46"  retmsg="msg" retcode="retCode" routerKey="workno" routerValue="<%=workNo%>">
...
<FORM METHOD=POST NAME=main  ACTION="<%= targeturl %>">
      <INPUT TYPE="hidden" NAME="crmActiveOpCode" value="<%= opCode %>"  >
