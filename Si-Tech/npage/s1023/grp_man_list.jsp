...
<%
  ...
  String opCode="";
  String opName="在网集团查询";
  String   sqlStmt="SELECT T.OWNER_CODE,T.UNIT_ID,T.UNIT_NAME,T.CONTACT_PERSON,T.CONTACT_PHONE FROM DBVIPADM.DGRPCUSTMSG T  WHERE T.SERVICE_NO = '"+work_no+"' AND  T.OWNER_CODE = '"+OWNER_CODE+"'";
	/**************** 分页设置 ********************/
  ...
  <table id="tabList"  cellspacing=0 >			
		...
		%>			
			<tr>				
				...
				<input name="queryAcBtn" class="b_foot"  type="button"  value="统一视图" onClick="grp(<%=result1[i][1].trim()%>);">
				</td>
