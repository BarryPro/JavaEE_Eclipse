...
<%
	System.out.println("===requestInto========= fm294Submit.jsp ==========");
...
%>
<wtc:service name="sm294Del" routerKey="region" routerValue="<%=regionCode%>" retcode="sRetCode" retmsg="sRetMsg" outnum="2" >
