...
<%
		System.out.println("===requestInto========= fm294Query.jsp ==========");
...
%>
		...
		if("000000".equals(retCode)){
			System.out.println("============ fm294Query.jsp ==========" + result.length);
			...
			for(int i=0;i<result2.length;i++){
				funCodeStr += result2[i][0]+"("+result2[i][1]+")";
				if(i != result2.length-1){
					funCodeStr += "、";
				}
			} */
		}else{
			System.out.println("============ fm294Query.jsp 失败==========");
		}
		}catch(Exception e){
			retCode11 = "444444";
