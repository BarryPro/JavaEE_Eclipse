...
<%
	String opCode = "7115";		
	String opName = "商务电话免费换机";	//header.jsp需要的参数     
			...
			onload=function()
		  {
			...
			function simChk()
			{
		      ...
		      rdShowMessageDialog("手机号码不能为空！");
		   	...
		   	var myPacket = new AJAXPacket("post7115Qry.jsp","正在查询客户，请稍候......");
		...
		function printCommit(){
		  ...
		  if(!checkElement(document.s7115.phoneno)) return false;	
		   ...
		   if (document.all.old_machine_type.value == "")
				{
					rdShowMessageDialog("旧机器类型不能为空!")
					return false;
					}
		
			  if (document.all.new_machine_type.value == "")
				{
					rdShowMessageDialog("新机器类型不能为空!")
					return false;
					}
		   ...
		   //打印工单并提交表单
		  document.all.op_mark.value="用户"  + document.all.phoneno.value + "商务电话免费换机";
		  ...
		  function printInfo(printType)
		  {
		   /*var retInfo = "";
		    ...
		    retInfo+="用户名称："+document.all.cust_name.value+"|";
		    ...
		    retInfo+=""+"|";
		    retInfo+=""+"|";
		    retInfo+="原话机型号:"+document.all.old_machine_type.value+"|";
				retInfo+="旧SIM卡卡号:"+document.all.old_sim_no.value+"|";
		    retInfo+="新话机型号:"+document.all.new_machine_type.value+"|";
		    retInfo+="新SIM卡卡号:"+document.all.new_sim_no.value+"|";
		    retInfo+=""+"|";
		    retInfo+=""+"|";
			retInfo+=""+"|";
			retInfo+=""+"|";
	...
	<form action="7115Cfm.jsp" method="POST" name="s7115"  onKeyUp="chgFocus(s7115)">
		...
		<table cellspacing="0">
		  	<tr> 
			    	...
			    	<td  nowrap colspan="3" >
			    		<input name="TranType" type="radio" onClick="sel_type1()" value="a" checked>换机 	
			    		<input name="TranType" type="radio" onClick="sel_type2()" value="d">换机冲正 	
			    	</td>
		  	</tr>
		    	<tr> 
		    		<td  nowrap width="16%" class="blue">用户号码</td>
		      		<td nowrap  colspan="3" width="28%"> 
		        		...
		        		<input  type="button" name="qryId_No" class="b_text" value="查询" onClick="simChk()" >            
		      		</td>
			</tr>
		    	<tr> 
		    	...
		    	<tr> 
		    		<td  nowrap width="16%" class="blue">原话机型号:</td>
		      		...
		      		<td  nowrap  width="16%" class="blue">旧SIM卡卡号</td>
		      		<td  nowrap  width="40%"> 
		      			<input  type="text" name="old_sim_no" value="">
		      		</td>
		  	</tr>
		    	<tr> 
		    		<td  nowrap width="16%" class="blue" class="blue">新话机型号</td>
		      		<td  nowrap   width="28%"> 
		      			<input  type="text" name="new_machine_type" value="" >
		      		</td>
		      		<td  nowrap  width="16%" class="blue" class="blue">新SIM卡卡号</td>
		      		<td  nowrap  width="40%"> 
    			...
    			<tr>
    				<td> 
    					<div align="left" class="blue">操作备注</div>
      				</td>
