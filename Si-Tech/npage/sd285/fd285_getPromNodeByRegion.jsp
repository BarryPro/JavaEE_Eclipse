...
<%
		...
		{
			getRegionSql = "select group_id,group_name from dChnGroupMsg where ROOT_DISTANCE = 2";
		}
		else
		{
			getRegionSql = "select group_id,group_name from dChnGroupMsg where group_id in (select parent_group_id from dChnGroupInfo  where group_id = '"+groupId+"' ) and ROOT_DISTANCE = 2";
		}
