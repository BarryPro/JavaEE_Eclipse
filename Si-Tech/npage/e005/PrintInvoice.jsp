...
<%
    ...
    if (smop_code.equals("e006") ||smop_code.equals("e007") ) {
	...
	inParam[0] ="select decode(sm_code,'zn','神州行','gn','全球通','dn','动感地带','kd','宽带'),to_char(id_no) from dcustmsg where phone_no=: smphoneNo  and substr(run_code,2,1)<'a'";
