  ...
  function getpasswd(){
  	if(document.all.contractno.value.trim().len()==0){
   	...
   	var myPacket = new AJAXPacket("getKdNo_new.jsp","正在查询客户，请稍候......");
		...
		myPacket.data.add("return_page","e034.jsp");
...
<input type="hidden" name="busy_type"  value="3"> <!--busy_type说明： 1；铁通固话 2；铁通宽带3；宽带托收-->
<input type="hidden" name="op_code"  value="e034">
