...
<%  	  
   String opCode = request.getParameter("opCode");
	...
	System.out.println("aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa sm_code is "+sm_code);
...
function dynAddRow(){
			...
			sqlStr ="select * from (select trim(fee_code) || '|' || trim(detail_code) as a,trim(fee_code) || '-' || trim(detail_code) || '--' ||trim(detail_name) from sFeeCodeDetail where fee_code != '*' and decode(sm_flag,'1','kd','2','ke','3','kf','4','kg','5','kh') ='"+sm_code+"' )  order by a";
