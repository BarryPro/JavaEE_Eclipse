...
<%
  ...
  String return_page="";
	if(busy_type.equals("1")) 	return_page="../e005/s1300_2.jsp?opCode=e006&opName=宽带缴费&crmActiveOpCode=e006";
	if(busy_type.equals("2"))   return_page="../e005/s1300_2.jsp?opCode=e006&opName=宽带缴费&crmActiveOpCode=e006";
	...
	var IfSuccess = KeeperClient.UpdateICBCControlNum();
	 ...
	 function doyz(packet)
	 {
		...
		else
		{
			...
			{
				var prtFlag=0;
				prtFlag=rdShowConfirmDialog("e006缴费成功!当前发票号码是"+ocpy_begin_no+",发票代码是"+bill_code+",是否打印发票?");
				if (prtFlag==1)
				{
...
function ifprint()//kf kg ki电子发票
{
	if(("<%=s_sm_code%>"=="kf" || "<%=s_sm_code%>"=="kg"|| "<%=s_sm_code%>"=="ki"))
	{
		...
		else if(returnValue=="3")
		{
			...
			var s_hjse=0;
			var s_xmmc="宽带缴费";//项目名称 crm可能为多条? 看下zg17多组怎么传的
			var s_ggxh="";
		...
		else//取消的
		{
			...
			document.frm_print.action="../s1300/PrintInvoice_qx.jsp?opCode="+opCode+"&paySeq="+paySeq+"&phoneno="+phoneno+"&kphjje="+kphjje+"&s_hjbhsje="+s_hjbhsje+"&hjse="+s_hjse+"&returnPage="+return_page+"&hsbz=1&xmdj="+kphjje+"&contractno="+contractno+"&id_no="+id_no+"&sm_code="+sm_code+"&chbz=1&s_xmmc="+s_xmmc+"&paynote=e006缴费";
