...
if(pwdLength == null)  pwdLength = "15";
%>
...
<TD width="<%=width2%>"><input  name="<%=pcname%>"   value=""   type="password" onKeyPress="return isKeyNumberdot(0)"  class="button" prefield="<%=pname%>" filedtype="pwd" maxlength="<%=pwdLength%>" onFocus="showReNumberDialog(document.all.<%=pcname%>)" pwdlength="<%=pwdLength%>">
	<font class="orange">*</font> 
</TD>
