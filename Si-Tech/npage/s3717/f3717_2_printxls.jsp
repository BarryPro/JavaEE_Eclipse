		...
		for(int i=0;i<11;i++)
		{
        		...
        		WritableCellFormat wcfF=null;
         		...
         		if(i==2){column=4;row=3;}	//集团编号：	
           		if(i==3){column=7;row=3;}  	//BlackBerry：	
...
<%
	...
	String sqlStr ="select  a.boss_org_code,a.service_no,b.phone_no,a.org_code ,a.unit_name from dgrpcustmsg a,dbvipadm.dgrpmanagermsg b where a.service_no=b.service_no and a.unit_id = '";
	//
	String grpName="" ;		//集团名称
	String unitID=""  ;		//集团编号
...
<%	 	 	
	...
	inputPara[0]=grpName;
	inputPara[1]=unitID;
	if(op_Code.equals("3718"))
		inputPara[2]="BlackBerry成员添加"; 
	else	
		inputPara[2]="BlackBerry成员删除"; 
