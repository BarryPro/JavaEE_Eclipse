...
function docheck()
{
    ...
    document.frm.action="g327Cfm.jsp";
...
<input type="hidden" name="actPhone" value="<%=activePhone%>"> 
		<table cellspacing="0">
			...
			<tr id="tb1" style="display:"> 
				...
				<td colspan=3> 
					<input type="text" value="<%=activePhone%>" readonly name="phoneNo"  maxlength="11" onKeyDown="if(event.keyCode==13)frm.beginDate.focus()" onKeyPress="return isKeyNumberdot(0)">
				</td>
