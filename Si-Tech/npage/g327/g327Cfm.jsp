...
<%@ page import="com.sitech.boss.pub.util.Encrypt"%> 
<%
 String actPhone = request.getParameter("actPhone").trim();
 String opCode = "e610";
...
String sql="";
String errMsg="";
//String rtnPage = "/npage/g327/g327_1.jsp?activePhone='<%=actPhon 
String password="";
int row_count = 51;
int num=0;
...
%>
 <wtc:service name="sg327" outnum="15" retmsg="msg2" retcode="code2" routerKey="region" routerValue="<%=regionCode%>">
...
%>
		<script>		
			...
			window.location.href="g327_1.jsp?activePhone=<%=actPhone%>";
		</script>
<%
    } 
	else
...
<div class="container">
 ...
 <div align="center"><h2><b>中国移信客户账单</b></h2></div> 
...
<div align="center">
  ...
  codebase="smsx.cab#Version=6,3,436,14">
	...
	<input type="button" value="打印预览" class="b_foot" title="打印预览" onClick="PageSetup_Null();document.all.wb.ExecWB(7,1)"/>
     -->
	 &nbsp;&nbsp;&nbsp;&nbsp;
	 <input type="button"  class="b_foot"value="返回" title="返回" onClick="window.location='g327_1.jsp?opCode=g327&opName=分散帐期用户账单查询&crmActiveOpCode=g327&activePhone=<%=actPhone%>'" />
	 &nbsp;&nbsp;&nbsp;&nbsp;
