...
<%
		System.out.println("===gaopengSeeLog========= fMarkIntegral.jsp ==========");
...
<%		
		...
		String inteUseNum =  request.getParameter("inteUseNum");
		String ifUseI =  request.getParameter("ifUseI");
		/*密码加密*/
		...
		inputParsm[7] = iPhoneNo;
		inputParsm[8] = inteUseNum;
		inputParsm[9] = ifUseI;
...
try{		
%>
		<wtc:service name="sMarkScoreChg" routerKey="region" routerValue="<%=regionCode%>"
...
<%
		...
		if("000000".equals(retCode)){
			...
			System.out.println("============ fMarkIntegral.jsp 失败==========");
		}
		}catch(Exception e){
			retCode11 = "444444";
