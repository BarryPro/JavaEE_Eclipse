...
try{   
	...
	city=oneTok(infoStr,'#',6).trim();
	accept=oneTok(infoStr,'#',7).trim();
	city=c;
	System.out.println("############################wkejwkejkfskjdfkjdlsadlfkjdslajdfjlsdfljdlksdf############"+c);
	...
	classInfo[0][6]=(String)hm.get("操作流水");classInfo[1][6]="0";classInfo[2][6]="操作流水："+accept;	classInfo[3][6]="0";
	classInfo[0][7]=(String)hm.get("地市");    classInfo[1][7]="0";classInfo[2][7]=c;				classInfo[3][7]="0";
	classInfo[0][8]=(String)hm.get("操作工号");classInfo[1][8]="0";classInfo[2][8]=work_no;classInfo[3][8]="0";
	classInfo[0][9]=(String)hm.get("广告内容");classInfo[1][9]="0";classInfo[2][9]="";classInfo[3][9]="0";
	range=9;
