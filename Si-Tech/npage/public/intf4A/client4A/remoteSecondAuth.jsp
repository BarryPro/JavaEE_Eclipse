...
if("000000".equals(retCode_region2) && resultGoldFlag.length > 0  &&  "000000".equals(retCode_region) && resultSwitchFlag.length > 0  ){
	...
	String sensitiveOperate =request.getParameter("sensitiveOperate");
	String appSessionId =request.getParameter("appSessionId");
	String sceneId =request.getParameter("sceneId");
	String serviceUrl =request.getParameter("serviceUrl");
	String appId = request.getParameter("appId");

	System.out.println("ningtn remoteSecond approverAccount = " + approverAccount);
	System.out.println("ningtn beginTime  = " + beginTime);
	System.out.println("ningtn endTime  = " + endTime);
	System.out.println("ningtn dynamicCode  = " + dynamicCode);
	/* 操作时间 requestTime节点 */
	...
	/* 根据xml模板，生成报文 */
	/* 套用xml模板 */
	String postXmlUrl = request.getRealPath("/npage/public/intf4A/xmltemplet")+"/remoteSecondAuth.xml";
	...
	document = updateElementText(document, "dynamicCode", dynamicCode);
	...
	String method = "remoteSecondAuth";
	...
	System.out.println("======client4A remoteSecondAuth " + result + " | " + resultDesc);
%>
