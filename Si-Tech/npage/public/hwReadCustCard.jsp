...
System.out.println("=gaopengSeeLog==== public ==" + hwAccept + "|" + showBody+"| sopcode="+sopcode);
...
<table cellspacing="0">
	...
	<tr style="display:<%=iccidInfoStyle%>;">
		...
		<input type="button" id="photoCollect1" name="photoCollect1" class="b_text"   value="影像采集" onClick="photoCollect22(1)" >
		...
		<input type="button" id="photoCollect2" name="photoCollect2" class="b_text"   value="影像采集" onClick="photoCollect22(2)" >
		<font class="orange">注：只录入一张身份证不需要使用此功能</font>
		</td>
	</tr>
...
<script language="JavaScript">	
  ...
  /*2014/12/01 9:05:53 gaopeng 影像采集按钮*/
