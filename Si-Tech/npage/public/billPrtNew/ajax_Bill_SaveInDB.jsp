...
/********************
 *开发商: si-tech
 *create by hejwa @ 2016/11/19 10:37:08
 ********************/
%>
...
System.out.println(" ------billnew----------------点击确认打印发票调 sinvoiceInDB 服务--------------------");
System.out.println("-------billnew---------errCode------sinvoiceInDB---------->"+errCode);
System.out.println("-------billnew---------errMsg-------sinvoiceInDB---------->"+errMsg);
