...
for (int i=0;i<result.length;i++) {
  ...
  colnumber += 4;
   ...
   {
	   out.println("printctrl.Print(50,"+colnumber+",9,0,'"+result[i][7].trim()+"')");
   }
   if((result[i][8].substring(0,1)!=("|")) &&(!(result[i][8].substring(0,1).equals("|")))   )
   {
	   out.println("printctrl.Print(50,"+colnumber+",9,0,'"+result[i][8].trim()+"')");
   }
   ...
   {
	   out.println("printctrl.Print(50,"+colnumber+",9,0,'"+result[i][9].trim()+"')");
   }
   if((result[i][10].substring(0,1)!=("|")) &&(!(result[i][10].substring(0,1).equals("|")))   )
   {
	   out.println("printctrl.Print(50,"+colnumber+",9,0,'"+result[i][10].trim()+"')");
   }
    colnumber += 4;
   if((result[i][11].substring(0,1)!=("|")) &&(!(result[i][11].substring(0,1).equals("|")))   )
   {
	   out.println("printctrl.Print(50,"+colnumber+",9,0,'"+result[i][11].trim()+"')");
   }
   if((result[i][12].substring(0,1)!=("|")) &&(!(result[i][12].substring(0,1).equals("|")))   )
   {
	   out.println("printctrl.Print(50,"+colnumber+",9,0,'"+result[i][12].trim()+"')");
   }
    colnumber += 4;
   if((result[i][13].substring(0,1)!=("|")) &&(!(result[i][13].substring(0,1).equals("|")))   )
   {
	   out.println("printctrl.Print(50,"+colnumber+",9,0,'"+result[i][13].trim()+"')");
   }
   if((result[i][14].substring(0,1)!=("|")) &&(!(result[i][14].substring(0,1).equals("|")))   )
   {
	   out.println("printctrl.Print(50,"+colnumber+",9,0,'"+result[i][14].trim()+"')");
   }
    colnumber += 4;
   if((result[i][15].substring(0,1)!=("|")) &&(!(result[i][15].substring(0,1).equals("|")))   )
   {
	   out.println("printctrl.Print(50,"+colnumber+",9,0,'"+result[i][15].trim()+"')");
   }
   if((result[i][16].substring(0,1)!=("|")) &&(!(result[i][16].substring(0,1).equals("|")))   )
   {
	   out.println("printctrl.Print(50,"+colnumber+",9,0,'"+result[i][16].trim()+"')");
   }
