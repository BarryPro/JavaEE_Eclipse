...
<script language="JavaScript">
 ...
 function docheck()
 {
	...
	{
		rdShowMessageDialog("请输入持卡人身份证号码!");
		return false;
	}
	else
	{
		...
		/*
		document.frm.action="zg84_2.jsp?card_no="+card_no+"&card_pwd="+card_pwd+"&phoneNo="+phoneNo+"&user_phone_no="+user_phone_no+"&user_no="+user_no+"&cardType="+cardType+"&remark="+remark;
		document.frm.submit();
		*/
	}
 }
...
function doProcess(packet)
{
	...
	{		
		...
		document.frm.action="zg84_2.jsp?card_no="+card_no+"&card_pwd="+card_pwd+"&phoneNo="+phoneNo+"&user_phone_no="+user_phone_no+"&user_no="+user_no+"&cardType="+cardType+"&remark="+remark+"&loginAccept="+loginAccept;
		document.frm.submit();
	}
	else
	{
