...
String service_name  =request.getParameter("service_name"); ;
	//szg44upload 接口没改完呢
%>
	<wtc:service name="<%=service_name%>" routerKey="regionCode" routerValue="<%=regionCode%>"  retcode="sReturnCode" retmsg="sErrorMessage"  outnum="7" >
...
function gohome()
{
document.location.replace("zgbi_upload.jsp");
}
-->
</script>
</HEAD>
