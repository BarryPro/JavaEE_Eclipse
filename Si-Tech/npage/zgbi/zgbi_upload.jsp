...
function sel4(){
 ...
 function dosubmit() 
 {
	...
	else 
	{
		...
		var seled = $("#seled").val();
		document.form.action="zgbi_cfm1.jsp?remark="+document.form.remark.value+"&regCode="+"<%=regionCode%>"+"&sysAccept="+"<%=sysAccept%>"+"&seled="+seled+"&service_name=szgbiupload";
...
<FORM action="g247_cfm1.jsp" method=post name=form ENCTYPE="multipart/form-data">
	...
	<table cellspacing="0">
      ...
      <tr> 
        ...
        <td colspan="4"> 
        	<q vType="setNg35Attr">
          <input name="busyType2" type="radio" onClick="sel3()" value="3" checked >工号批量添加
          </q>
		  <q vType="setNg35Attr">
		              ...
		              <tbody> 
			              <tr> 
				                ...
				                <td width="30%" colspan="2">
					                    <input type="text" size="30" class="InputGrey" readonly value="冲正工号批量添加">
				                </td>				               		              
		       ...
		       <table  cellspacing="0">
					  ...
					  <!--
						...
						-->
			              ...
			              <tr> 
				                <td colspan="3">说明：<br>
				        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color="red">数据文件为TXT文件,使用|作为分隔符.时间格式为YYYYMMDD,如20170501</font><br>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color="red">格式为：地市|区县|工号|授权开始时间|授权结束时间,例:01|01|aaaaxp|20170101|20170501</font><br>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color="red">每次上传的数据不要超过1000条,超过部分将不处理</font><br>
						</td>
			              </tr>   
		              </tbody> 
		      </table>
