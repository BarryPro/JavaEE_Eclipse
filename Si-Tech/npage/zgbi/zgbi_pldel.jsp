...
function sel4(){
 ...
 function dosubmit() 
 {
	...
	else 
	{
		...
		var seled = $("#seled").val();
		document.form.action="zgbi_cfm1.jsp?remark="+document.form.remark.value+"&regCode="+"<%=regionCode%>"+"&sysAccept="+"<%=sysAccept%>"+"&seled="+seled+"&service_name=szgbipldel";
 ...
 function setOpNote()
 {
	...
	{
	  document.all.remark.value = "操作员："+document.all.loginNo.value+"进行了批量信息删除"; 
	}
	return true;
 }
 </script> 
	...
	<table cellspacing="0">
      ...
      <tr> 
        ...
        <td colspan="4"> 
		  ...
		  <q vType="setNg35Attr">
          <input name="busyType2" type="radio" onClick="sel4()" value="4" checked>工号批量删除
          </q>
		  <!--
		  <q vType="setNg35Attr">
  ...
  <table cellspacing="0">
		              <tbody> 
			              <tr> 
				                ...
				                <td width="30%" colspan="2">
					                    <input type="text" size="30" class="InputGrey" readonly value="冲正工号批量删除">
				                </td>				               		              
		       ...
		       <table  cellspacing="0">
					  ...
					  <!--
						...
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color="red">格式为：工号 回车</font><br>
