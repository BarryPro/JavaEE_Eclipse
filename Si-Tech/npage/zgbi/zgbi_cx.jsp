		  ...
		  with(document.forms[0])
		  {
			//alert(document.form1.region_code.value);
			  hTableName.value="RPT003";
				...
				hParams1.value= "dbcustadm.prc_zgbi_rpt('"+document.form1.workNo.value+"','"+document.form1.begin_time.value+"','"+document.form1.end_time.value+"'";
  ...
  <table cellSpacing="0">
    <tr> 
      <td id="footer"> 
		  ...
		  &nbsp;
          <input type="button" name="return1" class="b_foot" value="返回" onclick="window.location.href='zgbi_upload.jsp'" >
          &nbsp;
