		...
		<div class="dis" id="tbc_01">
				...
				<table cellSpacing=0 id="serviceNoInfo">	
			        ...
			        <td colspan=6 align="center">     
			          ...
			          <span  style="color:red;">如果点击“资源预占”，不进行宽带开户请点击“资源释放”，不要直接关闭界面。</span>
			          <%}%>
			        </td>     
			      </tr>
			      <tr>  
			      ...
			      <tr>
			        ...
			        <td class="blue">施工单派发时间</td>
				      <td><input type="text" name="appointvTime"  maxlength="8" id="appointvTime"  v_format="yyyyMMdd" class="required" value="<%=dateStr2%>"><font class="orange">(格式YYYYMMDD)</font></td>	
			      </tr>  
					  <tr>
