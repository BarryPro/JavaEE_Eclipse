...
<script language=javascript>
	...
	function opchange() {
		if (document.getElementsByName("opFlag")[0].checked){
			opFlag = "2";
<%    if ("g975".equals(opCode) || "g976".equals(opCode)){%>
				document.getElementById("opCode").value = "g976";
				document.getElementById("opName").value = "预存购机-合约冲正";
<%}%>
