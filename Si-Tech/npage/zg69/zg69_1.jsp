...
<%
  	//String opCode = "4141";		
  	String opCode = "zg69";		
	String opName = "10086人工退费查询";	//header.jsp需要的参数
	...
	*/
	...
	else
	{
		...
		*/
		...
		document.qryOprInfoFrame.location = "zg69_2.jsp?begin_time="+begin_time+"&end_time="+end_time1+"&phone_no="+phone_no;
	}
} 
...
<form name="frm" method="POST" >
	...
	<div class="title">
		<div id="title_zi">10086人工退费查询</div>
	</div>
	<table>
	<tr >
			<td width="15%" class="blue" nowrap>查询号码</td>
			<td><input type="text" name="phone_no" id="phone_no" colspan=6  maxlength=11 size="18" value="">&nbsp;&nbsp;</td>
	</tr>
		<!--xl add end 查询条件-->
