...
<%
  ...
  String retnPage = "/npage/sd069/fd069_login.jsp?opCode="+opCode+"%26opName="+opName+"%26activePhone="+phoneNo;//跳转页面路径
  String  inParams [] = new String[2];
  inParams[0] = "SELECT count(1) FROM dWebTermSale WHERE update_accept =:acceptno AND phone_no =:phoneno";
  inParams[1] = "acceptno="+backaccept+",phoneno="+phoneNo;
%>
...
<%
          ...
          retnPage = "/npage/se969/fe969_main.jsp?opCode=e969%26opName=网上终端销售冲正%26activePhone="+phoneNo;
        }
      }
    }
  }else{
%>
          <SCRIPT language="JavaScript">
  	        ...
  	        window.location.href="/npage/se969/fe969_main.jsp?opCode=e969&opName=网上终端销售冲正&activePhone=<%=phoneNo%>";
          </SCRIPT>
<%   
  }
...
{  
 ...
 %>
	<script language="JavaScript">
	<!--
  	rdShowMessageDialog("查询用户密码出错，错误代码：<%=code1%>错误信息：<%=msg1%>",0);
  	window.location.href="/npage/se969/fe969_main.jsp?opCode=e969&opName=网上终端销售冲正&activePhone=<%=phoneNo%>";
  	//-->
  </script>
<%
...
<wtc:service  name="sd070Qry" routerKey="phone" routerValue="<%=phoneNo%>" outnum="38"  retcode="errCode" retmsg="errMsg">	
  ...
  %>
	...
	if (errCode.equals("000000")||errCode.equals("0")){
	  ...
	  mach_price = retList[0][17]; 
		...
		mobileTVfee= retList[0][36];          /*huangrong add 手机电视费 2011-2-18 11:15*/
		mobileTVterm= retList[0][37];     /*huangrong add  手机电视费消费期限 2011-2-18 11:15*/	
	 }
  }
%>
...
<!--
 ...
 function printCommit()
 {
  ...
  document.frm.iAddStr.value=document.frm.sale_code.value+"|"+document.all.agent_code.value+"|"+document.all.phone_typeno.value+"|"+document.frm.CashPay.value+"|"+document.frm.prepay_gift.value+"|"+document.frm.prepay_limit.value+"|"+document.frm.mon_baseFee.value+"|"+document.frm.mach_price.value+"|"+document.frm.consume_Term.value+"|"
	 +document.frm.OfferID.value+"|"+document.frm.IMEINo.value+"|"+document.frm.PhoneFree_Fee.value+"|"+document.frm.Active_Term.value+"|";
  //校验
...
<body>
<form name="frm" method="post" action="fd070_2.jsp" onload="init()">
...
<table cellspacing="0">
	...
	<tr bgcolor="F5F5F5">
		...
		<td>
			<input name="freefee" type="text"  class="InputGrey" id="freefee" value="<%=prepay_gift%>" readonly>
			<font color="orange">*</font>
		</td>
	</tr>
<!--begin huangrong add “手机电视费”和“手机电视费消费期限”的展示 2011-2-18 11:16-->
	<tr>
		<td class="blue">手机电视费</td>
		<td>
			<input name="PhoneFree_Fee" type="text"  class="InputGrey" id="PhoneFree_Fee" value="<%=mobileTVfee%>" readonly>
			<font color="orange">*</font>
		</td>
		<td class="blue">手机电视费消费期限</td>
		<td>
			<input name="Active_Term" type="text"  class="InputGrey" id="Active_Term" value="<%=mobileTVterm%>" readonly>
			<font color="orange">*</font>
		</td>
	</tr>	
<!--end huangrong add “手机电视费”和“手机电视费消费期限”的展示-->	
	...
	<tr>
		...
		<input type="hidden" name="return_page" id="return_page" value="<%=retnPage%>"><!-- 跳转路径 -->
