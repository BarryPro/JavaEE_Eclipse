...
function doCheck2()
{
	...
	var str = window.showModalDialog('../g141/getCount.jsp?unit_id='+document.frm1527.unit_id.value,"",prop);
...
{	
 ...
 	   if( document.frm1527.contract_no.value=="" &&otherFlag=="1") 
	   {	
 	   ...
 	   document.frm1527.action="g140_2.jsp"; 
	   frm1527.submit();
...
<TABLE cellSpacing=0>
    <TR> 
        ...
        <TD colspan=3>
            <select size="1" name="otherFlag" onchange="changsearchtype()">
                <option class=button value=0>集团编码</option>
                <option class=button value=1>产品帐号</option>
            </select>
        </TD>
	...
	<tr id="fwhm2"  style="display:none">
        ...
        <TD colspan=3>
            <input type="text" name="contract_no" size="20" maxlength="11" onKeyDown="if(event.keyCode==13){ return query() }"   onKeyPress="return isKeyNumberdot(0)"  >
            
        </TD>
	</tr>
    <TR> 
        <TD class=blue>账务年月</TD>
        <TD>
