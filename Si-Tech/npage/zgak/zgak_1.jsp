...
function xnjttj()
{
	...
	if(document.form1.all("phone_no").value=="")
	{
		  ...
		  with(document.forms[0])
		  {
			//alert(document.form1.region_code.value);
			  hTableName.value="RPT003";
				...
				hParams1.value= "dbcustadm.prc_zgaj('"+document.form1.workNo.value+"','"+document.form1.begin_time.value+"','"+document.form1.end_time.value+"','"+document.form1.org_code1.value+"','"+document.form1.phone_no.value+"'";
...
<form  action="../rpt/print_rpt_boss.jsp" method="post" name="form1">
	...
	<input type="hidden" name="op_code" value="zgaj">
	<input type="hidden" name="login_accept" value="">
	<input type="hidden" name="hTableName" value=""> 
	
  <table cellspacing="0">
    <tr>
		<td class="blue">查询手机号码</td>
		<td colspan="3">
			<input type="text"   name="phone_no"  size="17" maxlength="17">
		</td>
