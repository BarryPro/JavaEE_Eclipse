					...
					function doPrint()
					{
						...
						else
						{
							...
							else if(returnValue=="3")
							{
								...
								if(s_flag=="Y")
								{
									s_kpxm="通信服务费,销售折扣,预存款已出具发票金额,充值卡已出具发票金额,系统赠送,合约套餐费";
									s_xmdj=txfwf+","+xszk+","+yckykjje+","+czkykjje+","+xtcz+","+hytcf;
									s_xmje=s_xmdj;
									s_hsbz="1,1,1,1,1,1";
									s_sl="*,*,*,*,*,*";
									s_se="0,0,0,0,0,0";
					  ...
					  <table cellspacing="0" id = "PrintA">
						 ...
						 <tr id="footer"> 
							<td colspan="9">
							  ...
							  <input class="b_foot" name=back onClick="window.location = 'zg17_1.jsp?activePhone=<%=phoneno%>' " type=button value=返回>
