...
function doProcess(packet){
	...
	if(returnCode=="999999"){
		rdShowMessageDialog("lixs没有此用户的相关资料!");
		return;
	}
...
function check_HidPwd()
{
  ...
  {
     rdShowMessageDialog("lixs请输入服务号码!");
...
function docheck()
{
  ...
  if( document.frm.phoneNo.value.length != 11 )
  {
   ...
   document.frm.action="sg297Cfm.jsp?ispopmarket="+document.frm.ispopmarket.value;
