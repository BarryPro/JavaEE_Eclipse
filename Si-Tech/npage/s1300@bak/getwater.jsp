...
/*   
	...
	String sql = "select to_char(login_accept),decode(op_code,'1302','号码缴费','1300','帐号缴费','1304','托收单缴费','1306','缴预存赠话费','2327','托收用户缴费','3459','POS机缴费','5255','空中充值帐户缴费','d340','集团缴费','g659','家庭缴费') as opName,to_char(sum(pay_money),'9999999990.00') as sumPayMoney,to_char(op_time,'YYYY-MM-DD HH24:MI:SS') as opTime from wPay? where contract_no=? and back_flag ='0' and op_code in('1300','1302','1304','1306','2327','3459','5255','d340','g659') group by login_accept,op_code,op_time order by op_time desc";
