...
<BODY>
<form action="e627_3Cfm.jsp" method="post" name="frm">
		<%@ include file="/npage/include/header.jsp" %>   
  	
		<div class="title">
			<div id="title_zi">手机支付缴费/变更</div>
		</div>
  ...
  <table cellspacing="0">
    <tr>
        ...
        <td colspan="4"> 
          ...
          <input name="busyType3" type="radio" onClick="sel3()" value="3" checked> 变更 
    ...
    <tr>
      ...
      <td>
        <input type="text" name="payMoney" maxlength="3"  onKeyPress="return isKeyNumberdot(0)" >
			...
			<td>
        <input type="text" name="date" value="26" maxlength="2"  disabled  >
        <input type="hidden" name="date1" value="26"  >
			  <font class="orange"> *</font>
			</td>
    </tr>
  </table>
