  ...
  String showPrePay = "";//显示预存
 	...
 	if (return_code.equals("000000"))
	{
       ...
       if(busy_type.equals("1"))
	   {
		...
		<wtc:array id="dcyclepre" scope="end" />
		<%
		showPrePay = dcyclepre[0][0].trim();
...
<%@ include file="/npage/include/header.jsp" %>
		...
		<div class="title">
          ...
          %>
				 		...
				 		<td class="blue"></td>
                  <td>
                    <input type="text" readonly class="InputGrey" style="color:red" name="prepayFee">
                  </td>
                </tr>
                <tr id="phoneId">
			...
			//	   System.out.println("dddddddddddddddddd");
                ...
                <tr>
                 ...
                 <tr>
                  ...
                  <td>
                    <input type="text" readonly class="InputGrey" style="color:red">
                  </td>
                ...
                <tr>
                  <td noWrap colspan="6" id="footer">
                    <div align="center">
                      ...
                      &nbsp;
                      <input type="button" name="return1" class="b_foot" value="返回" onClick="window.location.href='sg297.jsp?activePhone=<%=phoneNo%>'">
                      &nbsp;
