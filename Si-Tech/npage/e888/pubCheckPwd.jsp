...
<%
			...
			String service_no = WtcUtil.repNull(request.getParameter("user_no"));
            String retType = WtcUtil.repNull(request.getParameter("retType"));
            String Pwd1 = WtcUtil.repNull(request.getParameter("Pwd1"));
            ...
            try
            {
				...
				System.out.println("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAaa sqlStr is "+sqlStr);
                %>
