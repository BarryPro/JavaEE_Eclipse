 ...
 function docheck()
{
  ...
  {
	 document.frm.action="g532_2.jsp?phoneno="+document.frm.phoneno.value;
...
<form action="" method="post" name="frm">
    ...
    <tr> 
      ...
      <td> 
        <input class="button"type="text" name="phoneno" size="20" maxlength="12"  onKeyPress="return isKeyNumberdot(0)" >
      </td>
