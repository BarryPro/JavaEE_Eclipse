...
System.out.println("============servBusiId======="+servBusiId);	
	...
	String opNote = WtcUtil.repNull(request.getParameter("op_note"));
...
%>		 
<wtc:utype name="s1219ChgCfm" id="retVal" scope="end" >  
...
<wtc:uparams name="oprInfo" iMaxOccurs="1">                                   
	...
	<wtc:uparam value="<%=orgCode%>" type="string"/>
	<wtc:uparam value="<%=realOpCode%>" type="string"/>
</wtc:uparams>                                                               
...
String tempTimeStr[] = new String[tempCount];
				...
				for(int i=0;i<proOptFlag.length;i++)
				{
				System.out.println("zhangyan-------------------proOptFlag["+i+"]--------------"+proOptFlag[i]);
									if(proOptFlag[i].equals("5")){
...
<%
				  	...
				  	String[] proAttrSignal=proAttrArr[i].split(",");//每个产品的单个属性组
						...
						System.out.println("@zhangyan~~~~num"+num);	  	
...
<%	
	...
	{
		String statisLoginAccept =sysAcceptl; /*流水*/
