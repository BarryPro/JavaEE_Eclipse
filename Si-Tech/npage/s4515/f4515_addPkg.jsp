...
<script language="JavaScript">   
	...
	function add_submit(){
		...
		var pkg_name = document.form1.pkg_name.value;
...
<body>
  ...
  <form name="form1"  method="post" action="f4515_addPkg_submit.jsp">
		...
		<div id="title_zi">添加智能网VPMN的资费</div>
				...
				<table cellspacing="0" >
	             ...
	             <%
	  					...
	  					<TD width="34%" >
	  						<input type="text" name="pkg_code"/>&nbsp;<font class="orange">*<font>
	  						&nbsp;</TD>
	  		 </tr>		
	  		 ...
	  		 <tr  height="22">				
	  					...
	  					<TD width="34%" >
	  							<input type="text" name="pkg_name"/>&nbsp;<font class="orange">*<font>
	  						&nbsp;</TD>
