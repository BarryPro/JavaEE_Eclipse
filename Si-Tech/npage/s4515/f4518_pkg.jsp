...
<body>
  ...
  <form name="form1"  method="post">
   ...
   <DIV id="Operation_Table">                     
	...
	<div class="title">
		<div id="title_zi">资费配置操作详细信息</div>
	</div>
		...
		%>
				...
				<table cellspacing="0" >
					<tr  height="22">
	  					...
	  					<TD align="center" class="blue">更改前结束日期</TD>
	  					<TD align="center" class="blue">更改前权限</TD>
