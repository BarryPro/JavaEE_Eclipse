...
System.out.println(printAccept);
  ...
  //上网卡品牌
  String sqlAgentCode = "select  unique a.brand_code,trim(b.brand_name) from dphonesalecode a,schnresbrand b where a.region_code='" + regionCode + "' and a.sale_type='29' and a.brand_code=b.brand_code and valid_flag='Y' and is_valid='1'";
  System.out.println("sqlAgentCode====="+sqlAgentCode);

  //上网卡类型
  String sqlPhoneType = "select unique a.type_code,trim(b.res_name), b.brand_code from dphonesalecode a,schnrescode_chnterm b where a.region_code='" + regionCode + "' and  a.type_code=b.res_code and a.brand_code=b.brand_code and valid_flag='Y' and a.sale_type='29' and is_valid='1'";
  System.out.println("sqlPhoneType====="+sqlPhoneType);

  //营销代码
  String sqlsaleType = "select unique a.sale_code,trim(a.sale_name), a.brand_code,a.type_code from dphonesalecode a where a.region_code='" + regionCode + "' and a.sale_type='29' and valid_flag='Y'";
  System.out.println("sqlsaleType====="+sqlsaleType);
  
   //营销明细
  String sqlsaledet = "select sale_price,prepay_gift,consume_term,prepay_limit,active_term,market_price,sale_price,sale_code from dphoneSaleCode  where region_code='" + regionCode + "' and sale_type='29' and valid_flag='Y'";
  ...
  with(document.frm){
	...
	if (IMEINo.value.length == 0) {
     ...
     if (secondphone.value.length == 0) {
      rdShowMessageDialog("语音卡号码不能为空，请重新输入 !",1);
      secondphone.focus();
      confirm.disabled = true;
	  return false;
     }
     ...
     if(opNote.value=="")
     {
			opNote.value=phone_no.value+"办理购G3上网卡业务";
		}
...
function printInfo(printType)
{
	...
	opr_info+="业务类型：购G3上网卡"+"|";
  	opr_info+="操作流水："+document.all.login_accept.value+"|"; 	 
  	opr_info+="数据卡赠送费用："+document.all.net_money.value+"元，分"+parseInt(document.all.Active_Term.value)+"个月赠送，"+parseInt(document.all.Active_Term.value)+"个月消费完毕|"; 
  	opr_info+="捆绑语音卡号码："+document.all.secondphone.value+"，语音卡赠送费用"+document.all.pay_money.value+"元，分"+parseInt(document.all.Consume_Term.value)+"个月赠送，"+parseInt(document.all.Consume_Term.value)+"个月消费完毕，";	
...
/****************根据agent_code动态生成phone_type下拉框************************/
 ...
 function typechange(){
  ...
  function salechage(){
    ...
    document.all.opNote.value = "用户"+document.all.phoneNo.value+"办理购G3上网卡";
}
function checksec()
{
	...
	{
      rdShowMessageDialog("语音卡号码不能为空，请重新输入 !");
	...
	{
      rdShowMessageDialog("语音卡号码不能与数据卡号码相同，请重新输入 !");
      document.frm.secondphone.focus();
      document.frm.checkimei.disabled = true;
	  return false;
     } 
	...
	myPacket.data.add("iOpCode","8356");
...
<body>
<form name="frm" method="post" action="f8356_2.jsp" onKeyUp="chgFocus(frm)">
<%@ include file="/npage/include/header.jsp" %>
  ...
  <table  cellspacing="0">
	...
	<tr>
            ...
            <td >
						  <input Class="InputGrey" name="price" type="text"  id="price" readonly v_name="上网卡价格" >
						  <font class="orange">*</font>
						</td>
            <td class="blue">赠送话费</td>
            <td>
						  <input Class="InputGrey" name="pay_money" type="text"   id="pay_money" v_name="赠送话费" readonly>
						  <font class="orange">*</font>
						</td>
	</tr>
	<tr>
		<td class="blue">话费消费期限</td>
            <td>
						  <input Class="InputGrey" name="Consume_Term" type="text" id="Consume_Term" v_name="话费消费期限" readonly>
						  <font class="orange">*</font>
						</td>
            <td class="blue">赠上网流量费</td>
            <td >
						  <input Class="InputGrey" name="net_money" type="text"  id="net_money" v_name="赠上网流量费" readonly>
						  <font class="orange">*</font>
						</td>
	</tr>
    <tr>
            ...
            <td>
						  <input Class="InputGrey" name="Active_Term" type="text"   id="Active_Term" v_name="上网费消费期限" readonly>
						  <font class="orange">*</font>
						</td>
	...
	<tr>
			...
			<td>
				 <input Class="InputGrey" name="secondname" type="text" id="secondname" readonly> 
				 <font color="orange">*</font>
			</td> 
	</tr>
	<tr>
	...
	<tr>
            ...
            <td colspan="3">
             <input name="opNote" type="text"  id="opNote" size="60" maxlength="60" value="购G3上网卡" >
            </td>
	</tr>
	</table>
    </div>
    ...
    <input type="hidden" name="sale_type" value="29" >
