...
<%
  ...
  %>
		...
		<wtc:pubselect name="TlsPubSelCrm" outnum="2" retmsg="msg1" retcode="code1" routerKey="region" routerValue="<%=regionCode%>">
  	 <wtc:sql><%=sql%></wtc:sql>
 	  </wtc:pubselect>
...
/***************需要判断工号是否是集团工号*****************/
  ...
  String sql1 = " select to_char(count(*)) from shighlogin where login_no=:workno and op_code='2294'";
  System.out.println("sql1====="+sql1);
  //ArrayList agentCodeArr1 = co1.spubqry32("1",sql1);
  	String [] paraIn = new String[2];
    paraIn[0] = sql1;    
    paraIn[1]="workno="+work_no;
  %>
  
	<wtc:service name="TlsPubSelCrm" outnum="1" retmsg="msg2" retcode="code2" routerKey="region" routerValue="<%=regionCode%>">
