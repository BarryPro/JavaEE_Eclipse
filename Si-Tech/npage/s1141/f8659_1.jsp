 ...
 function printCommit()
 {
  ...
  with(document.frm){
	...
	if (IMEINo.value.length == 0) {
     ...
     if(opNote.value=="")
     {
			opNote.value=phone_no.value+"办理购G3手机，赠话费业务";
		}
...
function printInfo(printType)
{
   var cust_info="";
	...
	opr_info+="用户品牌："+document.all.sm_code.value+" 办理业务：购G3手机，赠话费 业务执行时间："+document.all.payTime.value+"|";
   ...
   <table cellspacing="0">
         <tr>
          ...
          <tr>
            ...
            <td >
						  <input name="card_money" type="text"  id="card_money" v_type="money" v_must=1   readonly v_name="卡类金额" >
						  <font class="orange">*</font>
						</td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
        ...
        <TR>
		  ...
		  <tr>
            ...
            <td colspan="3">
             <input name="opNote" type="text"  id="opNote" size="60" maxlength="60" value="购G3手机，赠话费" >
            </td>
          </tr>
