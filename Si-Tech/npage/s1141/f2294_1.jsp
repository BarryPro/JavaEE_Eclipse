...
%>
 <%  //优惠信息//********************得到营业员权限，核对密码，并设置优惠权限*****************************//   
  ...
  <%
  	System.out.println("==第二批======s2287.jsp==== pwrf = " + pwrf);
	 ...
	 <td class="blue">应交预存</td>
          ...
          <tr> 
            <td colspan="4" id="footer"> <div align="center"> 
                ...
                &nbsp; 
                <input name="back" onClick="window.location='f2294_login.jsp?activePhone=<%=phoneNo%>'" class="b_foot"  type="button"  value="返回">
                &nbsp; </div></td>
          </tr>
        </table>
