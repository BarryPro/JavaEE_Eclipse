...
function selQry()
{
	if(document.all.confirmFlag.value=="oprPromptConfirm")
	{
		...
		document.qryOprInfoFrame.location = "f9898_2.jsp?phoneNo="+phoneNo;
...
<table cellspacing="0">
    <tr>
    	...
    	<td colspan="3">
    		<input name="phoneNo" type="text" class="button" size="25" maxlength="11" id="phoneNo"  v_must=1 v_type=0_9 v_name="手机号码">
    	</td>
  	</tr>
  	<tr> 
