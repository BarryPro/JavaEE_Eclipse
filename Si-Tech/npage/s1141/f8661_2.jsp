...
<%
	...
	String card_money=request.getParameter("card_money");  /*上网费*/
	...
	paraAray[10] = request.getParameter("card_money");     /*上网费*/
...
%>
<script language="JavaScript">
	rdShowMessageDialog("购上网本，赠上网费申请失败!(<%=errMsg%>",0);
