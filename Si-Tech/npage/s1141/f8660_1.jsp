...
System.out.println("**************************1");
  ...
  //rdShowMessageDialog("此用户为已中奖用户，中奖奖品为："<%=awardName%>", 请用户完好无损返回奖品，再继续办理冲正业务！");
   	if(rdShowConfirmDialog("此用户为已中奖用户，中奖奖品为：<%=awardName%> 请用户完好无损返回奖品，再继续办理冲正业务！")!=1)
		{
			location='f8659_login.jsp?activePhone=<%=phoneNo%>';
		}
	</script>
...
function printInfo(printType)
{
	...
	//}
	jkinfo="退款合计："+document.all.sum_money.value+"元";
	opr_info+=jkinfo+"|";
	note_info1+="备注；"+"|";
...
<body>
<form name="frm" method="post" action="f8660_2.jsp" onKeyUp="chgFocus(frm)">
        ...
        <tr>
          ...
          <tr>
            ...
            <td colspan="3">
			     ...
			     <input name="opNote" type="text"  id="opNote" size="60" maxlength="60" value="购G3手机，赠话费冲正" >
