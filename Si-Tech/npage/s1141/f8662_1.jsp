...
<%	}
	...
	//sunzx add end
%>
<wtc:service  name="s8660Qry" routerKey="phone" routerValue="<%=phoneNo%>" outnum="27"  retcode="errCode" retmsg="errMsg">
 ...
 */
  ...
  String vspec_name="",vmode_code="",vused_date="",vspec_fee="",net_fee="",phone_fee="";
...
function printInfo(printType)
{
	...
	opr_info+="业务类型：购G3笔记本冲正"+"|";
	
	opr_info+="业务流水："+document.all.login_accept.value+"|";
	opr_info+="笔记本型号: "+document.all.type_name.value+"|";

	var jkinfo="";
	jkinfo="退款合计："+document.all.sum_money.value+"元  含预存话费"+document.all.pay_money.value+"元,上网费"+document.all.net_fee.value+"元|";
...
<body>
<form name="frm" method="post" action="f8662_2.jsp" onKeyUp="chgFocus(frm)">
<%@ include file="/npage/include/header.jsp" %>
	...
	<tr>
             ...
             <td>
					<input name="net_fee" type="text"  id="net_fee" v_type="money" v_must=1 v_name="上网费" value="<%=net_fee%>" readonly>
					<font class="orange">*</font>
			</td>
	...
	<tr>
          <td class="blue">购笔记本款</td>
            <td>
			  		<input name="phone_fee" type="text" id="phone_fee"  v_name="购笔记本款" value="<%=phone_fee%>" readonly>
			  		<font class="orange">*</font>
			</td>
	...
	<tr>
            <td class="blue" >备注</td>
            <td colspan="3">
			     <input name="opNote" type="text"  id="opNote" size="60" maxlength="60" value="购上网本，赠上网费冲正" >
            </td>
	</tr>
	<tr>
