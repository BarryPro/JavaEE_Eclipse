...
if ( ajaxType.equals("getM") )
{
	...
	System.out.println("1141~~~~inLoginAccept="+inLoginAccept);
	System.out.println("1141~~~~inChnSource="+inChnSource);
	System.out.println("1141~~~~inOpCode="+inOpCode);
	System.out.println("1141~~~~inLoginNo="+inLoginNo);
	System.out.println("1141~~~~inLoginPwd="+inLoginPwd);
	System.out.println("1141~~~~inPhoneNo="+inPhoneNo);
	System.out.println("1141~~~~inUserPwd="+inUserPwd);
	System.out.println("1141~~~~inOpNote="+inOpNote);
	System.out.println("1141~~~~inregioncode="+inregioncode);
	System.out.println("1141~~~~inMarkPoint="+inMarkPoint);
	System.out.println("1141~~~~inMachPrice="+inMachPrice);
