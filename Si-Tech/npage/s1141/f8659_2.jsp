...
<%
	...
	/* ningtn add for pos start @ 20100722 */
%>
<wtc:service  name="s8659Cfm" routerKey="region" routerValue="<%=orgCode%>" outnum="2"  retcode="errCode" retmsg="errMsg">
...
<script language="JavaScript">
   ...
   infoStr+="<%=work_no%>  <%=paraAray[0]%>"+"     购G3手机，赠话费"+"|";//工号
...
%>
<script language="JavaScript">
	rdShowMessageDialog("购G3手机，赠话费失败!(<%=errMsg%>",0);
