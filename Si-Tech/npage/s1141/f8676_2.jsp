...
<%
  String opCode = "8676";     
  String opName = "输入手机号码查询所绑定的笔记本IMEI码";
  ...
  String retFlag="",retMsg="",passwordFromSer="",imei_no="",machineType="",totalDate="",custPhone="";
...
<div id="Operation_Table"> 
  ...
  <table  cellspacing="0">
	<tr>
            <td class="blue">笔记本IMEI码</td>
            <td>
            			<input name="imei_no" value="<%=imei_no%>" type="text" Class="InputGrey" v_must=1 readonly id="imei_no" maxlength="20" >
            </td>			
