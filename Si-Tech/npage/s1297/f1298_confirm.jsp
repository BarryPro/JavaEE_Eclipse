...
<%	
	...
	System.out.println("printAcceptprintAcceptprintAcceptprintAccept="+printAccept);
...
<script language="JavaScript">
   rdShowMessageDialog("12580销户成功! 下面将打印发票！",2);
   var infoStr="";
   infoStr+=" "+"|";
...
%>
<script language="JavaScript">
   rdShowMessageDialog("12580销户成功!",2);
  history.go(-2);
</script>
<%
		}
...
%>   
<script language="JavaScript">
	rdShowMessageDialog("12580销户失败!<br>errCode: <%=errCode%><br>errMsg: <%=errMsg%>",0);
	history.go(-1);
</script>
<%}%>
