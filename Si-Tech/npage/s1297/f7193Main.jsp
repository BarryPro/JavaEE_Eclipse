...
<%
	String opCode = "7193";	
	String opName = "12580移动秘书台冲正";		//header.jsp需要的参数   
...
<html>
	...
	<!--
	  ...
	  function printInfo(printType)
	  {
		...
		opr_info+="用户品牌："+sm_name+"      "+"办理业务：12580移动秘书 冲正"+"|";
		opr_info+="操作流水:"+"<%=printAccept%>"+"|";
		opr_info+="业务类型："+"<%=month_name%>"+"|" ;
        ...
        <table cellspacing="0">
	          ...
	          <tr>
	           ...
	           <tr>
		            <td class="blue">备注</td>
		            <td colspan="3" >
		            	<input name="opNote" type="text" readonly class="InputGrey" id="opNote" size="60" maxlength="60" value="<%="用户" + phoneNo +"，冲正"%>">
		            </td>		        
	          </tr> 
	  </table>
	  <table cellspacing="0">
