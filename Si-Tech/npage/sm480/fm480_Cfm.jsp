...
<%
    ...
    String m479LoginAccept="";
    if(backInfo.length>0){
    	m479LoginAccept = backInfo[0][0];
    	System.out.println("###################################f1213->f1213LoginAccept->"+m479LoginAccept);
    }
    //增加统一接触	
    String opBeginTime1  = new java.text.SimpleDateFormat("yyyyMMddHHmmss").format(new java.util.Date());//业务开始时间
	String url = "/npage/contact/upCnttInfo.jsp?opCode="+inPubParams[0]+"&retCodeForCntt="+retCode+"&opName=综合变更&workNo="+inPubParams[6]+"&loginAccept="+m479LoginAccept+"&pageActivePhone="+inPubParams[2]+"&retMsgForCntt="+errMsg+"&opBeginTime="+opBeginTime1;
%>
