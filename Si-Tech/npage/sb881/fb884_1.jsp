    ...
    <table cellspacing="0">
      ...
      <tr>
        <td colspan="4" id="footer">
          ...
          <input class="b_foot" type=button name="confirm1" value="发票查询" onClick="doQryBill(this)" index="2">
