    ...
    <script language="javascript">
 	      rdShowMessageDialog("补收SIM卡费冲正操作成功！",2);
 	          ...
 	          var  billArgsObj = new Object();
						...
						$(billArgsObj).attr("10030","<%=liushis%>"); //流水号--业务流水
						...
						$(billArgsObj).attr("11215","<%=liushis%>"); //流水号--业务流水
						$(billArgsObj).attr("11216","<%=op_date%>"  ); //原业务日期	
						
						var path = "/npage/public/billPrtNew/Bill_ELE_Prt.jsp?dlgMsg=下面将打印发票！";
