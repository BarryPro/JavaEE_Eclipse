 ...
 var simstatuss="";
  for(var i=0;i<radio1.length;i++)
  {
    ...
    if(opFlag=="") {
		...
		var op_date = $("#t1").find("input[type='radio']:checked").parent().parent().find("td:eq(2)").text().trim();
		if(op_date.length>6){
			op_date = op_date.substring(0,6);
		}
		
	    		
				document.form1.confirm.disabled=true;
	     
				document.form1.action = "fm265Cfm.jsp?op_date="+op_date;
