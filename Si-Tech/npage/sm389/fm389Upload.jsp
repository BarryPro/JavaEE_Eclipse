...
<%
	try{
		...
		String printAccept = mySmartUpload.getRequest().getParameter("loginAccept");
		String opCode = mySmartUpload.getRequest().getParameter("opCode");
		String srv_no = mySmartUpload.getRequest().getParameter("srv_no");
		boolean haveOldPhone = false;
	...
	}else if(!haveOldPhone){
		%>
	  		<script language="javascript">
					/*不包含原服务号码*/
					window.parent.tellNotHaveOldPhone("<%=srv_no%>");
				</script>
	  <%
