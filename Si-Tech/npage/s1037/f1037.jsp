...
function doProcess(packet){
	...
	if (errorCode=="0")
	{
		if(verifyType=="query")
		{
			...
			document.all.sys_note.value=document.all.grp_product.value+"集团产品包年续签冲正:<%=workno%>对集团产品ID"+user_id;
...
function doQuery()
{
	var myPacket = new AJAXPacket("f1037_rpc_query.jsp","正在获得查询信息，请稍候......");	
...
function doSubmit()
{
	var myPacket = new AJAXPacket("f1037_rpc_submit.jsp?sys_note="+document.all.sys_note.value+"&to_note="+document.all.to_note.value,"正在进行冲正，请稍候......");	
