...
function getInfo(){
	...
	var myPacket = new AJAXPacket("getSel.jsp?custid="+custid,"正在查询，请稍候......");
...
<table cellspacing="0">
	<tr colspan = 2>
		<td class="blue" colspan = 2  >操作类型 &nbsp;&nbsp;&nbsp;&nbsp;
			<input type="radio" name="opFlag" id="type1" value="one"   onclick = "opchange()" checked = "checked" >IP PBX业务录入&nbsp;&nbsp;
			<!--xl 新加冲正--> 
			<input type="radio" name="opFlag" id="type2" value="two"   onclick = "opchange()">IP PBX数据修改
		</td>
	</tr>    
	 <tr colspan = 2>
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<input type="button" name="query" class="b_text" value="查询" onclick="selectCust()" ></td>
...
<table cellSpacing="0">
    <tr> 
      <td id="footer"> 
              <input type="button" name="query_do" class="b_foot" value="信息录入" onclick="commit()" >
          &nbsp;
