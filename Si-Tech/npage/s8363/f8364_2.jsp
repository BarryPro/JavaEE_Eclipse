...
<%	
	  ...
	  String iOpCode = request.getParameter("opCode");
		...
		String iPhoneNo = "";
		String iUserPwd = "";
		String loginNoStr = request.getParameter("loginNoStr");
		String opCodeAddStr = request.getParameter("opCodeAddStr");
		String limitValueStr = request.getParameter("limitValueStr");
		String opCount = request.getParameter("opCount");
		String opType = "A";
...
<%
	    if(errCode.equals("0")||errCode.equals("000000")){
      	System.out.println("调用服务s8364Cfm in f8364_2.jsp 成功@@@@@@@@@@@@@@@@@@@@@@@@@@");
%> 
	      <script language="JavaScript">
					rdShowMessageDialog("操作成功!",2);
					window.location="f8364_1.jsp?opCode=<%=iOpCode%>";
				</script>
<%     		        	
 	    }else{
	 			System.out.println("调用服务s8364Cfm in f8364_2.jsp 失败@@@@@@@@@@@@@@@@@@@@@@@@@@");
