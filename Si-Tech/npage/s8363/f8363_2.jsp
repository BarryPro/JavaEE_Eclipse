...
<%	
	  ...
	  String iOpCode = request.getParameter("opCode");
		...
		String macAddrStr = request.getParameter("macAddrStr");
...
<%
	    if(errCode.equals("0")||errCode.equals("000000")){
      	System.out.println("调用服务s8363Cfm in f8363_2.jsp 成功@@@@@@@@@@@@@@@@@@@@@@@@@@");
%> 
	      <script language="JavaScript">
					rdShowMessageDialog("操作成功!",2);
					window.location="f8363_1.jsp?opCode=<%=iOpCode%>";
				</script>
<%     		        	
 	    }else{
	 			System.out.println("调用服务s8363Cfm in f8363_2.jsp 失败@@@@@@@@@@@@@@@@@@@@@@@@@@");
