...
<%	
	  ...
	  String iOpCode = request.getParameter("opCode");
		...
		paramsIn[5]  = iPhoneNo;
		paramsIn[6]  = iUserPwd;
		paramsIn[7]  = temloginNo;
		paramsIn[8]  = temopCode;
		paramsIn[9]  = temlimitValue;
		paramsIn[10]  = opCount;
		paramsIn[11]  = opType;
...
<%
	    if(errCode.equals("0")||errCode.equals("000000")){
      	System.out.println("调用服务s8364Cfm in f8364_3del.jsp 成功@@@@@@@@@@@@@@@@@@@@@@@@@@");
%> 
	      <script language="JavaScript">
					rdShowMessageDialog("操作成功!",2);
					window.location="f8364_3.jsp?opCode=<%=iOpCode%>&loginNo=<%=temloginNo%>";
				</script>
<%     		        	
 	    }else{
	 			System.out.println("调用服务s8364Cfm in f8364_3del.jsp 失败@@@@@@@@@@@@@@@@@@@@@@@@@@");
