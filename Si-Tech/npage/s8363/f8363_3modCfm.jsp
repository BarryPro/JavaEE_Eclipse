...
<%	
	  ...
	  String iOpCode = request.getParameter("opCode");
		...
		String opCount = "";
		String opType = "U";
		String macAddrOld = request.getParameter("macAddrOld");
...
<%
	    if(errCode.equals("0")||errCode.equals("000000")){
      	System.out.println("调用服务s8363Cfm in f8363_3modCfm.jsp 成功@@@@@@@@@@@@@@@@@@@@@@@@@@");
%> 
	      <script language="JavaScript">
					rdShowMessageDialog("操作成功!",2);
					window.location="f8363_3.jsp?opCode=<%=iOpCode%>&groupId=<%=groupidStr%>";
				</script>
<%     		        	
 	    }else{
	 			System.out.println("调用服务s8363Cfm in f8363_3modCfm.jsp 失败@@@@@@@@@@@@@@@@@@@@@@@@@@");
