...
String phoneNo = request.getParameter("phone_kd"); //request.getParameter("phoneNo");
System.out.println("phoneNo="+phoneNo);
String contract_no = request.getParameter("contract_kd");// contract_no
...
String sql="";
String errMsg="";
String rtnPage = "/npage/e032/e032_1.jsp";
String password="";
int row_count = 51;
int num=0;
...
<div  id="article">
 ...
 <div align="center"><h2><b>中国移动通信宽带客户账单</b></h2></div> 
...
<div align="center">
  ...
  codebase="smsx.cab#Version=6,3,436,14">
    ...
    -->
	 &nbsp;&nbsp;&nbsp;&nbsp;
	 <input type="button"  class="b_foot"value="返回" title="返回" onClick="window.location='e032_1.jsp?opCode=e610&opName=统一账单打印&crmActiveOpCode=e610'" align="center"/>
	 &nbsp;&nbsp;&nbsp;&nbsp;
