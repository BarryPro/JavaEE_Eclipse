...
<%
	...
	if(result12!=null&&result12.length>0){
				...
				System.out.println("QQQQQQQQQQQQQQQQ phone_new is "+phone_new);
				%>
			//	alert("QQQQQQQQQQQQQQQQ phone_new is "+"<%=phone_new%>");
				<%
	 }else{
