<%
	...
	if((flag=="0")||flag.equals("0")  )
	{
		...
		filedownload= bak_dir+region_code+"_"+year_month+"used"+".txt";
	}
	if((flag=="1") || flag.equals("1"))
	{
		System.out.println("AAAAAAAAAAAAAAAAAA qx级明细");
		filedownload= bak_dir+region_code+"_"+dis_code+"_"+year_month+"used"+".txt";
	}
    ...
    try
    {
		if(!f.exists())
		{
		   ...
		   out.println("<SCRIPT LANGUAGE=\"JavaScript\">alert(\"您下载的文件不存在!\");window.location.href=\"g557_1.jsp\";</SCRIPT>");	
