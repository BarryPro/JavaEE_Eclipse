...
<script type="text/javascript" src="<%=request.getContextPath()%>/njs/plugins/stTree.js"></script>
...
<script type="text/javascript" src="<%=request.getContextPath()%>/njs/si/rewriteSMD.js"></script>
