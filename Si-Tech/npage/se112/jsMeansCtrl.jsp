...
function doserviceGetMeans(packet){
	...
	if(RETURN_CODE!="0"){
		showDialog("结果:"+RETURN_MSG+"|原因:"+DETAIL_MSG,0,'retT=window.location.reload(true);retF=cancelAction();closeFunc=window.location.reload(true)');
		return false;
	}	
...
function calcMoney(meansFalg){
	...
	if("1"==meansFalg.charAt(1)){
		...
		//add zhangxy20170417 payment_type != "6" && for 短厅魔百盒续签
