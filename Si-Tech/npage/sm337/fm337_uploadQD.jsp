...
try
{
	...
	qudaodaoruType = mySmartUpload.getRequest().getParameter("qudaodaoruType");
	if(!fileNew.exists())  
	{
		fileNew.mkdirs();
	}
...
%>
	...
	<wtc:service name="sAreaBatchDeal" outnum="30" routerKey="region" routerValue="<%=regCode%>"  retcode="rc_fnDoGetProdInst" retmsg="rm_fnDoGetProdInst" >
        ...
        <wtc:param value="<%=qudaodaoruType%>"/>					
	</wtc:service>
