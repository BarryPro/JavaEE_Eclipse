...
<%
    ...
    String xiaoqumingchengss = request.getParameter("xiaoqumingchengss");
    String selType = request.getParameter("selType");
    String retQuence = request.getParameter("retQuence");
    String offeridband = request.getParameter("offeridband");
...
<%  //绘制界面表头
     ...
     fieldNum = String.valueOf(tempNum);
     	...
     	String work_no = (String)session.getAttribute("workNo");	
			...
			String beizhuss =work_no+"进行宽带小区查询";
...
%>
	...
	<wtc:service name="sM337KDQry" routerKey="region" routerValue="<%=regionCode%>" retcode="retCode" retmsg="retMsg" outnum="6">
			...
			<wtc:param value=""/>
			<wtc:param value="<%=xiaoqumingchengss%>"/>
			<wtc:param value="<%=offeridband%>"/>
	</wtc:service>
      		   ...
      		   String tdClass = ((i%2)==1)?"Grey":"";
      		    ...
      		    for(int j=0;j<Integer.parseInt(fieldNum);j++)
      		    {
                    ...
                    withssss="width=50%";
          		        ...
          		        inputStr = inputStr + "<TD "+withssss+" title=\'"+(result[i][j]).trim()+"\' class='"+tdClass+"'>&nbsp;" + (result[i][j]).trim() + "<input type='hidden' " +
          		            " id='Rinput" + i + j + "'  value='" +
          		            (result[i][j]).trim() + "'readonly></TD>";
                    }
      		    }
      		    ...
      		    out.print("<TD colspan='6'>查询失败！错误代码："+retCode+"，错误信息："+retMsg);
      		    out.print("</TD>");
      		    out.print("</TR>");
      		    }
%>
