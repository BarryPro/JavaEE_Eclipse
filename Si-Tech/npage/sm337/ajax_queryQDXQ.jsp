...
<%        
	...
	String showTip = "点击任意行小区信息可以查询对应营业厅和营业厅名称信息";
	...
	String  inputParsm [] = new String[17];
			...
			inputParsm[5] = "";
			inputParsm[6] = "";
			String beizhuss =work_no+"进行渠道小区查询";

%>

<wtc:service name="sM337KDQry" routerKey="region"
...
<body>
	...
	<div id="Operation_Table">
		<div class="title">
			<div id="title_zi">
				小区信息(<font color='red'><%=showTip%></font>)
			</div>
		</div>
		<table cellspacing="0">
			<tr align="center">
		...
		%>
			...
			<tr align="center" onclick="querygroupidajax('<%=result2[y][1]%>');">
		...
		%>
			<tr height='25' align='center'>
				<td colspan='6'>查询小区信息为空！</td>
			</tr>
			<%}}else {
			%>
			<tr height='25' align='center'>
				<td colspan='6'>查询小区信息失败：<%=retCode%>--<%=retMsg%></td>
			</tr>
