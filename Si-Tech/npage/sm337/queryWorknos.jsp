...
<%
    ...
    String sqlStr = request.getParameter("sqlStr"); // 修改为sqlid
...
<%  //绘制界面表头
     ...
     String sqlStrNote="select b.approval_login,a.login_name from dloginmsg a,dApprovalLoginMsg b where a.login_no=b.approval_login and substr(org_code,1,2)='"+regionCode+"'";
%>
