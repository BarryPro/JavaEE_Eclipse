...
System.out.println("====wanghfa====fe257_cfm.jsp====se257Cfm====0==== iLoginAccept = " + printAccept);
System.out.println("====wanghfa====fe257_cfm.jsp====se257Cfm====1==== iChnSource = 01");
System.out.println("====wanghfa====fe257_cfm.jsp====se257Cfm====2==== iOpCode = " + opCode);
System.out.println("====wanghfa====fe257_cfm.jsp====se257Cfm====3==== iLoginNo = " + workNo);
System.out.println("====wanghfa====fe257_cfm.jsp====se257Cfm====4==== iLoginPwd = " + password);
System.out.println("====wanghfa====fe257_cfm.jsp====se257Cfm====5==== iPhoneNo = " + phone);
System.out.println("====wanghfa====fe257_cfm.jsp====se257Cfm====6==== iUserPwd = ");
System.out.println("====wanghfa====fe257_cfm.jsp====se257Cfm====7==== iOpNote = " + opNote);
System.out.println("====wanghfa====fe257_cfm.jsp====se257Cfm====8==== iAllFee = " + prePayFee);
System.out.println("====wanghfa====fe257_cfm.jsp====se257Cfm====9==== iMyFee = " + myFee);
System.out.println("====wanghfa====fe257_cfm.jsp====se257Cfm===10==== iTranPhoneStr = " + tranPhoneStr);
System.out.println("====wanghfa====fe257_cfm.jsp====se257Cfm===11==== iTranFeeStr = " + tranFeeStr);
System.out.println("====wanghfa====fe257_cfm.jsp====se257Cfm===12==== iWinAccept = " + partInAccept);
System.out.println("====wanghfa====fe257_cfm.jsp====se257Cfm===13==== iSProjectCode = " + projectCode);
System.out.println("====wanghfa====fe257_cfm.jsp====se257Cfm===14==== iSGradeCode = " + sGradeCode);
System.out.println("====wanghfa====fe257_cfm.jsp====se257Cfm===15==== iOldTranPhoneStr = ");
System.out.println("====wanghfa====fe257_cfm.jsp====se257Cfm===16==== iIpAddr = " + ipAddr);
%>
...
<%
System.out.println("====wanghfa====fe257_cfm.jsp====se257Cfm==== " + retCode1 + ", " + retMsg1);
