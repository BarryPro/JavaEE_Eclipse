...
<TABLE cellSpacing=0 id="userBaseInfoTab">
  <TR class=t2>
    ...
    <TD><input type="text" name="contactCustName" id="contactCustName" class="" maxlength="15"> <font class="orange">*</font>  </TD>
	<td class="blue">联系电话</td>
    <TD><input type="text" name="contactPhone" id="contactPhone" class=""> <font class="orange">*</font> </TD>
</TR>
<TR class=t2>
...
<TR class=t2>
  ...
  <td>
	<select name="openType" id="openType" disabled>
    ...
    <TD>
	<input type="text" name="limitOwe" id="limitOwe" class="forReal" value="0" disabled />
	</TD>
</TR>
<TR class=t2>
  ...
  <td colspan=3 >
	<select name="addCmgr" id="sfgz2" disabled>
...
<TR class=t2>
  ...
  <input type="text" name="yzID" id="yzID"  value="" readonly>
	...
	<td>
		<input type="text"  disabled value="<%=groupId%>" name="userGroupName"  v_name="userGroupName"  v_must="1"  id="userGroupName" class="required" readonly>
