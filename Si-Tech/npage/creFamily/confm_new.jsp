...
String paramValue_zhaz="N";
	...
	if("101".equals(brandId))
	{
		...
		}else if(serviceNo.substring(0,5).equals("10647")){
			serviceNo = "206" + serviceNo.substring(5,serviceNo.length());
		}else if(serviceNo.substring(0,5).equals("10648")){
			serviceNo = "205" + serviceNo.substring(5,serviceNo.length());
		}
	}
	
	System.out.println("gaopeng22222222222222-----------------serviceNo="+serviceNo);
