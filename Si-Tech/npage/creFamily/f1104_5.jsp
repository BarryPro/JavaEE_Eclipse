...
*/
      ...
      /*end diling add*/
		...
		String[] paraStrIn = new String[]{sIn_Phone_no,sIn_OrgCode,sIn_Sm_code,sIn_Sim_no,sIn_Sim_type,sIn_zph,sIn_cardtype,sIn_workno,custIccid};
...
<%   
		...
		System.out.println("# return by sGoodNoCheck - > retCode12 = "+retCode12);
		...
		System.out.println("zhouby: region_code =" + region_code);
