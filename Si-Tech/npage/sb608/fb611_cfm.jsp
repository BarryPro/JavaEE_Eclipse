...
<%
	...
	System.out.println("=========wanghfa========= fb611_cfm.jsp " + opCode + ", " + opName);
	...
	System.out.println("===========wanghfa=sB608Cfm==5====== 家长号码 = " + fatherPhone3);
...
%>
<wtc:service name="sB608Cfm" routerKey="phone" routerValue="<%=fatherPhone3%>" retcode="retCode1" retmsg="retMsg1" outnum="2">
...
//为统一接触  start
	String sqlFindIdno = "select id_no from dcustmsg where phone_no = '" + fatherPhone3 + "'";
%>
...
<%
	...
	System.out.println("%%%%b611%%%调用统一接触开始%%%%%%%%");
	String url = "/npage/contact/upCnttInfo.jsp?opCode=" + opCode + "&opName=" + opName + "&workNo="
		...
		+ fatherPhone3 + "&contactType=user&contactId=" + idNo + "&retMsgForCntt=" + retMsg1
		+ "&opBeginTime=" + myOpBeginTime;
	System.out.println("url = " + url);
%>
	<jsp:include page="<%=url%>" flush="true" />
<%	
	System.out.println("%%%%b611%%%调用统一接触结束%%%%%%%%");
//为统一接触  end
...
%>
		<script language=javascript>
			rdShowMessageDialog("<%=fatherPhone3%>的三口之家解散家庭业务办理成功！", 2);
