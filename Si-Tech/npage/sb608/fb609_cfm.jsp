...
<%
	...
	System.out.println("=========wanghfa========= fb609_cfm.jsp " + opCode + ", " + opName);
	...
	System.out.println("===========wanghfa=sB608Cfm==5====== 家长号码 = " + fatherPhone1);
	System.out.println("===========wanghfa=sB608Cfm==6====== 家长密码 = ");
	System.out.println("===========wanghfa=sB608Cfm==7====== 成员号码 = " + memberPhone1);
...
%>
<wtc:service name="sB608Cfm" routerKey="phone" routerValue="<%=memberPhone1%>" retcode="retCode1" retmsg="retMsg1" outnum="2">
...
//为统一接触  start
	String sqlFindIdno = "select id_no from dcustmsg where phone_no = '" + memberPhone1 + "'";
%>
...
<%
	...
	String url = "/npage/contact/upCnttInfo.jsp?opCode=" + opCode + "&opName=" + opName + "&workNo="
		...
		+ memberPhone1 + "&contactType=user&contactId=" + idNo + "&retMsgForCntt=" + retMsg1
...
%>
		<script language=javascript>
			rdShowMessageDialog("<%=memberPhone1%>的三口之家加入家庭业务办理成功！", 2);
