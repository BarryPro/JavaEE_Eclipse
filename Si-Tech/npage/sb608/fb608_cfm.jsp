...
<%
	...
	System.out.println("=========wanghfa========= fb608_cfm.jsp " + opCode + ", " + opName);
	...
	System.out.println("===========wanghfa=sB608Cfm==5====== 家长号码 = " + fatherPhone0);
	System.out.println("===========wanghfa=sB608Cfm==6====== 家长密码 = ");
	System.out.println("===========wanghfa=sB608Cfm==7====== 成员号码 = ");
...
%>
<wtc:service name="sB608Cfm" routerKey="phone" routerValue="<%=fatherPhone0%>" retcode="retCode1" retmsg="retMsg1" outnum="2">
...
//为统一接触  start
	String sqlFindIdno = "select id_no from dcustmsg where phone_no = '" + fatherPhone0 + "'";
%>
...
<%
	...
	String url = "/npage/contact/upCnttInfo.jsp?opCode=" + opCode + "&opName=" + opName + "&workNo="
		...
		+ fatherPhone0 + "&contactType=user&contactId=" + idNo + "&retMsgForCntt=" + retMsg1
...
%>
		<script language=javascript>
			rdShowMessageDialog("<%=fatherPhone0%>的三口之家家庭建立业务办理成功！", 2);
