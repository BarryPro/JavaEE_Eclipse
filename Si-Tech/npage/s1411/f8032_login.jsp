...
<form name="frm" method="POST" onKeyUp="chgFocus(frm)">
 ...
 <input type="hidden" name="dept" >
	  ...
	  <TR> 
          ...
          <TD>
			<input type="radio" name="opFlag" value="one" onclick="opchange()" <%if(opCode.equals("8032")){%> checked <%}%>>申请&nbsp;&nbsp;
			<input type="radio" name="opFlag" value="two" onclick="opchange()" <%if(opCode.equals("8033")){%> checked <%}%>>冲正
	      </TD>
       </TR>    
         <tr> 
            <td class="blue"> 
