...
//***
 function getInfo_code()
 {
    ...
    var sqlStr = "";
    	sqlStr = "select a.order_code,trim(a.order_name),a.prepay_fee,a.bind_mode,to_char(b.prepay_least) "+
				 "from sPrePayCompute a,sbillmoderelease b "+
				 "where a.region_code= '01' "+
				 "and sysdate between a.begin_time and a.end_time "+
				 "and a.region_code=b.group_id and a.bind_mode=b.mode_code "+
