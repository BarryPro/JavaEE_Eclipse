...
%>
	<wtc:service name="e632Cfm" routerKey="region" routerValue="<%=regionCode%>" retcode="retCode1" retmsg="retMsg1" outnum="3" >
...
<script language="JavaScript">
	...
	window.location.href="e632_1.jsp?opCode=<%=opCode%>&opName=<%=opName%>";
</script>
<%}else{%>
	<script language="JavaScript">
