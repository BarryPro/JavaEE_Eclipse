...
<%
	...
	String iProdOrderStr  = WtcUtil.repNull(request.getParameter("iProdOrderStr"));
	String sel_workNo     = WtcUtil.repNull(request.getParameter("sel_workNo"));                     
  ...
  String regionCode     = (String)session.getAttribute("regCode");
	...
	System.out.println("---hejwa---------iProdOrderStr-------------------"+iProdOrderStr);
	...
	paraAray[5] = "";                                  //用户号码
	paraAray[6] = "";                                       //用户密码
	paraAray[7] = sel_workNo;  

	String iProdOrderArr[] = iProdOrderStr.split("\\|");
	
	for(int j=0; j<iProdOrderArr.length; j++){
		System.out.println("-------hejwa------------iProdOrderArr["+j+"]------------->"+iProdOrderArr[j]+"---->");
	}
	String serverName = "sm426Cfm";
try{
%>
		<wtc:service name="<%=serverName%>" outnum="10" retmsg="msg" retcode="code" routerKey="region" routerValue="<%=regionCode%>">
				...
				<wtc:params value="<%=iProdOrderArr%>" />			
		</wtc:service>
