...
<div class="input">
 <table cellspacing="0">
      ...
      <TR> 
		  ...
		  <TD>
		   <%=stPMvPhoneNo%>
		   <input type="hidden" id="stPMvPhoneNo" name="stPMvPhoneNo" value="<%=stPMvPhoneNo%>"/>
		  </TD> 
      ...
      <td >
        ...
        <input type="hidden" name="stPMsm_code" id="stPMsm_code" value="<%=stPMsm_code%>">
...
%>
	...
	double dValueTemp1 = Double.parseDouble(prepay_feeStr) -Double.parseDouble(stPMtotalOwe);
	 ...
	 <%}else if( opCode.equals("3250") || opCode.equals("1272")){%>
