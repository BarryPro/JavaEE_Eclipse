...
String beizhu ="工号"+iLoginNo+"进行虚拟副号批量销户";
...
%>
	<script language="JavaScript">
		...
		window.location.href="fm166.jsp?opCode=<%=iOpCode%>&opName=<%=opName%>";
	</script>
<%
	}		
%>	
			...
			<tr>
			 ...
			 <tr> 
					<td align="center" colspan="2" id="footer">
						<input class="b_foot" name="sure"  type="button" value="返回"  onclick="window.location.href='fm166.jsp?opCode=<%=iOpCode%>&opName=<%=opName%>';">
