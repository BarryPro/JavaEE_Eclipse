...
<%
  ...
  inParas[0] = workno;
	...
	inParas[2] = org_id;
	inParas[3] = limit_type;
	inParas[4] = limit_day_spe;
	inParas[5] = limit_day_beg;
	inParas[6] = limit_day_end;
	inParas[7] = limit_month_spe;
	inParas[8] = limit_month_beg;
	inParas[9] = limit_month_end;
	inParas[10] = phone_no;
...
<wtc:service name="s4872Cfm" routerKey="regionCode" routerValue="<%=regionCode%>" retcode="return_code" retmsg="return_message" outnum="2">
...
%>
	  ...
	  document.location.replace("s4872.jsp");
<%
	} else {
%>
