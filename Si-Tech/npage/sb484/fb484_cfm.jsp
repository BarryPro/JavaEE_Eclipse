...
<%
	...
	System.out.println("==============wanghfa=====sB484Cfm=====4==== 渠道 = 01");
	System.out.println("==============wanghfa=====sB484Cfm=====5==== noPass = " + noPass);
	System.out.println("==============wanghfa=====sB484Cfm=====6==== 用户密码 = " + userPwd);
...
%>
		<script language="JavaScript">
			rdShowMessageDialog("sB484Cfm，错误代码：<%=retCode1%>，错误信息：<%=retMsg1%>", 0);
