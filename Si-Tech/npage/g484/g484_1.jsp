...
function commit(){
 ...
 function sel3(){
    window.location.href='g484_1.jsp';
 }
function sel4(){
 ...
 function init()
 {
	...
	String sql_init = "select S_INVOICE_NUMBER,E_INVOICE_NUMBER,INVOICE_CODE from WLOGININVOICE where LOGIN_NO = '"+login_no+"'  and flag='N' "; 
	%>
...
<BODY onload = "init()">
<form action="g484_cfm.jsp" method="post" name="frm">
