...
<%
		System.out.println("gaopengSeeLog===m336====");
...
<wtc:service name="sm336Qry" routerKey="regionCode" routerValue="<%=regCode%>" retcode="retCode" retmsg="retMsg" outnum="10">
...
<wtc:array id="result1" start="1" length="9"  scope="end"/>
...
<%
	...
	retCode11 = retCode;
	retMsg11 = retMsg;
	System.out.println("gaopengSeeLog===m336====retCode==="+retCode);
	System.out.println("gaopengSeeLog===m336====result1.length==="+result1.length);
			...
			%>
				...
				<%
					for(int j=0;j<result1[i].length;j++){
						...
						<%
						System.out.println("gaopengSeeLog====m336====infoArray["+i+"]["+j+"]====="+result1[i][j]);
					}
				%>
