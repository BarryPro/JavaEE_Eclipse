...
String regionCode = (String)session.getAttribute("regCode");	
	...
	String sqlStr1="";
	sqlStr1 ="select a.mode_code,a.mode_name, decode(a.mode_flag,'0','主产品','1','可选产品','2','附加产品',a.mode_flag),b.sm_code||'->'||b.sm_name from sBillModeCode a, sSmCode b where a.region_code = b.region_code and a.sm_code = b.sm_code and a.region_code='"+region_code+"' and mode_code like '%" + mode_code + "%' and rownum < 100 " +
...
<script>
		...
		function doCommit(){
			if("<%=retListString1.length%>"=="0"){
				rdShowMessageDialog("您没有选择任何产品代码！");
				return false;
			}
