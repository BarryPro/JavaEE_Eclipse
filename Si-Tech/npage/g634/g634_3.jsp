...
<%	
	...
	String op_code = "g634";//需要新申请             //操作代码
	String op_note = "紧急开机";//request.getParameter("op_note");              //备注
...
%>
<wtc:service name="sEmergencyBoot" routerKey="region" routerValue="<%=regionCode%>" retcode="s4141CfmCode" retmsg="s4141CfmMsg" outnum="2" >
