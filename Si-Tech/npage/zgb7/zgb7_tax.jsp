...
function doProcess(packet)
{
	...
	if(s_flag=="Y")
	{
		...
		if(s_flag_new=="O")
		{
			...
			document.frm.action="../zg23/zg23_2_new.jsp?s_flag=0&phone_no="+returnValue;
		...
		if(s_qry_flag=="1")
		{
			...
			document.frm.action="../zg23/zg23_2_new.jsp?s_flag=0&phone_no="+phone_no;
			//alert("test?"+document.frm.action);
			document.frm.submit();
		}
		else
 ...
 function sel1()
 {
	window.location.href='zgb7_1.jsp';
 }
 function sel2()
 {
	 window.location.href='zgb7_tax.jsp';
 }
 function sel3()
 {
...
<form action="" method="post" name="frm">
  ...
  <table cellSpacing="0">	 
	 <tr>
		...
		<td colspan="3">
			<input type="text" name="tax_no" maxlength=30  onKeyPress="return isKeyNumberdot(0)" >
		</td>
	 </tr>
