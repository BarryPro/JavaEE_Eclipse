...
String total_no = "";
	int flag = 0;
%>
	<wtc:service name="g959cfm" routerKey="regionCode" routerValue="<%=regionCode%>"  retcode="sReturnCode" retmsg="sErrorMessage"  outnum="21" >
...
%>
<HEAD><TITLE>黑龙江BOSS-空中充值批量导入</TITLE>
...
function gohome()
{
document.location.replace("g959_1.jsp");
}
-->
</script>
</HEAD>
<BODY>
<FORM action="g247_1.jsp" method=post name=form>
   ...
   <%@ include file="/npage/include/header.jsp" %>
		...
		<table cellspacing="0">
		   <tbody> 
		    <tr > 
		      <td colspan="2">
		        <div align="center">空中充值批量转账前台导入配置完成。
