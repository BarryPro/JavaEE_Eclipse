...
<!--	
 ...
 function doclear() {
   ...
   function docheck3()
   {
	  ...
	  // alert(s_new);
	   document.frm.action = "i086_2_qry.jsp?s_new="+s_new+"&level=1";
	   document.frm.submit();	
...
<form action="" method="post" name="frm">
	...
	<table cellspacing="0">
      ...
      <tr> 
        ...
        <td colspan="4"> 
		  ...
		  &nbsp;&nbsp;&nbsp;&nbsp;
		  <input name="busyType4" type="radio" onClick="sel2()" value="2" checked>一级账目项查询
		  &nbsp;&nbsp;&nbsp;&nbsp;
	...
	<tr>
		<td class="blue">一级账目项名称</td>
		<td>
			<select name=rpt_type style='width:400px'>
				<!--wanghfa 20100602 解耦修改 start-->
				<wtc:qoption name="TlsPubSelBoss" outnum="2">
					<wtc:sql>select trim(show_id),trim(show_id)||'-->'||trim(show_name) from sbillcodenew where show_level='1'</wtc:sql>
				</wtc:qoption>
