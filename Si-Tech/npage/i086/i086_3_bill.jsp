...
<!--	
 ...
 function doclear() {
   ...
   function docheck3()
   {
	   var s_new =  document.all.rpt_type[document.all.rpt_type.selectedIndex].value;
	  // var s_new = s_paytype.split("-->")[1];
	//   alert(s_new);
	   document.frm.action = "i086_2_qry.jsp?s_new="+s_new+"&level=3";
	   document.frm.submit();	
...
<form action="" method="post" name="frm">
	...
	<table cellspacing="0">
      ...
      <tr> 
        ...
        <td colspan="4"> 
		  ...
		  &nbsp;&nbsp;&nbsp;&nbsp;
		  <input name="busyType4" type="radio" onClick="sel4()" value="4" checked>三级账目项查询
		</td>
     </tr>
    </tbody>
  </table>
	...
	<tr>
		<td class="blue">三级账目项名称</td>
		<td>
			<select name=rpt_type style='width:400px'>
				<!--wanghfa 20100602 解耦修改 start-->
				<wtc:qoption name="TlsPubSelBoss" outnum="2">
					<wtc:sql>select trim(node_code),trim(node_code)||'-->'||trim(show_name) from sbillcodenew where show_level='3'</wtc:sql>
				</wtc:qoption>
