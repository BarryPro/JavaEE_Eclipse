...
<%
    String opCode =  "9108";
	String opName =  "SP企业信息审核结果查询";
	String op_code =  "9108";
	String op_name =  "SP企业信息审核结果查询";
	...
	int iEndPos = iPageNumber*iPageSize;
    	...
    	//String[][] baseInfoSession = (String[][])arr.get(0);
	...
	%>
		...
		<wtc:array id="r2" start="6" length="19" scope="end"/>
<%
		ret_code = retCode;
		ret_meg = retMsg;
		result = r2;
...
<body>
<FORM action="f9108_1.jsp" method=post name=form>
<%@ include file="/npage/include/header.jsp"%>
<div class="title">
	<div id="title_zi">SP企业信息审核结果查询</div>
</div>
...
<table cellSpacing="0">
		<tr> 
			...
			<td width="35%">
				<input type="text" name="ICPName" value="<%=iSpName%>" v_must="0" v_type="string">
			</td>
		</tr>
		<tr> 
			<td class="blue">开始时间</td>
			<td>
				<input type="text" name="beginTime" value="<%=iBegin_Time%>" v_format="yyyyMMdd" onblur="checkElement(this)" v_must="0" v_type="string" size=15/>
			</td>
			<td class="blue">结束时间</td>
			<td>
				<input type="text" name="endTime" value="<%=iEnd_Time%>" v_format="yyyyMMdd" onblur="checkElement(this)" v_must="0" v_type="string"/>
			</td>
		</tr>
		 <tr id="footer"> 
         ...
         if (i%2==0){
             tdClass = "Grey";
			    ...
			    <td class="<%=tdClass%>"><div align="center"><%=(iStartPos+i+1)%>&nbsp;</div></td>
		  	  	...
		  	  	<td class="<%=tdClass%>"><div align="center"><%=result[i][12]%>&nbsp;</div></td>
		  	  	<td class="<%=tdClass%>"><div align="center"><%=result[i][14]%>&nbsp;</div></td>
		  	  	<td class="<%=tdClass%>"><div align="center"><%=result[i][15]%>&nbsp;</div></td>
