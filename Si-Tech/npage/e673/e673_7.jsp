...
<BODY>
<form action="e673_7.jsp" method="post" name="frm">
...
<%
   if(flag)
   {
	...
	inParas[0]="SELECT a.invoice_code,a.s_invoice_number,a.e_invoice_number,b.region_name,'','','',a.login_no,c.login_name,to_char(a.op_time, 'YYYY-MM-DD HH24:MI:SS') FROM dbcustadm.wcityinvoice a,sregioncode b,dloginmsg c WHERE a.login_no=c.login_no AND a.region_code = b.region_code AND  a.invoice_code=:invoice_code AND a.s_invoice_number<=to_number(:invoice_number) AND a.e_invoice_number>=to_number(:invoice_number1)";
    inParas[1]="invoice_code="+invoice_code+",invoice_number="+invoice_number+",invoice_number1="+invoice_number;

	inParas1[0]="SELECT a.invoice_code,a.s_invoice_number,a.e_invoice_number,b.region_name,d.district_name,'','',a.login_no,c.login_name,to_char(a.op_time, 'YYYY-MM-DD HH24:MI:SS') FROM dbcustadm.wdisinvoice a,sregioncode b,dloginmsg c,sdiscode d WHERE a.login_no=c.login_no AND a.region_code=b.region_code AND a.district_code=d.district_code AND a.region_code=d.region_code AND a.invoice_code=:invoice_code AND a.s_invoice_number<=to_number(:invoice_number) AND a.e_invoice_number>=to_number(:invoice_number1)";
  	inParas1[1]="invoice_code="+invoice_code+",invoice_number="+invoice_number+",invoice_number1="+invoice_number;

	inParas2[0]="SELECT a.invoice_code,a.s_invoice_number,a.e_invoice_number,b.region_name,d.district_name,a.group_id,e.group_name,a.login_no,c.login_name,to_char(a.op_time, 'YYYY-MM-DD HH24:MI:SS') FROM dbcustadm.wgroupinvoice a,sregioncode b,dloginmsg c,sdiscode d,dchngroupmsg e WHERE a.login_no=c.login_no AND a.region_code=b.region_code AND a.district_code=d.district_code AND a.region_code=d.region_code AND a.group_id=e.group_id AND a.invoice_code=:invoice_code AND a.s_invoice_number<=to_number(:invoice_number) AND a.e_invoice_number>=to_number(:invoice_number1)";
