...
System.out.println("s_in_ModeTypeCode:"+inParas[3]);	  
	...
	String sqlStr = "select '00'||region_code,region_name from sregioncode where region_code<=13 order by region_code";
%>
...
function commit(){
  ...
  if(document.frm.s_in_CaseTypeCode.value =="")  {
     ...
     document.frm.action="e673_4.jsp";
 	 document.frm.submit();
...
function commit2(){
  ...
  if(document.frm.s_in_CaseTypeCode.value =="")  {
   ...
   if(document.frm.date.value.length!=8)  {
     ...
     document.frm.action="e673_4Cfm.jsp";
 	 document.frm.submit();
