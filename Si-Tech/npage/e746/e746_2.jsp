...
//	System.out.println("111111111111111信息录入开始~~~~~~~~~~~~~~~~~···"+work_no);
   /* String loginName = (String)session.getAttribute("workName");
	...
	String qdgh = request.getParameter("qdgh");
	String org_code = (String)session.getAttribute("orgCode");
...
%>    
   ...
   <wtc:service name="sQdInvoiceInDB" routerKey="phone" routerValue="15004678912" retmsg="retMsg" retcode="retCode1"  outnum="2" >
	<wtc:param value="<%=s_Invoice_number%>"/>
	<wtc:param value="<%=e_Invoice_number%>"/>
	<wtc:param value="<%=Invoice_code%>"/>
	<wtc:param value="<%=qdgh%>"/>
