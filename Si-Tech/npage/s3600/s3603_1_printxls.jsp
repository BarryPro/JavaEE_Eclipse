...
<%
	...
	String sqlStr ="select  a.service_no,b.phone_no,a.org_code ,a.unit_name from dgrpcustmsg a,dbvipadm.dgrpmanagermsg b where a.service_no=b.service_no and a.unit_id = '";
	//
	String grpName="" ;		//集团名称
	String unitID=""  ;		//集团编号
...
<%	 	
	...
	inputPara[0]=grpName;
	inputPara[1]=unitID;
	if(op_Code.equals("3603"))
	  inputPara[2]="BOSS侧VPMN成员用户开户"; 
