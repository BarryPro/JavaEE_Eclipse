		...
		for(int i=0;i<11;i++)
		{
        	...
        	if(i==0){fn=15;column=1;row=1;} //黑龙江移动通讯公司集团成员管理不成功记录————
     		...
     		if(i==2){column=4;row=3;}	//集团编号：	
       		if(i==3){column=7;row=3;}  	//BOSS侧VPMN	
...
<%
	...
	String sqlStr ="select  a.boss_vpmn_code,a.service_no,b.phone_no,a.org_code,a.unit_name from dgrpcustmsg a,dbvipadm.dgrpmanagermsg b where a.service_no=b.service_no and a.unit_id = '";
	//
	String grpName="" ;		//集团名称
	String unitID=""  ;		//集团编号
...
%>
			<wtc:pubselect name="sPubSelect" routerKey="region" routerValue="<%=regCode%>"  retcode="retCode1" retmsg="retMsg1" outnum="5">
...
<%
	...
	if(op_Code.equals("3609"))
	   inputPara[2]="BOSS侧VPMN成员按手机号删除";
	...
	response.setHeader("Content-Disposition","attachment;filename=\"" +currDate+phoneNo.nextToken()+".xls" + "\"");                                                                                                                                                                                             
