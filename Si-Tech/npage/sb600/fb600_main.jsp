...
<%
	System.out.println("===========wanghfa=sB600Qry==0====== loginAccept = ");
	System.out.println("===========wanghfa=sB600Qry==1====== ChnSource = 08");
	System.out.println("===========wanghfa=sB600Qry==2====== opCode = " + opCode);
	System.out.println("===========wanghfa=sB600Qry==3====== workNo = " + workNo);
	System.out.println("===========wanghfa=sB600Qry==4====== noPass = " + noPass);
	System.out.println("===========wanghfa=sB600Qry==5====== activePhone = " + activePhone);
	System.out.println("===========wanghfa=sB600Qry==6====== userPwd = ");
	System.out.println("===========wanghfa=sB600Qry==7====== opNote = ");
%>
<wtc:service name="sB600Qry" routerKey="phone" routerValue="<%=activePhone%>" retcode="retCode1" retmsg="retMsg1" outnum="9">
	<wtc:param value=""/>
	<wtc:param value="08"/>
...
<%
	System.out.println("===========wanghfa======= sB600Qry : " + retCode1 + ", " + retMsg1);
...
<%
		...
		for (int i = 0; i < result.length; i ++) {
			for (int j = 0; j < result[i].length; j ++) {
				System.out.println("========wanghfa======= sB600Qry : result1[" + i + "][" + j + "] = " + result1[i][j]);
...
<form name="frm" action="fb600_cfm.jsp" method="POST">
...
<table cellspacing="0">
	...
	<tr>
		...
		<td>
			<select type="select" id="receiptType" name="receiptType">
		...
		<td>
			<select type="select" id="receiptMethod" name="receiptMethod">
