...
%>
<%
	System.out.println("===========wanghfa=sB601Cfm==0====== printAccept = " + printAccept);
	System.out.println("===========wanghfa=sB601Cfm==1====== 渠道 = 08");
	System.out.println("===========wanghfa=sB601Cfm==2====== opCode = " + opCode);
	System.out.println("===========wanghfa=sB601Cfm==3====== workNo = " + workNo);
	System.out.println("===========wanghfa=sB601Cfm==4====== noPass = " + noPass);
	System.out.println("===========wanghfa=sB601Cfm==5====== activePhone = " + activePhone);
	System.out.println("===========wanghfa=sB600Cfm==5====== userPwd = ");
	System.out.println("===========wanghfa=sB600Cfm==5====== opNote = " + opNote);
%>
	<wtc:service name="sB601Cfm" routerKey="phone" routerValue="<%=activePhone%>" retcode="retCode1" retmsg="retMsg1" outnum="1">			
...
<%
	...
	System.out.println("%%%%b601%%%调用统一接触开始%%%%%%%%");
...
<%	
	System.out.println("%%%%b601%%%调用统一接触结束%%%%%%%%");
//为统一接触  end
	System.out.println("===========wanghfa========== sB601Cfm : " + retCode1 + ", " + retMsg1);
...
<%
		...
		for (int i = 0; i < result1[0].length; i ++) {
			System.out.println("==========wanghfa=========sB601Cfm===== result[0]["+i+"] = " + result1[0][i]);
		}
%>
		<script language="JavaScript">
