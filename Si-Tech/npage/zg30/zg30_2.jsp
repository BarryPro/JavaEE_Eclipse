					...
					<HEAD><TITLE>增值税发票作废开具申请</TITLE>
						...
						<script language="javascript">
							...
							function docfm()
							{
								...
								if(check_flag=="1")
								{
									var url="zg30_3.jsp?zp_numberArrays="+zp_numberArrays+"&zp_codeArrays="+zp_codeArrays+"&zp_zdArrays="+zp_zdArrays+"&zp_kprArrays="+zp_kprArrays+"&zp_ztArrays="+zp_ztArrays+"&sprid="+sprid;
					...
					<div class="title">
						<div id="title_zi">增值税发票作废开具申请</div>
						  ...
						  <table cellspacing="0" >
							  ...
							  <tr id="footer"> 
								<td colspan="9">
								  <input class="b_foot" name=tjsq onClick="doprint()" type=button value=打印发票传递单>
								  <input class="b_foot" name=tjsq onClick="docfm()" type=button value=提交传递申请>	
								  <!-- ret_sp
								  <input class="b_foot" name=doCfm onClick=" " type=button value=是否可以直接划拨?> 
								  -->
								  <input class="b_foot" name=back onClick="window.location.href='zg30_1.jsp'" type=button value=返回>
								</td>
							  </tr>
