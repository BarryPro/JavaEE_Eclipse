...
<form action="" method="post" name="frm">
    ...
    <tr> 
	 ...
	 <tr> 
		  ...
		  <td> 
			<input class="button" type="radio" name="utype" value="1" checked onclick="checks(1)">为本号码缴费
			&nbsp;&nbsp;
			<input class="button" type="radio" name="utype" value="0" onclick="checks(0)">为其他号码缴费
		  </td>
	 </tr>	 

	<tr id="div1"> 
	  <td class="blue" width="15%">缴费手机号码</td>
	  <td> 
		<input class="button"type="text" name="phone_no2" size="20" maxlength="12"  onKeyPress="return isKeyNumberdot(0)" >
	  </td>
	</tr>
 <tr> 
      <td class="blue" width="15%">缴费金额</td>
      <td> 
