...
<%
  ...
  String[][] result5  = null;
  /*if(busy_type.equals("2")) */// end type = 2
	if(busy_type.equals("3")){
...
<%
  ...
  timeResult=timeResult1;
}else
	{
		inParas1[0]="23";
%>
<wtc:pubselect name="sBossDefSqlSel" routerKey="region" routerValue="<%=regionCode%>"  retcode="retCode1" retmsg="retMsg1" outnum="2">
...
<%
	inParas1[0]="30";
	/*
	inParas1[0]+="SELECT to_char(IS_B+IS_BAND) FROM " ;
	inParas1[0]+="(SELECT COUNT(*) AS IS_B FROM dCustMsg WHERE phone_no = :phone_no AND substr(run_code,2,1) != 'A' AND ROWNUM < 2) , " ;
	inParas1[0]+="(SELECT COUNT(*) AS IS_BAND FROM MK_PHONEBINDING_INFO WHERE bdband_account = :dbBand_Account AND ROWNUM < 2)" ;
	*/
	inParas1[1]="phone_no="+phoneNo+",dbBand_Account="+dbBand_Account;
%>
...
<%
System.out.println("=====zhaorh0002====>result_band[0][0].trim()====="+result_band[0][0].trim());
		if( 0 != result_band.length)
			if( result_band[0][0].trim().equals("2") )
			{
%>
				<script language=javascript>
			...
			<div id="title_zi">用户信息</div>
              ...
              <table cellspacing="0">
                ...
                <tr>
                  ...
                  <td width="35%">
                    <input type="text" readonly class="InputGrey" name="TbusyName"  value="<%=busy_name1%>">
                  </td>
          ...
          %>
                ...
                <tr id="phoneId">
                  <td class="blue">物联网号码</td>
						  <td>
						  <input type="text" readonly class="InputGrey" name="phone_input" value="<%=phone_input%>">
                ...
                <tr>
                  <td noWrap colspan="6" id="footer">
                    <div align="center">
                      ...
                      &nbsp;
                      <input type="button" name="return1" class="b_foot" value="返回" onClick="window.location.href='g573_1.jsp'">
                      &nbsp;
