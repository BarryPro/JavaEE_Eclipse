...
%>
	<wtc:service name="s6714InitEx" routerKey="region" routerValue="<%=regionCode%>" outnum="19" retcode="retCode" retmsg="retMsg">
...
{ 
 ...
 document.all.sysNote.value = "手机["+<%=phone_no%>+"]变更彩铃业务,彩铃产品["+document.all.mebProdCode.value+"]";
	...
	document.form.action="ff712_2.jsp";
...
function doQuery()
	{		
		...
		document.form.action = "ff712_1.jsp?action=select&activePhone=<%=phone_no%>";
		document.form.submit(); 
	}
...
{
    var path = "<%=request.getContextPath()%>/npage/sf712/fpubprod_sel.jsp";
...
{   
    ...
    var path = "<%=request.getContextPath()%>/npage/sf712/fpubmebProdCode_sel.jsp";
    path = path + "?sqlStr=" + sqlStr + "&retQuence=" + retQuence;
    path = path + "&fieldName=" + fieldName + "&pageTitle=" + pageTitle;
    path = path + "&selType=" + selType;
...
{   
    var path = "<%=request.getContextPath()%>/npage/sf712/fpubmatureProdCode_sel.jsp"; 
    path = path + "?sqlStr=" + sqlStr + "&retQuence=" + retQuence;
    path = path + "&fieldName=" + fieldName + "&pageTitle=" + pageTitle;
    path = path + "&selType=" + selType;
    path = path + "&groupFlag=Y";
