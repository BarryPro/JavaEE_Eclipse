...
System.out.println("offerattrtype==============="+offerattrtype);
	...
	if(opCode.equals("1255")){
		if((phoneHead.equals("157") && flagTD=="true") && !(offerattrtype.equals("YnPT"))){
			retCode1="111111";
			retMsg1="157号段TD公话号码的用户只能办理TD固话包年类销售品！";
		}
		else if(!(phoneHead.equals("157") && flagTD=="true") && offerattrtype.equals("YnPT")){
			retCode1="111111";
			retMsg1="只有157号段TD公话号码的用户能办理TD固话包年类销售品！";
		}
	  else{
