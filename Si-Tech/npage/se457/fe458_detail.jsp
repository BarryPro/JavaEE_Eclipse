...
<form name="frm" method="post">
	...
	<div class="title">
		<div id="title_zi">营销方案活动类型配置详细信息查询</div>
	</div>
	<table>
		<tr>
      ...
      <td class="blue" width="30%">
		...
		<tr>
			...
			<td>
				<input name="stopTime" type="text" id="stopTime" value="<%=endTime%>" class="InputGrey" readonly>
			</td>
		</tr>
		<tr>
	...
	<table cellspacing="0"> 
		<tr>
			<td colspan="6" align="center" id="footer">
				...
				<%
				if ("e461".equals(getOpCode)) {
					%>
					<input type="button" name="backBtn" id="backBtn" class="b_foot" onclick="window.location='fe461_queryApr.jsp?opCode=e461&opName=四喜号码营销方案配置审批'" value="返回" >
					<%
				} else {
					%>
					<input type="button" name="backBtn" id="backBtn" class="b_foot" onclick="window.location='fe458_query.jsp?opCode=<%=opCode%>&opName=<%=opName%>&opFlag=query'" value="返回" >
					<%
				}
				%>
