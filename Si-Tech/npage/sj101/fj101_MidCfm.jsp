...
<%
        ...
        String codelist = WtcUtil.repNull(request.getParameter("codelist"));
        String namelist = WtcUtil.repNull(request.getParameter("namelist"));
        String rolelist = WtcUtil.repNull(request.getParameter("rolelist"));
        String operlist = WtcUtil.repNull(request.getParameter("operlist"));
	...
	String [] inputParam = new String [11] ;
        ...
        inputParam[6]="";
        inputParam[7]=operlist;
        inputParam[8]=codelist;
        inputParam[9]=namelist;
        inputParam[10]=rolelist;

%>

        <wtc:service name="sj101MIDCfm" routerKey="phone" routerValue="<%=phoneNo%>"  retcode="retCode" retmsg="retMsg" outnum="2" >
...
response.data.add("verifyType" ,"MIDQQQ"           );
