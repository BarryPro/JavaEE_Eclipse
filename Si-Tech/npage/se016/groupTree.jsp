...
<%
	...
	String regionCode = request.getParameter("regionCode")==null?"form1":request.getParameter("regionCode");	
	String row = request.getParameter("row")==null?"0":request.getParameter("row");	
	String groupName = "groupName"+row;
	String groupId = "groupId"+row;
	//查询当前省对应的组织机构
	String dataJsp = "groupTreeXml.jsp?isRoot=true&regionCode="+regionCode;
