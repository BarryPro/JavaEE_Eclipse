		...
		for(int i=0;i<11;i++)
		{
        		...
        		WritableCellFormat wcfF=null;
         		...
         		if(i==2){column=4;row=3;}	//集团ID：	
           		if(i==3){column=7;row=3;}  	//ADC-IPT业务：	
...
//	SPubCallSvrImpl callView = new SPubCallSvrImpl();
	String sqlStr ="select a.service_no,b.phone_no,a.org_code,a.unit_name "
		+"from dGrpcustMsg a,dbvipadm.dgrpmanagermsg b "
		+"where a.service_no=b.service_no and a.unit_id = '";
	String grpName="" ;		//集团名称
	String unitID=""  ;		//集团编号
...
<%
	...
	inputPara[0]=grpName;
	inputPara[1]=unitID;
	if(op_Code.equals("2905"))
	  inputPara[2]="IPT成员用户添加"; 
	if(op_Code.equals("2907"))
	  inputPara[2]="IPT成员用户删除";  
	if(op_Code.equals("2909"))
	  inputPara[2]="IPT成员资费变更";     
