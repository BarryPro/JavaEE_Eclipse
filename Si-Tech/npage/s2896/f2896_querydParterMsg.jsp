	...
	{			
		...
		{//值为一条时不需要用数组
       	...
       	window.opener.tabBusi.style.display="none";
				...
				newRow.insertCell().innerHTML = '<center><a href="f2896_2.jsp?parterId=' + document.all.parterId.value + '&oTypeCode=' + document.all.oTypeCode.value + '" target="_blank" >查询</a></center>';
		...
		{//值为多条时需要用数组
			...
			{	
				...
				newRow.insertCell().innerHTML = '<center><a href="f2896_2.jsp?parterId=' + document.all.parterId[a].value + '&parterName=' + document.all.parterName[a].value + '&oTypeCode=' + document.all.oTypeCode[a].value + '" target="_blank">查询</a></center>';
				newRow.insertCell().innerHTML = '<center><input name="queryBusiBtn" style="cursor:hand" type="button" class="b_text" value="查询业务信息" onclick="queryBusiInfo()">&nbsp;</center>' ;
