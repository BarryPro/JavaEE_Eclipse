	...
	function checks()
	{
		...
		else
		{
			...
			else
			{
				...
				{
					var myPacket = new AJAXPacket("../zgb5/szgb5_jy.jsp","正在提交，请稍候......");
				...
				{
					var myPacket = new AJAXPacket("../zgb5/szgb5_jyCrm.jsp","正在提交，请稍候......");
					myPacket.data.add("objSel",objSel);//传入
					myPacket.data.add("rwsj",rwsj);
					myPacket.data.add("sim_vlaue",sim_vlaue);
					myPacket.data.add("khxm",khxm);
...
<table cellspacing="0">
	...
	<tr id="jffpjlid">
	   ...
	   <table cellspacing="0">
	     <tr id="footer">
           <TD nowrap colspan="8"> 
               <input type="button" name="dosuer" class="b_foot" value="确认" onClick="docfm()">
