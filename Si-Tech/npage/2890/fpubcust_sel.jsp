...
*/
  ...
  /*      
	...
	String sqlStr1 = "select * from (select a.id_iccid, a.cust_id, a.cust_name, b.unit_id, b.unit_name, a.region_code||a.district_code||town_code, rownum id from dCustDoc a, dCustDocOrgAdd b where a.owner_type='04' and a.cust_id = b.cust_id " + sqlFilter + ") where id <"+iEndPos+" and id>="+iStartPos;
