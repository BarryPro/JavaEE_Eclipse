...
function getInfo_Cust()
{
    ...
    var fieldName = "证件号码|客户ID|客户名称|集团编号|集团名称|归属地|";
		var sqlStr = "";
    var selType = "S";    //'S'单选；'M'多选
...
%>
          ...
          <TR>
            ...
            <TD colspan="3">
              ...
              <input name="grp_userno" type="hidden" class="InputGrey" size="20" maxlength="12" readonly  v_type="string"  v_name="集团用户编号" value="<%=grp_userno%>">
