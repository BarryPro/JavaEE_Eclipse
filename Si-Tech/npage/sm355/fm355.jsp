...
<script type="text/javascript">
 ...
 function deleteoffer(acceptss,bands,usernames,usericcid,usericcidtypes,moneys,phoneno,kuandainos,belongcode,id_nos,liushui,old_opdate){
...
<%@ include file="/npage/include/header.jsp" %>
	...
	<div id="showTab" ></div>
      ...
      <input type="hidden" name="old_opdate" id="old_opdate"  />
