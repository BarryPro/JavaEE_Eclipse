...
<%
  ...
  String sr_phone = request.getParameter("srephonenumber");
...
%>
	<wtc:service name="sm185Req" routerKey="region" routerValue="<%=regionCode%>" retcode="retCode" retmsg="retMsg" outnum="1">
...
<%
	if("000000".equals(retCode)){
		System.out.println(" ======== sm185Req 调用成功 ========");
%>	
    <script language="javascript">
 	      rdShowMessageDialog("积分转赠操作成功！",2);
 	      window.location="fm185.jsp?activePhone=<%=zr_phone%>&opCode=<%=opCode%>&opName=<%=opName%>";
 	  </script>
<%}else{
