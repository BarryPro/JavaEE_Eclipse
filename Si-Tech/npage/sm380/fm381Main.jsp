...
function chkPhoneFunc(){
		...
		getdataPacket.data.add("iOprtype","2");
...
/*2016/5/27 14:44:26 gaopeng 提交操作*/
		function nextStep(){
			...
			getdataPacket.data.add("ioprtype","1002");
...
<body>
	...
	<div>
		...
		<table>
			<tr>
		     <td class="blue">原SIM卡号</td>
				 <td>
				 		<input type="text" name="oldSimNo" id="oldSimNo" value="" class="InputGrey" readonly/>
			   		<font class=orange>*</font>
			   		<input type="button" id="b_emptySimOpen" name="b_emptySimOpen" value="换卡" class="b_text" disabled="disabled" onClick="emptySimOpenFunc()" > 
			   </td>
	    </tr>
	    ...
	    <tr  id="tr_serviceNo1">
			  <td class="blue"  id="th_simInfo"> 新SIM卡号 </td>
	 ...
	 <table>
	   <tr>
			<td align=center colspan="4" id="footer">
				<input class="b_foot" id="cfmBtn" name="cfmBtn"  type="button" value="确认" disabled="disabled"  onclick="nextStep();">&nbsp;&nbsp;
