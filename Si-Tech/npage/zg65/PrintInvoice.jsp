...
<%
		String print_phoneno = request.getParameter("print_phoneno");
    ...
    String op_code = "zg65";
    String smphoneNo = request.getParameter("phoneno_out");
    ...
    String printNote = "0";
	  ...
	  String sm_name = "中移铁通宽带";
    String s_sm_code="kh";
		String s_id_no=request.getParameter("id_no");
		String returnPage ="zg65_1.jsp";
	...
	String bill_code = request.getParameter("s_invoice_code");

    String smop_code = "zg65";
...
<%
	...
	inParam[1] = "smphoneNo="+print_phoneno+",s_region_code="+regionCode;
...
<SCRIPT language="JavaScript">
    function printInvoice()
    {
		...
		printctrl.Print(13, 15, 9, 0, "宽带账号:<%=smphoneNo%>");		
		printctrl.Print(72, 15, 9, 0, "支票号:<%=result[0][7]%>");
		...
		printctrl.Print(16, 19, 9, 0, "本次发票金额:(小写)￥<%=result[0][9].trim()%> 大写金额合计:<%=result[0][8]%>");
			<%
			if(smop_code.equals("1310")||smop_code.equals("1362")||smop_code.equals("zg65"))
			{
			%>
