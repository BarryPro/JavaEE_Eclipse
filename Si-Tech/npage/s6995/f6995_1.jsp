...
function docheck() {
	if (document.form.phone_no.value.length == 0) {
       ...
       if (isValidYYYYMMDD(document.form.begin_time.value) != 0)
       {
		...
		{
		    document.form.action="f6995_2.jsp";    
		}
		
		if (document.form.bill_type.value=="2")
		{
		    document.form.action="f6995_3.jsp";    
		}
...
function searchAccount() {
 ...
 <BODY>
<FORM action="f6995_1.jsp" method=post name="form">
			...
			<div id="title_zi">查询条件</div>
              ...
              <table cellspacing="0">
                <tr> 
                  ...
                  <td width="35%"> 
                    <input type="text" name="phone_no" maxlength="11" class="InputGrey" onKeyPress="return isKeyNumberdot(0)" value="<%=activePhone%>" readOnly >
