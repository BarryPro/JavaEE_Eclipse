...
<%    	        
		    for(int y=0;y<result.length;y++)
			{
				 ...
				 <td><input class="b_foot" type="button" value="缴费" onclick="addTab('<%=result[y][3]%>','<%=result[y][1]%>','<%=loginaccept%>','<%=result[y][2]%>')"></td>					 
...
%>	
<tr>
 <td colspan=7 align="center"><input class="b_foot" name=back onClick="window.location.href='zgb9_1.jsp'" type=button value=返回></td>
</tr>
	</TBODY>
	    </TABLE>
