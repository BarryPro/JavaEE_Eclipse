		<div id="workPanel">	
		    <img src="<%=request.getContextPath()%>/nresources/default/images/to-left_2.gif"  id="imgLeftRight" onclick="imgLeftRight()" />
			<div id="tabset">
				<div id="tab">
					<ul id="tabtag" >
				...
				<dl id="contentArea">
					<dt class="on" >
						<iframe align="top"  class="workIframe"  id="ifram" src="../portal/work/portal_simple.jsp" frameborder="0" scrolling="auto"  width="100%" height="100%" noresize>
					  </iframe>
					</dt>
				</dl>
			</div>
