...
function docheck()
{
	if(frm.phoneNo.value=="" )
		{
			 rdShowMessageDialog("请输入合法的物联网用户号码！",0);
			document.frm.phoneNo.focus();
		 	 return false;
		}
    ...
    document.frm.action="g578_cfm.jsp";
...
<input type="hidden" name="water_number"  >
		...
		<table cellspacing="0">
			...
			<tr id="tb1" style="display:"> 
				...
				<td > 
					<input type="text" value="" name="phoneNo"  maxlength="13" onKeyDown="if(event.keyCode==13)frm.beginDate.focus()" onKeyPress="return isKeyNumberdot(0)">
				</td>
			...
			<tr id="tb2" style="display:none"> 
				...
				<td class="blue"><div id="pass_msg1">帐户密码</div></td>
				<td>
					<jsp:include page="/npage/common/pwd_one.jsp">
					<jsp:param name="width1" value="16%"  />
					<jsp:param name="width2" value="34%"  />
