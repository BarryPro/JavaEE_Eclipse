...
<%
    ...
    String loginNo = (String)session.getAttribute("workNo");
		...
		/*add 2017/0612 使用证件类型 反费类型*/
		String isType = (String)request.getParameter("isType");
		String isFeeTypes = (String)request.getParameter("isFeeTypes");		
...
try
{
  ...
  String input_parms[] = new String[34];
				...
				input_parms[32]	= isType;			/*使用证件类型*/  
				input_parms[33]	= isFeeTypes;			/*反费规则*/ 
...
<%
System.out.println("服务入参sm349Cfm（isType）："+isType);
System.out.println("服务入参sm349Cfm（isFeeTypes）："+isFeeTypes);
