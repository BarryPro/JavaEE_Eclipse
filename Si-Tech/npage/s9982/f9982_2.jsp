...
<%
		...
		System.out.println("opCodeopCodeopCodeopCodeopCodeopCodeopCodeopCodeopCode="+opCode);		
...
%>	
 <wtc:service name="s9982Cfm" routerKey="region" routerValue="<%=regionCode%>" retcode="errCode" retmsg="errMsg" outnum="2">			
...
%>
		<script language="javascript">
	 	rdShowMessageDialog("申请失败！" + "<%=errMsg%>",0);	
