...
<%
    ...
    int iEndPos = iPageNumber*iPageSize;
		...
		System.out.println("iClassCode=="+iClassCode);
		System.out.println("iClassName=="+iClassName);
		...
		System.out.println("getRegionSql del->"+getRegionSql);
...
<body>
	<div id="Operation_Table">
		 <input type='hidden' name='iClassName' value='<%=iClassName%>'>
     <table cellspacing="0">
			<tr height=25 align="center">
				<th width="14%" nowrap>选择</th>
