...
if(isRoot==null||isRoot.length()==0)
{
	...
	{
		String	strSql = "select popedom_code, '("+loginNo+")工号权限树' from sPopeDomCode where par_domcode = 0";
	...
	else
	{
		...
		for (int i = 0; i < rootList2.length; i++)
		{
			...
			tmpElm.addAttribute("text",popedomName2.trim());
			...
			if(flag.equals("N"))
			{
				String url = "funcTreeXml_qry.jsp?popedomCode="+popedomCode2.trim()+"&popedomName="+popedomName2.trim();
