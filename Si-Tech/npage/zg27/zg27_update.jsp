...
%>
<wtc:service name="s_zg27Upd" routerKey="region" routerValue="<%=regionCode%>" retcode="sCode" retmsg="sMsg" outnum="2" >
...
<script language="JavaScript">
	...
	window.location="zg27_1.jsp?opCode=zg27&opName=增值税红字发票开具申请";
	</script>
<%
	}else{
%>   
