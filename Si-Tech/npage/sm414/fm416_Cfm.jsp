...
<%
	...
	String iOldImeiCode   = WtcUtil.repNull(request.getParameter("iOldImeiCode"));
  ...
  String regionCode     = (String)session.getAttribute("regCode");
	...
	paraAray[7] = "备注：魔百合修改IMEI"+phoneNo; 
	paraAray[8] = iOldImeiCode;
	paraAray[9] = iImeiCode;
	paraAray[10] = iOldAccept;

	String serverName = "sm416Cfm";
try{
%>
