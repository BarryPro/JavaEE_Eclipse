...
<%
		...
		String sm439_imei =  request.getParameter("sm439_imei");
		String sm439_valueAdded =  request.getParameter("sm439_valueAdded");
		String sm439_example =  request.getParameter("sm439_example");
		...
		inputParsm[7] = sm439_imei;
		inputParsm[8] = sm439_valueAdded;
		inputParsm[9] = sm439_example;
...
%>
	...
	<wtc:array id="sm439Cfm_result" scope="end"/>
