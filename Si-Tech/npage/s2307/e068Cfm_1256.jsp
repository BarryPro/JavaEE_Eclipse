...
<%
	...
	System.out.println("AAAAAAAAAAAAAAAAAAAAAAA ownerCode is "+ownerCode);
...
/*	ArrayList arr = F1256Wrapper.s1256Cfm(loginAccept,opCode,workNo,
	...
	String sql_1256 = "";								   
%>
	<wtc:service name="s1256Cfm" routerKey="phone" routerValue="<%=phoneNo%>" outnum="1" retcode="retCode" retmsg="retMsg">
		<wtc:param value="0"/>
