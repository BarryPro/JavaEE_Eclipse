		...
		function getModiFilePath(filePath,file_name,source_name,info)
		{
	 	...
	 	function showModiFile()
	 	{
			...
			if(list_name==undefined)
			{
	 		...
	 		var packet = new AJAXPacket("fo003_ajax_modiShowFile.jsp");
	 		packet.data.add("list_name",list_name);
...
<body>
<form action="" name="frmo003Upt" method="post" >
	<%@ include file="/npage/include/header.jsp" %>
	<div class="title">
		<div id="title_zi">纳税人资质信息修改</div>
	</div>
	<table cellspacing="0">
		<tr>
			<td class="blue">纳税人识别号：</td>
			<td>
					<input type=text name="taxpayer_id" value="<%=retList[0][1]%>" id="taxpayer_id" v_must="15"  v_type="string" v_maxlength="30"/>
					<font class=red>*至少输入15位</font> 
			</td>
			<td class="blue">资质类型：</td>
			<td>
				<select v_must="1" id="taxpayer_type" value="<%=retList[0][2]%>">
        ...
        <tr>
			...
			<td>
				<select v_must="1" id="bill_type" value="<%=retList[0][3]%>">
			...
			<td>
					<input type=text name="phone_no" value="<%=retList[0][6]%>" id="phone_no" v_must="1" class="isLengthOf" v_maxlength="255"/>
					<font class=orange>*</font>
			</td>
        </tr>
        <tr>
			...
			<td>
					<input type=text name="bank_name" value="<%=retList[0][7]%>" id="bank_name" v_must="1" class="isLengthOf" v_maxlength="255"/>
					<font class=orange>*</font>
			</td>
			<td class="blue">主银行帐号：</td>
			<td>
					<input type=text name="bank_account" value="<%=retList[0][8]%>" id="bank_account" v_must="1" class="isLengthOf" v_maxlength="255"/>
					<font class=orange>*</font>
			</td>
        </tr>
        ...
        <tr>
			...
			<td>
				<input type="text" name="valid_date" id="valid_date" v_must="1" class="Wdate"  v_type="date" value="<%=retList[0][9]%>"
			...
			<td>
				<input type="text" name="expire_date" id="expire_date"  v_must="1" class="Wdate"  v_type="date" value="<%=retList[0][10]%>"
		...
		<tr>
			...
			<td colspan="3">
				<input type="text" id="unit_name" v_must="1" name="unit_name" value="<%=retList[0][4]%>" size="80" class="required isLengthOf" v_maxlength="255"/>
				<font class=orange>*</font>
			</td>
		</tr>
		<tr>
			...
			<td  colspan="3">
				<input type="text" id="unit_address" name="unit_address" v_must="1" value="<%=retList[0][5]%>" size="80" class="required isLengthOf" v_maxlength="255" maxlength="255"/>
				<font class=orange>*</font>
			</td>
		</tr>
		<tr>
			<td class="blue">备注:</td>
			<td colspan="3">
				<input type=text name="remark" id="remark" v_must="1" size="80" value="<%=retList[0][11]%>" class="isLengthOf" v_maxlength="128"/>
				<font class=orange>*</font>
			</td>
		</tr>
    </table>
