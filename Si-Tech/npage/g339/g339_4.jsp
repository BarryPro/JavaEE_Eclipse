...
<%
	...
	String USERLISTSEQ = request.getParameter("USERLISTSEQ");//这个是成员的
	...
	inParas2_now[0]=" select to_char(nvl(sum(FEEVAL),0)),to_char(PRODUCTCHARGECODE) from dBBOSS_ACCT_FEEINFO where seq=:seq group by PRODUCTCHARGECODE ";
