...
<%	
	String opr_source="01";  //"01表示boss侧，11表示平台侧"
...
<%
    System.out.println("%%%%%%%调用统一接触开始%%%%%%%%");
		...
		String url = "/npage/contact/upCnttInfo.jsp?opCode=1850&retCodeForCntt="+code+"&opName=视频留言&workNo="+login_no+"&loginAccept="+login_accept+"&pageActivePhone="+id_value+"&retMsgForCntt="+msg+"&opBeginTime="+opBeginTime;
