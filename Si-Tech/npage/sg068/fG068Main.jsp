...
<html>
<head>
<title>TD固话自备机入网</title>
<%

	String opCode = request.getParameter("opCode");
	String opName = request.getParameter("opName");
	String phoneNo =  request.getParameter("activePhone");
	String PhoneHead = phoneNo;
	if((!"".equals(phoneNo))&&(phoneNo!=null)){
	 PhoneHead = phoneNo.substring(0, 3);
	}
...
<wtc:pubselect name="sPubSelect" outnum="1"  routerKey="phone" 
	retcode="retCode2" retmsg="retMsg2" routerValue="<%=phoneNo%>">
...
<%  
	String num="";
	String SqlStr = "select count(1) from group_instance_member a, dcustmsg b "
		+"where a.serv_id = b.id_no and b.phone_no = '"+phoneNo+"' and a.member_role_id = 10335";
%>
...
/*和7898的限制一样*/
 String number1="";
	String sql_str="select count(*) from wphonesaleopr a,dcustmsg b where a.id_no=b.id_no and a.back_flag in ('0','2')  "+
				  "and a.op_code='g068' and b.phone_no='"+phoneNo+"'";
%>
<wtc:pubselect name="sPubSelect" outnum="1"  routerKey="phone" retcode="retCode1" retmsg="retMsg1" routerValue="<%=phoneNo%>">
...
<script language=javascript>
  window.onload=function(){
  	var phoneNo1 = "<%=phoneNo%>";
    if(phoneNo1=="" || phoneNo1=="null"){
      removeCurrentTab();
    }
...
function doCfm(subButton)
{
  ...
  for(var i=0;i<radio1.length;i++)
  {
	if(radio1[i].checked)
	{
		...
		if(opFlag=="one")
		{     
			frm.action="fG068Open.jsp";
			document.all.opcode.value="g068";
		}
		else if(opFlag=="two")
		{
		...
		frm.action="fG069Open.jsp";
		document.all.opcode.value="g069";
		}
	}
  }
  frm.submit();
