...
<%
  ...
  String regionCode     = (String)session.getAttribute("regCode");
	...
	paraAray[8] =  iProdOffInsId; 														//资费实例  
	paraAray[9] =  iProductId;  														  //产品代码
	paraAray[10] =  new_iServicId; 														   //APP的ServiceID串    新选择的
	paraAray[11] =  iServicId;                          //旧APP的ServiceID串      旧的服务查的        
	paraAray[12] =  "工号"+(String)session.getAttribute("workNo")+"为客户做视频APP调整业务";   
	

	String serverName = "sDXSPLLOffDeal";
try{
%>
