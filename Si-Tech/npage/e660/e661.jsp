...
<script language="JavaScript">
	function do_query()
	{
	  ...
	  var document_no		= frm.document_no.value ;
		document.frm.action="e661_1.jsp?document_name="+document_name+"&document_no="+document_no;
		document.frm.submit();
	}
	...
	function do_moHu()
	{
		...
		document.frm.action="e661_0.jsp?region_code="+region_code+"&begin_ymd="+begin_ymd+"&end_ymd="+end_ymd;
		document.frm.submit();
	}
</script> 
