...
<%     	
      	...
      	inParas1[0] = "SELECT document_name, document_no,to_char(action_flag ), to_char(action_time,'yyyymmdd hh24:mi:ss'), RETURN_MSG ,to_char(document_accept),active_name  FROM pBackPay_check   WHERE document_name = :document_name    AND document_no = :document_no  AND action_flag = 3" ; 
...
function retProcess(packet)
{

	var sRetMsg = packet.data.findValueByName("sRetMsg");
  ...
  <table cellspacing="0">
    <tbody> 
     ...
     <tr> 
        ...
        <td width="35%"> 
 					<input class="InputGrey"  readonly type="text" name="max_user" size="50" value="<%=result2[0][5]%>" >  
				</td>
				<td class="blue" width="15%">合并后金额最高的用户金额：</td>
        <td width="35%"> 
 					<input class="InputGrey" readonly type="text" name="max_fee"size="50" value="<%=result2[0][6]%>">  
				</td>
     </tr>
     ...
     <tr>
        ...
        <td width="35%"> 
 					<input class="InputGrey" readonly type="text" name="all_users" size="50" value="<%=result2[0][7]%>">  
				</td>
				<td class="blue" width="15%">合并后总金额：</td>
        <td width="35%"> 
 					<input class="InputGrey" readonly type="text" name="all_fee" size="50" value="<%=result2[0][8]%>">  
				</td>			
     </tr>
  ...
  <table cellspacing="0">
    <tbody> 
     ...
     <tr> 
        ...
        <td width="35%"> 
 					<input class="InputGrey" readonly type="text" name="min_month" size="50" value="<%=result2[0][9]%>">  
				</td>
				<td class="blue" width="15%">最长月份：</td>
        <td width="35%"> 
 					<input class="InputGrey" readonly type="text" name="max_month" size="50" value="<%=result2[0][10]%>">  
				</td>
     </tr>
     ...
     <tr>
        ...
        <td width="35%"> 
 					<input class="InputGrey" readonly type="text" name="min_turns" size="50" value="<%=result2[0][11]%>" >  
				</td>	
				<td class="blue" width="15%">最长周期：</td>
        <td width="35%"> 
 					<input class="InputGrey" readonly type="text" name="max_turns" size="50" value="<%=result2[0][12]%>" >  
				</td>			
     </tr>
  ...
  <table cellSpacing="0">
    <tr> 
      <td id="footer"> 
      		...
      		%>
<!-- 必须核对文件后才能提交所以封掉          <input type="button" name="query" class="b_foot" value="<%=button_name%>" onclick=do_submit("B","<%=DOCUMENT_ACCEPT%>") <%=hidden_flag1%> >
          &nbsp;
--->
