...
function set_MM_pl(){
    ...
    function queryRate(){
        ...
        var vIdNo = $("#id_no").val();
		var vPhoneNo = $("#phone_no").val();//haoyy add 20120216 关于申请解决车务通业务问题的请示

				//2）修改页面调用服务sGetAddProduct的逻辑部分，如果选择批量
				//下标 8的入参传0
        ...
        path = path + "&phoneNo=" + vPhoneNo;//haoyy add 20120216 关于申请解决车务通业务问题的请示
...
<div class="title">
	<div id="title_zi">
		...
		<span id="div_mm_chg_type" style="display:none">
			...
			<input type="radio" name="mm_chg_type" value="2"    onclick="chg_MM_tab_show(2)"         />批量
		</span>
	</div>
</div>
