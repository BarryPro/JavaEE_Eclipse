...
%> 
            <wtc:service name="sGetGroupInit" routerKey="region" routerValue="<%=regionCode%>" retcode="retCode1" retmsg="retMsg1" outnum="13" >
            	<wtc:param value="<%=iccid%>"/>
            	<wtc:param value="<%=cust_id%>"/>
                <wtc:param value="<%=unit_id%>"/>
                <wtc:param value="<%=service_no%>"/>
                <wtc:param value="<%=regionCode%>"/>
                <wtc:param value="7897"/>
                <wtc:param value="m03"/>
