...
function add1()
{
	...
	//var gmfmc = document.all.gmfmc.value ;
	if(hth=="" ||gmf=="")
	{
		rdShowMessageDialog("请输入托收合同号和购买方号码!");
		return false;
	}
	else
	{
		var prtFlag=0;
		prtFlag=rdShowConfirmDialog("是否确认添加操作?");
		if (prtFlag==1)
		{
			//document.frm.action="zgbj_2.jsp?hth="+hth+"&gmf="+gmf+"&stype=ins"+"&gmfmc="+gmfmc;
			document.frm.action="zgbj_2.jsp?hth="+hth+"&gmf="+gmf+"&stype=ins";
			document.frm.submit();
		}
		else
		{
...
<form action="" method="post" name="frm">
    ...
    <table cellspacing="0">
      ...
      <tr> 
        ...
        <td colspan="4"> 
        	<q vType="setNg35Attr">
          <input name="busyType1" id="busyType1" type="radio" onClick="sel1()" value="1" checked>新增 
        </q>
  ...
  <table cellspacing="0">
	...
	<!--
	<tr>
	<td class="blue" width="15%">购买方名称</td>
      <td> 
        <input type="text" name="gmfmc" size="60" maxlength="60"  >
      </td>
	</tr>
	 -->
  </table>
  ...
  <table cellSpacing="0">
    <tr> 
      <td id="footer"> 
           <input type="button" name="query" class="b_foot" value="新增" onclick="add1()" >
          &nbsp;
