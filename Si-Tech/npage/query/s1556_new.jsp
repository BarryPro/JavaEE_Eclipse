...
<!--	
 ...
 function sel1()
 {
            window.location.href='s1556.jsp?activePhone='+"<%=activePhone%>";
 }
 function sel2()
 {
            window.location.href='../s6995/f6995_1.jsp?activePhone='+"<%=activePhone%>";
 }
 ...
 function init()
 {
	...
	<%
		...
		if(opCode1.equals("1556") ||opCode1=="1556")
		{
			%>	
				document.getElementById("sl1").checked=true;<%
		}
		if(opCode1.equals("6995") ||opCode1=="6995")
		{
              ...
              <table cellspacing="0">
                ...
                <tr> 
                  ...
                  <td colspan="3"> 
                    ...
                    <input name="busyType1" id="sl1" type="radio" value="1556"  checked >
                    [1556]明细账单查询
				          &nbsp;&nbsp;&nbsp;
					<input name="busyType1" id="sl2" type="radio" value="6995"    >
					[6995]特服费用查询
					</td>
                 </tr>
...
function doCfm()
{
	...
	// alert("1"+"<%=workno%>"+"<%=opCode%>");
	 ...
	 if(radioButtonVal=="1556")
	 {
			frm.action="s1556.jsp?activePhone=<%=activePhone%>";
     }
	 if(radioButtonVal=="6995")
	 {
			frm.action="../s6995/f6995_1.jsp?activePhone=<%=activePhone%>";
     }
	 frm.submit();
}
