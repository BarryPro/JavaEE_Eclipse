...
%>
	<wtc:service name="s1500_wPayQry" routerKey="region" routerValue="<%=regionCode%>" retcode="retCode1" retmsg="retMsg1" outnum="18" >
...
<!--xl add for 积分信息查询-->
<wtc:service name="s1500_PointQry" routerKey="region" routerValue="<%=regionCode%>" retcode="retCode2" retmsg="retMsg2" outnum="18" >
	<wtc:param value="<%=phone_no%>"/>
	<wtc:param value="<%=id_no%>"/>
	<wtc:param value="<%=begin_time%>"/>
	<wtc:param value="<%=end_time%>"/>
