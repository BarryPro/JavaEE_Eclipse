...
<HEAD>
    ...
    <%
     String opCode = request.getParameter("opCode")==null?"1863":request.getParameter("opCode");
...
function doCheck()
{
	...
	else 
	{
					...
					||(document.frm1527.optType.value == 2)||(document.frm1527.optType.value == 3 ))
			{
				...
				"fDetQryC.jsp?qryType="+document.frm1527.detType.value+
    		...
    		//	rdShowMessageDialog("AAAAAAAAAAA");
	  // rdShowMessageDialog("currTime = "+currTime +"readPath= "+readPath+"appId= "+appId+"appName= "+appName+"sceneId= "+sceneId+"sceneName= "+sceneName+"ipAddr = "+ipAddr);
			//	System.out.println("currTime = "+currTime +"readPath= "+readPath+"appId= "+appId+"appName= "+appName+"sceneId= "+sceneId+"sceneName= "+sceneName+"ipAddr = "+ipAddr);
	      var getdataPacket = new AJAXPacket("fAjax5085.jsp","正在获得数据，请稍候......");
				...
				getdataPacket = null;
	     // rdShowMessageDialog("BBBBBBBBBBBB");
	    	
			}
	    else if(document.frm1527.dynPW.value.length==6)
			{
				document.frm1527.action="fDetQryC.jsp?qryType="+document.frm1527.detType.value+"&qryName="
