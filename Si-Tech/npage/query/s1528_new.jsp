...
<!--	
 ...
 function sel1()
 {
            window.location.href='f1528_1.jsp?activePhone='+"<%=activePhone%>";
 }
 function sel2()
 {
            window.location.href='../s1300/s4182.jsp?activePhone='+"<%=activePhone%>";
 }
 */
 ...
 function init()
 {
	...
	<%
		if(opCode1.equals("1528") ||opCode1=="1528")
		{
			%>	
				document.getElementById("sl1").checked=true;<%
		}
		if(opCode1.equals("4182") ||opCode1=="4182")
		{
			...
			<div id="title_zi">请选择查询类型</div>
              ...
              <table cellspacing="0">
                ...
                <tr> 
                  ...
                  <td colspan="3"> 
                   <q vType="setNg35Attr">
                    <input name="busyType1" id="sl1" type="radio" value="1528"   checked >
                    [1528]交费信息查询
                  </q>
				          &nbsp;&nbsp;&nbsp;
				            <q vType="setNg35Attr">
					<input name="busyType1" id="sl2" type="radio" value="4182"  >
					[4182]POS交费记录查询
					</q>
					</td>
                 </tr>   
...
function doCfm()
{
	...
	// alert("1"+"<%=workno%>"+"<%=opCode%>");
	 ...
	 if(radioButtonVal=="1528")
	 {
			frm.action="f1528_1.jsp?activePhone=<%=activePhone%>";
     }
	 if(radioButtonVal=="4182")
	 {
			frm.action="../s1300/s4182.jsp?activePhone=<%=activePhone%>";
     }
	 frm.submit();
}
<!--
