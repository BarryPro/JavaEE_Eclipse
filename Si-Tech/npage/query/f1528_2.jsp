...
<%
  ...
  if (sConMoreQryArr1.length > 0)
	...
	{
		countName  = result[0][2].trim();   
		
		int i_cust_length = countName.length();
		System.out.println("aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa i_cust_length is "+i_cust_length+" and countName is "+countName+" and count is "+count);
		if(i_cust_length>=4)
		{
			countName=countName.substring(0,2)+"****";
		}
		else if(i_cust_length==3)
		{
			countName=countName.substring(0,1)+"**";
		}
		else
		{
			countName=countName.substring(0,1)+"*";
