...
%>
   ...
   <!-- =================================取用户密码以及工号密码 add by zhangyta at 20120501 Begin============================================ -->  
...
<!-- =================================取用户密码以及工号密码 add by zhangyta at 20120501 End============================================ -->
...
<FORM action="s1321_3print.jsp" method=post name=form>
	 <%@ include file="/npage/include/header.jsp" %>
	 	<div class="title">
			<div id="title_zi">帐单类型  <%=bill_typename%> </div>
				     ...
				     <table cellspacing="0">
                      <tr > 
                        <th> 
                          <div align="center"> <b>帐单年月</b></div>
                        </th>
						<!--<td nowrap bgcolor="#99ccff"> 
                          <div align="center"> <b>批次</b></div>
                        </td>-->
						<th> 
                          <div align="center"> <b>费用名称</b></div>
                        </th>
						<th> 
                          <div align="center"> <b>应收</b></div>
                        </th>
						<th> 
                          <div align="center"> <b>优惠</b></div>
                        </th>
						<th> 
                          <div align="center"> <b>帐单帐目项</b></div>
                        </th>
					  </tr>
		...
		<%
			...
			<a href="f1500_sPubCustBillDet1.jsp?idNo=<%=result[0][0]%>&opFlag=1556">详细资费信息查询</a>
		<%
			}
		%>
