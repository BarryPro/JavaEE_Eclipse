...
<%	
  ...
  String opName = request.getParameter("opName");  
	...
	paraAray[1] = request.getParameter("updateLevel_hidden"); //变更级别
  paraAray[2] = work_no;
...
%>
		<script language="JavaScript">
			  ...
			  //history.go(-2);
			  window.location.href="f9912_a.jsp?opCode=<%=opCode%>&opName=<%=opName%>&activePhone=<%=paraAray[0]%>";
		</script>
<%
	}else{
%>   		<script language="JavaScript">
