...
<form action="" name="frm" method="POST">
 	<input type="hidden" name="opcode" value = "g635" >
	<input type="hidden" name="opname" value = "担保开机" >
	...
	<table cellspacing="0" id="tabList">
		...
		<tr >
			<td class="blue" colspan=2 >
				担保人手机号码 &nbsp;&nbsp;&nbsp;<input type="text" name="unitid" value="<%=activePhone%>" readonly maxlength="11">
			</td>
			 
		</tr>
		<tr >
			<td class="blue" colspan=2 >
				被担保人手机号码 <input type="text" name="bdb"  maxlength="11">
			</td>
...
<script language="javascript">
	...
	function docfm()
	{
		...
		var bdb = document.frm.bdb.value;
		if(bdb=="")
		{
			rdShowMessageDialog("请输入被支付手机号码!");
		}
		else
		{
			var actions = "g635_2.jsp?phone_no="+unitid+"&bdb="+bdb;
