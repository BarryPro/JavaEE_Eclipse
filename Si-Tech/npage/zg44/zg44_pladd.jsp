      ...
      <tr> 
        ...
        <td colspan="4"> 
         ...
         <q vType="setNg35Attr">
		  ...
		  <!--xl add  批量导入-->
		  <q vType="setNg35Attr">
          <input name="busyType2" type="radio" onClick="sel5()" value="3" checked> 批量成员添加
          </q>
		  <!--
		  <q vType="setNg35Attr">
  ...
  <table cellspacing="0">
		              <tbody> 
			              <tr> 
				                ...
				                <td width="30%" colspan="2">
					                    <input type="text" size="30" class="InputGrey" readonly value="虚拟集团关系配置">
				                </td>				               		              
		       ...
		       <table  cellspacing="0">
					  ...
					  <!--
						...
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;虚拟集团编码|虚拟集团名称|工号|地市编码|成员手机号码|成员帐户号码  回车<br>
						</td>
			              </tr>   
		              </tbody> 
		      </table>
