...
%>
    <wtc:service name="s1222Init" routerKey="phone" routerValue="<%=phoneNo%>" retcode="s1222InitCode" retmsg="s1222InitMsg" outnum="54" >
    ...
    <wtc:array id="moreInfo" start="22" length="32" scope="end" />
<%
...
<%                                                      
        ...
        for(int i = 0 ; i < moreInfo.length ; i ++){            
            for(int j = 0 ; j < moreInfo[i].length ; j ++){   
                ...
                /* System.out.println(" == ningtn == " + i + " " + j + " : " + moreInfo[i][j].trim()); */
%>                                                      
