...
<%
    ...
    try{
        if(("M".equals(iBizMode))||("1".equals(iBizMode))){
            sqlStr = "select biztype,biztype||'->'||biztypename from sbiztypecode where sm_code='ML' and main_type='"+iBizTypeL+"'";
        }else{
            sqlStr = "select biztype,biztype||'->'||biztypename from sbiztypecode where sm_code='AD' and main_type='"+iBizTypeL+"'";
        }
        %>
