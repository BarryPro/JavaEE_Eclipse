...
<%
	...
	String op_name = "业务信息变更";
	String opName = "业务信息变更";
...
onload=function(){	    
	    ...
	    /*2012年4月10日,修正业务小类不能设置值的问题,将此行和上一行对换了位置*/
	    changeBizTypeL();
		...
		<TABLE cellSpacing="0">
			 <TR> 
	         	<TD id="footer" align="center"> 		      
	         		<input name="modBtn" style="cursor:hand" type="button" class="b_foot" value="确定" onClick="modBusiInfo()">&nbsp;&nbsp;  	    
   ...
   if(document.form1.introURL.value != "" && document.form1.introURL.value.substr(0,7)!="http://")
		...
		if(document.form1.tb3_col1.length!=undefined)
		{
			for(var i = 0;i<document.form1.tb3_col1.length;i++)
			{
				...
				{
					rdShowMessageDialog("开通参数不能是数字开头!");
					return false;
				}
				if(/[^0-9a-zA-Z]/g.test(document.form1.tb3_col1[i].value))
				{
					rdShowMessageDialog("开通参数只能是字母或数字组合!");
					return false;
				}
			}
		}else
