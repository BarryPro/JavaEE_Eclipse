...
<%	
	...
	String qydm= request.getParameter("qydm");
	String ywdm= request.getParameter("ywdm");
	 
	String ywsysj= request.getParameter("ywsysj");
	...
	//新增入参 企业代码 业务代码 费用 使用时间
	paraAray[12] =ywdm;
	paraAray[13] =qydm;
	paraAray[14] =strBackMoney;
	paraAray[15] =ywsysj;
%>
<wtc:service name="szgaj_cz" routerKey="phone" routerValue="<%=phoneno%>" retcode="s4141_2CfmCode" retmsg="s4141_2CfmMsg" outnum="2" >
...
<script language="JavaScript">
	...
	window.location="zgaj_cz.jsp";
	</script>
<%
	}else{
%>   
<script language="JavaScript">
	rdShowMessageDialog("投诉退费冲正处理失败:<%=retMsg%>,<%=retCode%>",0);
	window.location="zgaj_cz.jsp";
	</script>
<%}
%>
