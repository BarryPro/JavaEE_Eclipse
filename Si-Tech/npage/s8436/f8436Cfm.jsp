...
System.out.println(errCode);
	...
	{
		System.out.println("调用服务s8436Cfm in f8436_1.jsp 成功@@@@@@@@@@@@@@@@@@@@@@@@@@");
%> 
		<script language="JavaScript">
			rdShowMessageDialog("操作成功!");
			window.location="f8436_1.jsp?opCode=8436&opName=号码过户限制添加";
		</script>
<%
 	        		        	
 	}else{
		System.out.println("调用服务s8436Cfm in f8436_1.jsp 失败@@@@@@@@@@@@@@@@@@@@@@@@@@");
