...
String errMsg = "";
%>
<wtc:service name="sd211UpdateFee"  routerKey="region" routerValue="<%=region_code%>" retcode="code" retmsg="msg" outnum="0">
...
<script language="javascript">
	...
	document.URL = "fd211_updateCloseFee.jsp?regionCode="+region_code+"&closeFeeCode="+closeFee_code;
</script>	
