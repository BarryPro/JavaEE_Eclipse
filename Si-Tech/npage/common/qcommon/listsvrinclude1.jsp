...
<body>
	...
	<%=PageListNav.pageNav(String.valueOf(rowsCount),pageSize,currentPage)%><a>总计<b class="orange"><%=rowsCount%></b>条记录</a>
</div>
	...
	<div class="list" >
     ...
     if (i < iStartPos) 
		...
		if(!selType.equals("")){
		%>
		<td align="center" class="<%=classes%>"><input type="<%=selType%>" name='List' style='cursor:hand' RIndex=<%=i%> onkeydown="if(event.keyCode==13) saveTo()" onclick="saveTo()" ></td>
		<%
		}					
