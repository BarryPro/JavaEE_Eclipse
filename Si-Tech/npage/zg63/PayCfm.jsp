...
<%
  ...
  String return_page="";
	...
	if(busy_type.equals("2"))   return_page="zg63_1.jsp?opCode="+opCode+"&opName="+opName;
...
if("<%=s_invoice_flag%>"=="0")
	{
   	var prtFlag=0;
		...
		if (prtFlag==1)
		{
			...
			{
				//alert("go kh");
				document.frm_print.action="../e005/PrintInvoice_kf.jsp?check_seq="+"<%=check_seq%>"+"&s_flag="+"<%=s_flag%>"+"&bill_code="+"<%=bill_code%>"+"&opCode=zg63";
			...
			{
				//alert("原来的");
				document.frm_print.action="../zg62/PrintInvoice.jsp?check_seq="+"<%=check_seq%>"+"&s_flag="+"<%=s_flag%>"+"&opCode=zg63";
