...
function commit(){
 ...
 function sel1() {
    window.location.href='e9001.jsp';
 }
 function sel2(){
 ...
 function init()
 {
	...
	String sql_init = "select S_INVOICE_NUMBER,E_INVOICE_NUMBER,INVOICE_CODE from TT_WLOGININVOICE where LOGIN_NO = '"+login_no+"'  "; 
	%>
    ...
    if(retList.length != 0)
	{
		...
		<%
		max = Integer.parseInt(result[0][1]) - Integer.parseInt(result[0][0]);
	}
	%>
 }
 </script> 
...
<BODY onload = "init()">
<form action="e903Cfm.jsp" method="post" name="frm">
		<%@ include file="/npage/include/header.jsp" %>   
  	
		<div class="title">
			<div id="title_zi">铁通营业员发票删除</div>
		</div> 
	<!--
  <table cellspacing="0">
 ...
 <table cellspacing="0">
    <tr>
        ...
        <td colspan="4"> 
          ...
          <input name="busyType1" type="radio" onClick="sel1()" value="1" >录入发票号码和发票代码 
          <input name="busyType1" type="radio" onClick="sel2()" value="2" >按流水查询 
          <input name="busyType1" type="radio" onClick="sel3()" value="3" checked>营业员发票删除 
