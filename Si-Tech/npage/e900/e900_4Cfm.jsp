...
<%	
   ...
   ret_msg = retMsg;
	...
	inParas2[0]="select taxpay_code,taxpay_name from DBCUSTADM.TT_SINVOICECODE where region_code=:region_code1 and dis_code='01'";
...
//		request.setAttribute("jsr",jsr);
	    ...
	    request.getRequestDispatcher("e900_4Txt.jsp").forward(request, response);
	}else{
%>
