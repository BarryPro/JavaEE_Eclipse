...
<%
	    ...
	    String sqlStr1 = "20";
%>
<wtc:service name="sCrmDefSqlSel" outnum="2" retmsg="return_msg1" retcode="return_code1">
			<wtc:param value="<%=sqlStr1%>"></wtc:param>
</wtc:service>
...
function select_change()
{
	...
	var myPacket = new AJAXPacket("e900_select1.jsp","正在获得区县信息，请稍候......");
	var sqlStr = "21";
...
<BODY>
<form action="e900Cfm.jsp" method="post" name="frm">
