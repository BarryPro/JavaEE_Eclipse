...
String total_no = "";
	int flag = 0;
%>
	<wtc:service name="s247cfm" routerKey="regionCode" routerValue="<%=regionCode%>"  retcode="sReturnCode" retmsg="sErrorMessage"  outnum="21" >
...
%>
<HEAD><TITLE>黑龙江BOSS-手工充值卡配置</TITLE>
...
function gohome()
{
document.location.replace("g247_1.jsp");
}
-->
</script>
</HEAD>
