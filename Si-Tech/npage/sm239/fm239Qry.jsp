...
try{		
%>
		<wtc:service name="m239Qry" routerKey="region" routerValue="<%=regionCode%>" retcode="retCode" retmsg="retMsg" outnum="12">
	...
	<wtc:array id="infoRet1" scope="end" start="0"  length="11"  />
	<wtc:array id="result_t" scope="end" start="11"  length="1" />
