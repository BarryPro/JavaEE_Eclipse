...
%>	
    ...
    <wtc:service name="s4116Cfm" routerKey="regionCode" routerValue="<%=regionCode%>"  retcode="errCode" retmsg="errMsg"  outnum="2" >
...
<%
		...
		{
			System.out.println("调用服务s4116Cfm in f4116_1.jsp 成功@@@@@@@@@@@@@@@@@@@@@@@@@@");
%> 
			<script language="JavaScript">
				rdShowMessageDialog("操作成功!");
				window.location="f4116_1.jsp?opCode=<%=op_code%>&opName=<%=opName%>";
			</script>
<%
	
		}else
		{
			System.out.println("调用服务s4116Cfm in f4116Cfm.jsp 失败@@@@@@@@@@@@@@@@@@@@@@@@@@");
