...
%>
	<wtc:service name="s7123Cfm" routerKey="region" routerValue="<%=regCode%>" retcode="retCode1" retmsg="retMsg1" outnum="3">			
...
<script language="JavaScript">
	...
	window.location="f7123.jsp?opCode=7123&opName=<%=opName%>";
</script>
<%}%>