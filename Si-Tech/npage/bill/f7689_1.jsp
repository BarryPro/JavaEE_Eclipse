...
<%
  ...
  String opName = "预存话费赠TD商务固话(铁通)冲正";
...
<body>
	...
	<tr>
	    ...
	    <input type="hidden" name="iOpCode" value="7689">
		...
		<input type="hidden" name="do_note" value="<%=iPhoneNo%>"+"预存话费赠TD商务固话(铁通)冲正">
		...
		<input type="hidden" name="return_page" value="/npage/bill/f7688_login.jsp?opName="预存话费赠TD商务固话(铁通)"&opCode=7688&activePhone=<%=iPhoneNo%>">	
