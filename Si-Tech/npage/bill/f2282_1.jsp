...
//--------1---------doProcess函数----------------
  ...
  function doProcess(packet)
  {
    ...
    document.frm.ip.value= next_rate_code;							
		...
		document.all.do_note.value = document.all.phoneNo.value+"签约赠礼品冲正，礼品代码："+document.all.Gift_Code.value;
  ...
  function chkPass()
  {    	
  var myPacket = new AJAXPacket("qryCus_s2282Init.jsp","正在查询客户，请稍候......");
	...
	<table cellspacing="0"  >
		...
		<tr > 
			<td class="blue">
	          ...
	          <td>
	          			<input type="text" name="Gift_Code" value="<%=gift_code%>">
		...
		<tr > 
			<td colspan="4" id="footer"> 
				...
				<input name="commit" id="commit" type="button" class="b_foot"   value="下一步" onClick="frmCfm();">
	              ...
	              &nbsp; 
	              <input name="close" onClick="parent.removeTab('b282');" type="button" class="b_foot" value="关闭">
	              &nbsp; 
				</div>
			</td>
		</tr>
		...
		<input type="hidden" name="loginAccept" value="<%=paraStr[0]%>">
			...
			<input type="hidden" name="iOpCode" value="2282">
	    ...
	    <!--以下部分是为调f1270_3.jsp所定义的参数
			...
			<input type="hidden" name="do_note" value="<%=iPhoneNo%>"+"签约赠礼品冲正">
			...
			<input type="hidden" name="beforeOpCode" value="2281">	
			<input type="hidden" name="backaccept" value="<%=iLoginNoAccept%>">		
			
			<input type="hidden" name="return_page" value="/npage/bill/f2282_1.jsp">			
