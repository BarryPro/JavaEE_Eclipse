...
<%
      ...
      if(Integer.parseInt(retPowerRight[0][0])<=0){ /*count(*)>0代表该工号能办理4263功能，否则不允许*/
%>
        <script language=javascript>
          rdShowMessageDialog("该工号无权限办理公务测试号转出业务！",1);
          removeCurrentTab();
        </script>
<%       
      }
...
<body>
<form name="frm" method="POST" action="f4263_1.jsp" onKeyUp="chgFocus(frm)">
	<%@ include file="/npage/include/header.jsp" %> 	
      ...
      <table cellspacing="0">
		  ...
		  <td>
			<input type="text" name="opFlag" class="InputGrey" value="申请" readonly>&nbsp;&nbsp;
		  </td>
      	</tr>    
      	<tr> 
