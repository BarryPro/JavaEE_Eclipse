...
<%	 }
	...
	//String rpcPage = "qryCus_s7382Init";
%>
<%
//******************得到下拉框数据***************************//

  //手机品牌
  String sqlAgentCode = "select  unique a.brand_code,trim(b.brand_name) from dphoneSaleCode a,schnresbrand b where a.region_code='" + regionCode + "' and a.sale_type='20' and a.brand_code=b.brand_code and valid_flag='Y' and spec_type like 'P%'";
  String[] inParamA = new String[2];
  inParamA[0] = "select  unique a.brand_code,trim(b.brand_name) from dphoneSaleCode a,schnresbrand b where a.region_code=:region_code and a.sale_type='20' and a.brand_code=b.brand_code and valid_flag='Y' and spec_type like 'P%'";
...
<%
  //手机类型
  String sqlPhoneType = "select unique a.type_code,trim(b.res_name), b.brand_code from dphoneSaleCode a,schnrescode_chnterm b where a.region_code='" + regionCode + "' and  a.type_code=b.res_code and a.brand_code=b.brand_code and a.sale_type='20' and valid_flag='Y' and spec_type like 'P%'";
  String[] inParamB = new String[2];
  inParamB[0] = "select unique a.type_code,trim(b.res_name), b.brand_code from dphoneSaleCode a,schnrescode_chnterm b where a.region_code=:region_code and  a.type_code=b.res_code and a.brand_code=b.brand_code and a.sale_type='20'and valid_flag='Y' and spec_type like 'P%'";
...
<%
  //营销代码
  String sqlsaleType = "select unique a.sale_code,trim(a.sale_name), a.brand_code,a.type_code from dphoneSaleCode a where a.region_code='" + regionCode + "' and a.sale_type='20' and valid_flag='Y' and spec_type like 'P%'";
  String[] inParamC = new String[2];
  inParamC[0] = "select unique a.sale_code,trim(a.sale_name), a.brand_code,a.type_code from dphoneSaleCode a where a.region_code=:region_code and a.sale_type='20' and valid_flag='Y' and spec_type like 'P%'";
...
<%
  //营销明细
  String sqlsaledet = "select favour_cost,base_fee,consume_term,free_fee,active_term,mon_base_fee,all_gift_price,sale_price,sale_code,market_price from dphoneSaleCode  where region_code='" + regionCode + "' and sale_type='20' and valid_flag='Y' and spec_type like 'P%'";
  String[] inParamD = new String[2];
  inParamD[0] = "select favour_cost,base_fee,to_char(consume_term),free_fee,to_char(active_term),mon_base_fee,all_gift_price,sale_price,sale_code,market_price from dphoneSaleCode where region_code=:region_code and sale_type='20' and valid_flag='Y' and spec_type like 'P%'";
  inParamD[1] = "region_code=" + regionCode;
  System.out.println("sqlsaledet===1111111111111=="+sqlsaledet);
%>
...
<%
  ...
  //新主资费(修改部分)
  String sqlmodecode = "select a.mode_code,a.sale_code from dChnResSalePlanModeRel a , dphoneSaleCode b,sbillmodecode c where a.sale_code=b.sale_code and b.region_code='" + regionCode + "' and b.sale_type='20'  and b.region_code=c.region_code and a.mode_code=c.mode_code";
  String[] inParamE = new String[2];
  inParamE[0] = "select a.mode_code,a.sale_code from dChnResSalePlanModeRel a , dphoneSaleCode b,product_offer c where a.sale_code=b.sale_code and b.region_code=:region_code and b.sale_type='20'  and to_number(a.mode_code)=c.offer_id";
...
%>
	<wtc:service name="TlsPubSelCrm" routerKey="phone" routerValue="<%=iPhoneNo%>" retcode="retCodeE" retmsg="retMsgE" outnum="7">
...
<!--
  ...
  {
	out.println("arrdetfavour["+l+"]='"+saledetStr[l][0]+"';\n");
	...
	//out.println("arrdetsummoney["+l+"]='"+saledetStr[l][8]+"';\n");
 ...
 function viewConfirm()
{
	  		...
	  		if((document.all.m_smCode.value !="") && (document.all.m_smCode.value != document.all.oSmCode.value))
	  		{
		  		if(document.all.oSmCode.value == "gn"){
		  			...
		  			if(smzvalues=="3") {//非实名制全球通、动感地带客户转移为神州行客户
		  				rdShowMessageDialog("<%=readValue("7379","ps","jf",Readpaths)%>");
		  			}
		  		}
	  		}
  ...
  function frmCfm()
  {
	 document.frm.iAddStr.value=document.frm.sale_code.value+"|"+document.all.agent_code.options[document.all.agent_code.selectedIndex].text+"|"+document.all.phone_type.options[document.all.phone_type.selectedIndex].text+"|"+
	                            document.frm.Sale_Price.value+"|"+document.frm.Base_Fee.value+"|"+document.frm.Consume_Term.value+"|"+document.frm.Free_Fee.value+"|"+document.frm.Active_Term.value+"|"+document.frm.Mon_Base_Fee.value+"|"+
	                            document.frm.All_Gift_Price.value+"|"+document.frm.Market_Price.value+"|"+document.frm.IMEINo.value;
...
function getbrand(){
 ...
 function checkAward()
 {
  ...
  function salechage(){
	...
	for ( x3 = 0 ; x3 < arrdetsalecode.length  ; x3++ )
   	{
      		...
      		{
      			document.all.Favour_Cost.value=arrdetfavour[x3];
    ...
    document.all.do_note.value = "用户"+document.all.phoneNo.value+"办理预存优惠购卡";
     document.frm.iAddStr.value=document.frm.sale_code.value+"|"+document.all.agent_code.options[document.all.agent_code.selectedIndex].text+"|"+document.frm.Sale_Price.value+"|"+document.frm.Base_Fee.value+"|"+document.frm.Consume_Term.value+"|"+document.frm.Free_Fee.value+"|"+document.frm.Active_Term.value+"|"+document.all.phone_type.options[document.all.phone_type.selectedIndex].text+"|"+document.frm.Mon_Base_Fee.value+"|"+document.frm.All_Gift_Price.value+"|"+document.frm.Market_Price.value+"|"+document.frm.IMEINo.value;
...
<body>
	...
	<table cellspacing="0">
          ...
          <tr>
            ...
            <td>
			  ...
			  <font color="orange">*</font>
               ...
               <td class="blue" >优惠额度</td>
                <td>
                	<input name="Favour_Cost" type="text" class="InputGrey" id="Favour_Cost" readonly>
              </td>
          </tr>
		</tr>
		<tr>
		...
		<tr>
            ...
            <td>
				<input name="All_Gift_Price" type="text" class="InputGrey" id="All_Gift_Price" readonly>
			</td>
		</tr>
		<tr>
			 <td class="blue">
...
<div name="licl" id="licl">
			<input type="hidden" name="iOpCode" value="7379">
			...
			<input type="hidden" name="return_page" value="/page/bill/f7379_1.jsp">		
