...
//--------1---------doProcess函数----------------
  ...
  function doProcess(packet)
  {
    ...
    var oNextMode		= packet.data.findValueByName("oNextMode"       );  
		...
		document.all.Next_Mode.value = oNextMode;
  ...
  function frmCfm()
  {
     	...
     	document.frm.op.value="用户取消了彩铃营销案";
  		 //getAfterPrompt();
         if(!checkElement(document.all.phoneNo)) return;
         document.frm.iAddStr.value=document.frm.Sale_Code.value+"|"+document.frm.Color_Mode.value+"|"+document.frm.Pay_Money.value+"|"+document.frm.Begin_Time.value+"|"+document.frm.backaccept.value+"|"+document.frm.op.value+"|";
         //alert(document.frm.iAddStr.value);
...
<body>
	...
	<table cellspacing="0">
		...
		<tr> 
			...
			<td>
				<input name="Pay_Money" type="hidden" class="InputGrey" id="Pay_Money" <%=oPayMoney%> readonly>
			</td>
			<td>
...
<div name="licl" id="licl">			
			<input type="hidden" name="opCode" value="7967">
			<input type="hidden" name="iOpCode" value="7967">
	    ...
	    <!--以下部分是为调f1270_3.jsp所定义的参数
			...
			<input type="hidden" name="do_note" value="<%=iPhoneNo%>"+"彩铃取消">
