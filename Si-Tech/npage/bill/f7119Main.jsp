...
<%
  ...
  inParam[0] = "select a.mode_code ,a.mode_code||'--'||b.mode_name from sBillModeNormal a, sBillModeCode b where a.region_code=b.region_code and a.mode_code=b.mode_code and a.region_code=:region_code and a.sm_code=:sm_code";
  inParam[1] = "region_code=" + region_code +",sm_code=" + sm_code;
...
function setOpNote(){
	...
	{
  		document.frm.opNote.value = "动感地带月租包年取消;号码:"+document.frm.phoneNo.value; 
	}
	return true;
}
//-->
...
<form name="frm" method="post">
	<%@ include file="/npage/include/header.jsp" %>   
      ...
      <table cellspacing="0">
          ...
          <tr > 
            <td class="blue">备注</td>
            <td colspan="3">
             <input name="opNote" type="text" id="opNote" value="" size="30" onFocus="setOpNote();" readOnly class="InputGrey"> 
            </td>
          </tr>
		  <tr> 
  ...
  <input name="breach_fee" type="hidden" class="button" id="breach_fee" value="<%=breach_fee%>" readonly>
  <input name="order_code" type="hidden" class="button" id="order_code" value="" readonly>
  <input name="should_fee" type="hidden" class="button" id="should_fee" value="<%=should_fee%>" readonly>
  <input name="mon_base_fee" type="hidden" class="button" id="mon_base_fee" value="0"   readonly>
  <input name="consume_term" type="hidden" class="button" id="consume_term" value="<%=consume_term%>"   readonly>
