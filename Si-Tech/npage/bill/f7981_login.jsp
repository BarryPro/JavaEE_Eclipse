...
%>
<%  String num2="";
	String sqlstr="select count(*) from wphonesaleopr a,dcustmsg b where a.id_no=b.id_no and a.back_flag='0'  "+
				  "and a.op_code='7981' and a.stop_time > to_char(sysdate,'YYYYMMDD') and b.phone_no='"+phoneNo+"'";
%>
...
function doCfm(subButton)
{
  ...
  for(var i=0;i<radio1.length;i++)
  {
    if(radio1[i].checked)
	{
	  ...
	  if(opFlag=="one")
	  {
	    	frm.action="f7981_1.jsp";
	    	document.all.opcode.value="7981";
	  }else if(opFlag=="two")
	  {
	    if(document.all.backaccept.value==""){
	    	...
	    	frm.action="f7982_1.jsp";
	    	document.all.opcode.value="7982";
	  }
