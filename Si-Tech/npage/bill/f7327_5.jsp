...
%>
	<wtc:service name="s7327Sel" retcode="retCode1" retmsg="retMsg1" outnum="14">			
...
<%
  ...
  if(result2.length==0)
  {
	...
	{
	   retFlag="1";
	   retMsg="s7327Sel查询号码基本信息为空!<br>errCode: " + errCode + "<br>errMsg: " + errMsg ;
    }  
  ...
  { 
   ...
   mainCartOweMoney = result13[0][0];
	  ...
	  if(phoneNoArr==null || phoneNoArr.length==0 || phoneNoArr[0][0].equals("")){
	    ...
	    {
	       retFlag="1";
	       retMsg="s7327Sel查询号码基本信息失败!"+errMsg;
        }
	}  
...
<!--
  ...
  function ret()
  {
  		...
  		window.location.href='/npage/bill/f7327.jsp?activePhone=<%=show_phone%>&opName=<%=opName%>&opCode=<%=opCode%>';
  }
		  ...
		  <tr>
		    ...
		    <tr> 
			  ...
			  <%
			    if(op_Flag.equals("1")){
			  %>
			  <TD align=center class="<%=tdClass%>"><%=mainCartState%></TD>
			  <%
			  ...
			  %>
			  <TD align=center class="<%=tdClass%>"><%=stateFlagArr[j][0]%></TD>
			  <%
