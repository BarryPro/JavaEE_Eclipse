...
<%
    ...
    */
    ...
    if (theop_code.equals("1255") || theop_code.equals("1259") || theop_code.equals("1201")) {
        ...
        paraAray[19] = next_main_cash.substring(0,next_main_cash.indexOf("--")); //@wt          19 下月主套餐              iNextMode                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      
        ...
        System.out.println("-----------------------paraAray[0] -------------------------"+paraAray[0] );
				...
				System.out.println("-----------------------paraAray[9] -------------------------"+paraAray[9] );
				System.out.println("-----------------------paraAray[10]-------------------------"+paraAray[10]);
				System.out.println("-----------------------paraAray[11]-------------------------"+paraAray[11]);
				System.out.println("-----------------------paraAray[12]-------------------------"+paraAray[12]);
				System.out.println("-----------------------paraAray[13]-------------------------"+paraAray[13]);
				System.out.println("-----------------------paraAray[14]-------------------------"+paraAray[14]);
				System.out.println("-----------------------paraAray[15]-------------------------"+paraAray[15]);
				System.out.println("-----------------------paraAray[16]-------------------------"+paraAray[16]);
				System.out.println("-----------------------paraAray[17]-------------------------"+paraAray[17]);
				System.out.println("-----------------------paraAray[18]-------------------------"+paraAray[18]);
				System.out.println("-----------------------paraAray[19]-------------------------"+paraAray[19]);
				System.out.println("-----------------------paraAray[20]-------------------------"+paraAray[20]);
				System.out.println("-----------------------paraAray[21]-------------------------"+paraAray[21]);
				System.out.println("-----------------------paraAray[22]-------------------------"+paraAray[22]);
				System.out.println("-----------------------paraAray[23]-------------------------"+paraAray[23]);
				System.out.println("-----------------------paraAray[24]-------------------------"+paraAray[24]);
				System.out.println("-----------------------paraAray[25]-------------------------"+paraAray[25]);
				System.out.println("-----------------------paraAray[26]-------------------------"+paraAray[26]);

        
 %>
			<wtc:service name="s1255CfmEx" routerKey="phone" routerValue="<%=themob%>" retcode="retCode1" retmsg="retMsg1" outnum="2" >
...
<script language="jscript">
    function printBill() {
        ...
        var dirtPage = "/npage/bill/f1201_login.jsp?activePhone=<%=phone_no%>";
