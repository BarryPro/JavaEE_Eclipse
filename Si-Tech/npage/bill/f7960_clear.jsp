...
<%
  ...
  else if(errCode.equals("000000") && tempArr.length>0)
  {
	    ...
	    oColorName = tempArr[0][30];//彩铃资费名称
...
//--------1---------doProcess函数----------------
  ...
  function doProcess(packet)
  {
    ...
    var oNextMode		= packet.data.findValueByName("oNextMode"       );  
		...
		document.all.Pay_money.value = oPayMoney;
		...
		document.all.do_note.value = document.all.phoneNo.value+"彩铃申请冲正："+document.all.Sale_Code.value+"，礼品代码："+document.all.Sale_Name.value;
	  	//document.frm.iAddStr.value=document.all.Sale_Code.value+"|"+document.frm.Color_Mode.value+"|"+document.frm.Pay_money.value+"|"+document.frm.Begin_time.value+"|"+
	  								document.op.value+"|"+document.frm.backaccept.value+"|";
  ...
  function frmCfm()
  {
  		 if(document.frm.op.value=="")
     		document.frm.op.value="用户进行了彩铃营销案冲正";
  		 //getAfterPrompt();
         if(!checkElement(document.all.phoneNo)) return;
         document.frm.iAddStr.value=document.all.Sale_Code.value+"|"+document.all.Color_Mode.value+"|"+document.all.Pay_money.value+"|"+document.frm.Begin_Time.value+"|"+
	  								document.all.op.value+"|"+document.frm.backaccept.value+"|";
	   	//alert(document.frm.iAddStr.value);                  
	...
	<div id="title_zi">业务明细</div>
		...
		<TABLE cellSpacing="0">
          <TBODY> 
            ...
            <td>
            	<input type="text" name="Sale_Code" id="Sale_Code" value="<%=oSaleCode%>" size="10" readonly class="InputGrey">
			</td>            
            <td class="blue">
            	营销案名称
            </td>
            <td>
				<input name="Sale_Name" type="text" class="InputGrey" id="Sale_Name" size="40" value="<%=oSaleName%>" readonly>
			</td>
		</tr>
		<tr>	
			<td class="blue">
            ...
            <td>
				<input name="Mode_Code" type="text" class="InputGrey" id="Mode_Code" size="10" readonly value="<%=oModeCode%>">
			</td>  
			<td class="blue">
				主资费名称
			</td>
			<td>
				<input name="Mode_Name" type="text" class="InputGrey" id="Mode_Name"  size="40" readonly value="<%=omodename%>">
		</tr>	
		<tr> 
     	 <td class="blue">
       		 彩铃代码
      		...
      		<td>
				<input name="Color_Mode" type="text" class="InputGrey" id="Color_Mode" size="10" value="<%=oColorMode%>" readonly>
			</td>
			<td class="blue">
				彩铃名称
			</td>
            <td>
				<input name="Color_Name" type="text" class="InputGrey" id="Color_Name" size="40" value="<%=oColorName%>" readonly>
			</td>             
		</tr>
		<tr>	
            <td class="blue">
            ...
            <td>
            	<input type="text" name="Begin_Time" id="Begin_Time" value="<%=oBeginTime%>" size="9" readonly class="InputGrey">
			</td>            
            <td class="blue">
            	业务到期日期
            </td>
		...
		<tr>
        	<td colspan=4>
        		<input name="op" type="hidden" class="button" size="20" id="op" maxlength=30 >
        	</td>
        </tr>			
		<tr> 
...
<div name="licl" id="licl">	
			<input type="hidden" name="opCode" value="7964">
			<input type="hidden" name="iOpCode" value="7964">
	    ...
	    <!--以下部分是为调f1270_3.jsp所定义的参数
			...
			<input type="hidden" name="do_note" value="<%=iPhoneNo%>"+"彩铃申请冲正">
