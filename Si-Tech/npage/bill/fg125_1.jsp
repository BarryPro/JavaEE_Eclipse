...
<%
  ...
  String opName = "购TD商务固话赠通信费(铁通)冲正";
...
<%
  ...
  System.out.println("======================================================7689start");
%>
	<wtc:service name="s7689Init" routerKey="phone" routerValue="<%=iPhoneNo%>" retcode="retCode2" retmsg="retMsg2" outnum="46">
...
System.out.println("======================================================7689end");
  ...
  {
	   retFlag = "1";
	   retMsg = "s7689Init查询号码基本信息为空!<br>errCode: " + errCode + "<br>errMsg+" + errMsg;
  }
...
<body>
	...
	<tr>
	    ...
	    <input type="hidden" name="iOpCode" value="g125">
		...
		<input type="hidden" name="do_note" value="<%=iPhoneNo%>"+"购TD商务固话赠通信费(铁通)冲正">
		...
		<input type="hidden" name="return_page" value="/npage/bill/fg124_login.jsp?opName="购TD商务固话赠通信费(铁通)"&opCode=g124&activePhone=<%=iPhoneNo%>">	
