	...
	<%@ include file="/npage/include/header.jsp" %>   
	  ...
	  <TR> 
		...
		<TD>
			...
			<input type="radio" name="opFlag" value="two" >取消&nbsp;&nbsp;
			<input type="radio" name="opFlag" value="three" >亲情号增加&nbsp;&nbsp;
			<input type="radio" name="opFlag" value="four" >亲情号删除&nbsp;&nbsp;
		</TD>
