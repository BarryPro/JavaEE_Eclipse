...
/****************由移动号码得到密码、机主姓名、 等信息 s1206InitEx***********************/
  ...
  //retList = impl.callFXService("s1206InitEx", paraAray1, "33","phone",phoneNo);
%>
...
<%
  ...
  }else if(!(tempArr[0][1] == null))
  {
	if (errCode.equals("000000")){
		...
		{
		   retFlag = "1";
	       retMsg = "s1206InitEx查询号码基本信息失败!<br>errCode: " + errCode + "<br>errMsg: " + errMsg;
		}
	}
  }
...
function setOpNote(){
	...
	{
		if ("<%=regionCode%>"=="03")
	  		document.frm.opNote.value = "数据业务包年冲正;"+document.frm.phoneNo.value+";"+document.frm.order_code.value; 
		else
	  		document.frm.opNote.value = "畅听冲正;"+document.frm.phoneNo.value+";"+document.frm.order_code.value; 
	}
	return true;
}
//-->
	...
	<%@ include file="/npage/include/header.jsp" %>   
      ...
      <table cellspacing="0">
          ...
          <tr style="display:none"> 
            <td class="blue">备注</td>
            <td colspan="3">
             <input name="opNote" type="text" id="opNote" value="" onFocus="setOpNote();"> 
            </td>
          </tr>
		  <tr> 
            <td colspan="4"> 
