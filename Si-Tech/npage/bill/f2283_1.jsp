...
//--------1---------doProcess函数----------------
 ...
 { 
	...
	document.all.do_note.value = "用户"+document.all.phoneNo.value+"办理全球通签约送礼，方案代码："+document.all.Gift_Code.value;    
	...
	<table cellspacing="0" >
		...
		<tr> 
            ...
            <td>
				...
				<font class="orange">(扣减积分<0为赠送积分)</font>
			</td>  
			 <td class="blue">
            	消费期限
            </td>
