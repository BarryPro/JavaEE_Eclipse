...
%>
	<wtc:service name="s7689Init" routerKey="phone" routerValue="<%=iPhoneNo%>" retcode="retCode1" retmsg="retMsg1" outnum="46">
...
<body>
	...
	<tr>
		...
		<td>
			...
			<input name="Consume_Term" type="hidden" id="Consume_Term" value="<%=consume_term%>"  />
			<input name="Free_Fee" type="hidden" id="Free_Fee"  value="<%=free_fee%>" />
		</td>
	</tr>
	<tr>
		...
		<td colspan="3">
			...
			<input name="Active_Term" type="hidden" id="Active_Term"  value="<%=active_term%>" />
		</td>
	</tr>
	<tr>
	    ...
	    <input type="hidden" name="iOpCode" value="g123">
