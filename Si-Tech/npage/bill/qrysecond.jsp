...
//  retList = co.callFXService("s8042Init", inputParsm, "29","phone",iPhoneNo);
%>
	<wtc:service name="s8042Init" routerKey="region" routerValue="<%=regionCode%>" outnum="29" retcode="retCode1" retmsg="retMsg1">
