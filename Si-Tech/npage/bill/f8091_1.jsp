...
//--------1---------doProcess函数----------------
 ...
 /*
  function chkPass()
  {
  var myPacket = new RPCPacket("qryCus_s2284Init.jsp","正在查询客户，请稍候......");
...
<form name="frm" method="post" action="f1270_3.jsp" onKeyUp="chgFocus(frm)">
	...
	<table cellspacing="0">
		<tr >
			...
			<!--	<input class="InputGrey" type="button" name="qryId_No" value="查询" onClick="chkPass()">-->
			</td>
		...
		<tr >
			...
			<input name="oMarkPoint" type="hidden" class="InputGrey" id="oMarkPoint" value="" >
			</td>
		</tr>
		<tr>
			...
			<td>
			<input name="Gift_Name" type="text"  size=40 class="InputGrey" id="Gift_Name" value="<%=gift_name%>" readonly>
			</td>
		...
		<tr >
			...
			&nbsp;
			<input name="close" onClick="parent.removeTab('<%=opCode%>');" type="button" class="b_foot" value="关闭">
			&nbsp;
			</div>
			</td>
		</tr>
	...
	<input type="hidden" name="loginAccept" value="<%=printAccept%>">
		...
		<input type="hidden" name="iOpCode" value="8091">
    ...
    <!--以下部分是为调f1270_3.jsp所定义的参数
		...
		<%
		group_type_code = group_type_code +"--"+group_type_name;
		bigCust_flag = bigCust_flag+"--"+bigCust_name;
		%>
		
		<input type="hidden" name="group_type" value="<%=group_type_code%>" >
		<input type="hidden" name="ibig_cust" value="<%=bigCust_flag%>">
		...
		<input type="hidden" name="beforeOpCode" value="8094">
		<input type="hidden" name="backaccept" value="<%=iLoginNoAccept%>">
		<input type="hidden" name="printAccept" value="<%=printAccept%>">
		<input type="hidden" name="return_page" value="/npage/bill/f8091_1.jsp">
		
		<input type="hidden" name="opCode" value="8091">
		<input type="hidden" name="opName" value="特殊号码资费营销案冲正">
