...
/****************由移动号码得到密码、机主姓名、温馨家庭申请等信息 s1251Init***********************/
  ...
  String main_card = request.getParameter("parentPhoneNo");
  ...
  //retList = impl.callFXService("s7328Qry", paraAray1, "36", "phone",main_card);
%>
	<wtc:service name="s7328Qry" routerKey="phone" routerValue="<%=main_card%>" retcode="retCode1" retmsg="retMsg1" outnum="36">
	<wtc:param value="0"/>
	<wtc:param value="01"/>		
...
<!--
  ...
  function ret()
  {
  		window.location.href='/npage/bill/f7328_login.jsp?activePhone=<%=main_card%>&opName=<%=opName%>&opCode=<%=opCode%>';
  }
