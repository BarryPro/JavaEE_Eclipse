...
<%
		System.out.println("===gaopengSeeLog========= fm402Chk.jsp ==========");
...
try{		
%>
		<wtc:service name="sKDAddOfferChk" routerKey="region" routerValue="<%=regionCode%>"
...
<%
		...
		if("000000".equals(retCode)){
			System.out.println("============ fm402Chk.jsp ==========" + infoRet1.length);
				...
				%>
					...
					for(int j=0;j<infoRet1[i].length;j++){
						System.out.println("============ fm402Chk.jsp ==========infoRet1["+i+"]["+j+"]" + infoRet1[i][j]);
						%>
			...
			System.out.println("============ fm402Chk.jsp 失败==========");
		}
		}catch(Exception e){
			retCode11 = "444444";
