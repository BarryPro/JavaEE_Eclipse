...
<xsl:choose>
	<xsl:when test=".[TreeNode or @Xml]">xtree/img/collapsed.gif</xsl:when>
	<xsl:otherwise>xtree/img/endnode.gif</xsl:otherwise></xsl:choose>
</xsl:attribute>
</img>
<input type="checkbox" style="top:0px">
