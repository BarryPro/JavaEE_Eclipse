		  ...
		  with(document.forms[0])
		  {
			//alert(document.form1.region_code.value);
			  hTableName.value="RPT003";
				...
				hParams1.value= "dbcustadm.prc_zgaa_rpt('"+document.form1.login_no.value+"','"+document.form1.begin_time.value+"','"+document.form1.end_time.value+"','"+document.form1.org_code1.value+"'";
...
<form  action="../rpt/print_rpt_boss.jsp" method="post" name="form1">
  ...
  <table cellspacing="0">
    <tr>
		...
		<td>
			<input type="text"   name="login_no" value=<%=work_no%> size="17" maxlength="17">
		</td>
	</tr> 
	<tr>
