    ...
    //alert(printinfo); 
     	  ...
     	  var opcode = "<%=opcodeadd%>";
     		...
     		function submit_cfm(){
     	  	...
     	  	if("<%=opcodeadd%>" =="1104" || "<%=opcodeadd%>" =="m275" ||"<%=opcodeadd%>" =="d535" ||"<%=opcodeadd%>" =="4977"||"<%=opcodeadd%>" =="g784"||"<%=opcodeadd%>" =="g785"||"<%=opcodeadd%>" =="m028"||"<%=opcodeadd%>" =="m094"||sysAccept4977!=""){/* lijy add @20110517 d535,4977分支的添加，用户ims开户,宽带开户免填单打印*/
	     	  	var tableName = "tbl"+servOrderNoArray[0];
	     	  	var tabobj = g(tableName);
	     	  	var simcardfee = 0;
	     	  	var prefee = 0;
