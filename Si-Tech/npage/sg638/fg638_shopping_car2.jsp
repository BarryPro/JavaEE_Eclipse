...
function ini(phone_no) 
  {     	
		var packet = new AJAXPacket("/npage/portal/shoppingCar/getOper.jsp");
...
function goNext(custOrderId,custOrderNo,prtFlag)
{
	...
	$("#buzhou3",window.parent.document).css("display","");
	$("#buzhou3",window.parent.document).attr("src",nextpath);
}
    ...
    var retCode = packet.data.findValueByName("retCode"); 
	  ...
	  if(retCode=="0")
	  {
	  	...
	  	var path=   pageUrl+"?gCustId=<%=g_CustId%>"
	  							...
	  							+"&prtFlag="+prtFlag
	  							+"&opCode=g629&opName=家庭用户开户&crmActiveOpCode=g629&activePhone=<%=phone_no%>&broadPhone=null"
...
function funCheck4977()
{
    ...
    initOpCode = "4977";
    var pageName = "/npage/portal/shoppingCar/qryProductOfferComplex.jsp?opCode="+initOpCode+"&phoneNo=<%=activePhone%>";
...
{	
    ...
    var packet = new AJAXPacket("/npage/portal/shoppingCar/getProdSrv.jsp");
           ...
           /* if (checkflag != "1")//需要验证
            {
                ...
                var path = "/npage/portal/shoppingCar/sCustAuthQry.jsp" + str;
...
function getCustMore(obj)
{
    if (obj.flag == "1")
    {
        ...
        $(".moreCust").html(oDiv);
        var packet = new AJAXPacket("/npage/portal/shoppingCar/getCustMore.jsp");
        packet.data.add("custId", "<%=gCustId%>");
...
function ajaxGetDcustMsgByCustId(){
	var packet = new AJAXPacket("/npage/portal/shoppingCar/ajaxGetDcustMsgByCustId.jsp");
...
function ajax_CT_HOMECUST_INFO(){
	var packet = new AJAXPacket("/npage/portal/shoppingCar/ajax_CT_HOMECUST_INFO.jsp");
	    packet.data.add("g_CustId", "<%=g_CustId%>");
...
function funCreFamily(){
    ...
    initOpCode = "g629";
    var pageName = "/npage/portal/shoppingCar/qryProductOfferComplex_family.jsp?opCode="+initOpCode;
   	window.open(pageName,'销售品选择','width=840px,height=600px,left=100,top=50,resizable=yes,scrollbars=yes,status=yes,location=no,menubar=no');
}
function getCarFirst(custOrderId,oldWorkNo)	//2011/8/19 wanghfa修改
{
    ...
    var packet = new AJAXPacket("/npage/portal/shoppingCar/getCar.jsp");
    packet.data.add("custOrderId", custOrderId);
...
function getCar(custOrderId,oldWorkNo) {
  ...
  var packet = new AJAXPacket("/npage/portal/shoppingCar/ajax_checkWorkNo.jsp");
...
function showDetailCar(orderId,serNo){
		var path = "/npage/portal/shoppingCar/showDetailCar.jsp?orderId="+orderId+"&serNo="+serNo;
...
function delTrOver()
{
	...
	var packet = new AJAXPacket("/npage/portal/shoppingCar/ajax_delTr.jsp");
...
function nominateOper(phone_no,iCust_Type,vAction_Code,iCust_Type_code)
{
	...
	var packet = new AJAXPacket("/npage/portal/shoppingCar/ajax_addOper.jsp");
	packet.data.add("phone_no", phone_no);
...
<form method="post" name="frm">
  ...
  <div id="Operation_Table">
    ...
    <div class="but_look" style="display:none">
...
%>		
            ...
            <div id="items" style="overflow-y:auto; overflow-x:hidden;">
                <div class="item-col col-1" style="width: 100%;overflow-y:auto; overflow-x:hidden;">
                    <div class="title" style="display:none">
                    	<div id="title_zi">产品订购信息</div>
                    </div>

                    <div class="list" style="height:100px; overflow-y:auto; overflow-x:hidden;_width:100%; display:none">
                    ...
                    <div class="list" style="width: 100%;overflow-y:auto; overflow-x:hidden;">
                ...
                <div class="item-row col-2" style="width:0%;height:100%;overflow-y:no;overflow-x:no;display: none;">
                    <div class="title">
        ...
        <div id='pop-div' style="overflow-y:auto; overflow-x:auto; width:600px; height:0px;" class="pop-box">  
        ...
        <div id="footer" style="width: 98%;margin-left: 10px;overflow-y:auto; overflow-x:hidden;">
            ...
            <div style="float:left;text-align:left;">
                ...
                <input type="hidden" class="b_foot" value="重置" id="nextBtn" custOrder="" onclick="clearPage();"/>
            </div>
        </div>
...
<div id="page-warp" style="display: none;">
...
<script>
    var _jspPage = {
	"div1_switch":["mydiv1","/npage/portal/shoppingCar/fserviceMsg.jsp?activePhone="+$("#phone_no_source").val(),"f"]
	,"div2_switch":["mydiv2","/npage/portal/shoppingCar/fsource_sel.jsp?activePhone="+$("#phone_no_source").val(),"f"]
	,"div3_switch":["mydiv3","/npage/portal/shoppingCar/fserviceMsg1.jsp?activePhone="+$("#phone_no_source").val(),"f"]
		,"div4_switch":["mydiv4","/npage/portal/shoppingCar/fserviceMsg2.jsp?activePhone="+$("#phone_no_source").val(),"f"]
		,"div5_switch":["mydiv6","/npage/portal/shoppingCar/fserviceMsg4.jsp?activePhone="+$("#phone_no_source").val(),"f"]
		,"div6_switch":["mydiv7","/npage/portal/shoppingCar/fserviceMsg6.jsp?activePhone="+$("#phone_no_source").val(),"f"]
	};
