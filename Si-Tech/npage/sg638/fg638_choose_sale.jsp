...
{	
	...
	else
	{
		...
		*/
		...
		$("#buzhou2",window.parent.document).attr("src","fg638_shopping_car.jsp?gCustId=<%=gCustId%>&loginType=<%=loginType%>&phone_no=<%=phone_no%>&activePhone=<%=phone_no%>&custOrderId=&broadPhone=&resultList="+resultList);
