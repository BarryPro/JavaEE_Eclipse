...
function dnyCreatDiv2(login_accept,printinfo){
	var newE = parent.parent.parent.document.createElement("DIV");
    
    newE.id = login_accept;
    newE.printinfo=printinfo;
    newE.style.display = "none";
    parent.parent.parent.document.appendChild(newE);
}
function doProcess(packet)
{
	  ...
	  if(retCode=="0")
	  {
	  	...
	  	parent.parent.parent.addTab(false,closeId,funciton_name,path);
	  	parent.parent.setFamilyNum("<%=serviceNo%>");
