		...
		queryInfo();
		 ...
		 function queryInfo(){
	       ...
	       // }
	        ...
	        var myPacket = new AJAXPacket("fg638_show2.jsp","正在获取信息，请稍候......");
...
<form id="frmg638" name="frmg638" method="post" >
	...
	<table cellspacing="0">
		<tr>
			...
			<td>
				<input type="text" id="phoneNo" name="phoneNo"  v_must="1" v_type="mobphone" maxlength="11" value="<%=phoneNo%>"/><font class="orange">*</font>
			</td>
			<td class="blue">密码</td>
			<td>
