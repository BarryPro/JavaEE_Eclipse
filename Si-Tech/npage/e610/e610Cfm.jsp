...
String sql="";
String errMsg="";
String rtnPage = "/npage/e610/e610_1.jsp";
String password="";
int row_count = 51;
int num=0;
...
<div align="center">
  ...
  codebase="smsx.cab#Version=6,3,436,14">
    ...
    -->
	 &nbsp;&nbsp;&nbsp;&nbsp;
	 <input type="button"  class="b_foot"value="返回" title="返回" onClick="window.location='e610_1.jsp?opCode=e610&opName=统一账单打印&crmActiveOpCode=e610'" align="center"/>
	 &nbsp;&nbsp;&nbsp;&nbsp;
