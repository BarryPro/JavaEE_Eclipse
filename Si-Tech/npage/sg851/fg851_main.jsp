...
<HEAD>
	...
	<SCRIPT language="javascript" 
		type="text/javascript" src="/npage/public/zalidate.js"></script>
...
<DIV ID="Operation_Table">
	<DIV ID="d0" NAME="d0" STYLE="display:none">
		...
		<TABLE>
			<TR>
				<TD class="blue" align="CENTER">用户账号:</TD>
				<TD colspan = '3'>
					<INPUT type="TEXT" ID='Account' NAME='Account' ch_name='用户账号' MAXlENGTH="64" VALUE='<%=phoNo%>'
						class = 'InputGrey' readOnly />	
				</TD>	
			<TR>
			<TR>
				<TD colspan="4" align="center" id="footer">
					<INPUT TYPE="button" ID="btnCfm" NAME="btnCfm" CLASS="b_foot" VALUE="确认" onClick="doCfm()" />   
...
function doRet()
{
	document.frm.action="fg851_main.jsp?opCode=<%=opCode%>&opName=<%=opName%>";
	document.frm.submit();			
}
...
function doCfm()
{
	...
	document.frm.action="fg851_cfm.jsp";
	document.frm.submit();	
