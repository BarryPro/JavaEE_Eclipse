...
<HTML>
	<HEAD>
		<TITLE>黑龙江BOSS-网间号码批量导入功能</TITLE>
        ...
        if(document.all.delayType.value == "")
			...
			function setOpNote()
			{
				...
				{
				  document.all.opNote.value = "操作员："+document.all.loginNo.value+"进行了网间号码批量导入操作"; 
				}
				return true;
			}	
			...
			{
				var seled =$("#seled").val()
				document.form.action="s6945_e935Upload.jsp?remark="+document.form.opNote.value+"&regCode="+"<%=regionCode%>"+"&sysAccept="+"<%=sysAccept%>"+"&delayType="+document.form.delayType.value+"&seled="+seled;
	      	...
	      	<!--huangrong add 延期标志 并对页面样式修改 2011-6-29-->
		    	<tr> 
		      	<td class="blue" align=center width="10%">延期标志</td>		        
				    <td width="40%" class="blue" colspan="3">
				    ...
				    <!--end add 延期标志 2011-6-29-->	
			       	  <TD class="blue" align=center width="10%" style="display:none">数据来源</TD>
	      ...
	      <tr> 
	      	<td colspan="3">说明：<br>
					  ...
					  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color="red">数据文件为TXT文件</font>：<br>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color="red">注意号码的正确性，否则会造增加网间号码批量导入操作失败</font>:<br>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;手机号码  回车<br>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;如： <br>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;13604511111 <br>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;13704511111 <br>
