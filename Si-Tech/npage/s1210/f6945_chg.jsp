...
<head>
<title>垃圾短信与网管黑名单综合受理_修改</title>

<%
String opCode = "6945";
String opName = "垃圾短信与网管黑名单综合受理_修改";
	...
	<tr>
	    ...
	    <td class="blue" width="20%">
	    	<select name="opType" id="opType" class="button" >
	    		...
	    		<option value="U">修改该用户的垃圾短信和黑名单的取消时间</option>
	    	</select>
	    </td>
	    ...
	    <td class="blue" width="20%">
	    	<select name="delayType" id="delayType" class="button" onChange="changType()">
	    		...
	    		<option value="F" selected>立即恢复</option><!--huangrong add 默认立即恢复-->
	    	</select>
	    </td>	    
	</tr>
		           <TR id="bltys"  > 
