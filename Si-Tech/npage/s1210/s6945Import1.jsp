<%
  /*
   * 功能:垃圾短信号码的批量信息导入，文件从weblogic域复写到tuxedo域
   * 版本: 1.0
   * 日期: 2010/01/29
   * 作者: gaolw
   * 版权: si-tech
...
<%
	...
	String filename = orgcode.substring(0,2)+"gsms_open_web.txt";	
	System.out.println("*******************************************="+filename);
	String iErrorNo ="";
	String sErrorMessage = " ";	
	String remark = request.getParameter("remark");

	String sSaveName=request.getRealPath("/npage/tmp/")+"/"+orgcode.substring(0,2)+"gsms_open_web.txt";		
...
<html>
	<body onload="ifprint()">
		<form action="s6945Import2.jsp" name="frm_print_invoice" method="post">
