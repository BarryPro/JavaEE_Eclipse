...
<head>
<title>垃圾短信与网管黑名单综合受理_网间号码查询_修改</title>

<%
String opCode = "e851";
String opName = "垃圾短信与网管黑名单综合受理_网间号码查询_修改";
	...
	<tr>
	    ...
	    <td class="blue" width="20%">
	    	<select name="opType" id="opType" class="button" >
	    		<option value="U">修改该用户的网间黑名单时间</option>
	    	</select>
	    </td>
	    ...
	    <td class="blue" width="20%">
	    	<select name="delayType" id="delayType" class="button" >
	    		...
	    		<option value="F" selected>立即恢复</option>
	    	</select>
	    </td>	    
	</tr>
    <tr>
