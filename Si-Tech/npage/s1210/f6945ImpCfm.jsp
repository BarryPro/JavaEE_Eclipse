...
<%
	...
	paraStr[17] = "";//huangrong update paraStr[16]-->paraStr[17] 2011-6-21
%>

	<wtc:service name="s7478Imp" routerKey="regionCode" retCode="initRetCode" retMsg="initRetMsg" routerValue="<%=regionCode%>" outnum="5">
...
<table cellspacing="0">
    ...
    <tr>
        <td colspan="4" id="footer">
						<input class="b_foot" type="button" name="b_back" value="返回" onClick="location='f6945_2.jsp'">
            &nbsp;        	
