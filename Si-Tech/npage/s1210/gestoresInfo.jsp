<TR id="gestoresInfo1" > 
 ...
 <tr id="gestoresInfo2" > 
  ...
  <TD colspan="5"> 
    <input name="gestoresAddr" id="gestoresAddr"  class="button" v_must='0' v_type="addrs" size=60 index="21"  onblur="if(checkElement(this)){ checkAddrFunc(this,4,0);}"><font class="orange">*</font>
		&nbsp;&nbsp;
		<input type="button" name="scan_idCard_two3" id="scan_idCard_two3" class="b_text"   value="读卡" onClick="Idcard_realUser('manage')" />
