...
int flag = 0;
%>
	<wtc:service name="se935Cfm" routerKey="region" routerValue="<%=regionCode%>"  retcode="sReturnCode" retmsg="sErrorMessage"  outnum="1" >
		<wtc:param value="0"/>
...
%>  	
<HEAD><TITLE>黑龙江BOSS-网间号码批量导入功能</TITLE>
...
function gohome()
{
	document.location.replace("f6945_wjpldrphone.jsp");
}
...
<BODY>
<FORM action="f6945_wjpldrphone.jsp" method=post name=form>
