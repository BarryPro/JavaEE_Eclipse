...
<script language="javascript">
  ...
  */
  		...
  		var retCode = packet.data.findValueByName('retCode');
			...
			if (result[0][0] != ''){
					...
					for(var i = 0; i < finalResult.length; i++){
							if (finalResult[i][2] == '698001'){//已经订购过
  ...
  Page.prototype.printInfoForSubscribing = function (opcode){
			...
			/************受理内容************/
			opr_info += "业务类型：手机阅读业务" + $('select option:selected').text() + "功能申请，资费" + this.charge() + "|";
			opr_info += "操作类型：申请|";
	...
	Page.prototype.printInfoForUnsubscribing = function (opcode){
			...
			/************受理内容************/
			opr_info += "业务类型：手机阅读业务" + this.timeLongForUnsubscribing() + "功能退订申请。|";
			opr_info += "操作类型：退订|";
			opr_info += "操作时间：" + Constants.CURRENT_DATE + '|';
...
<form name="frm" method="post" action="">
  ...
  <table cellspacing="0">
      ...
      <td>
          ...
          <option spCode="698001" bizCode="100705" time="180" rmb="30元/半年" value="0">神州行阅读包半年包30元/半年</option>
          <option spCode="698001" bizCode="100705" time="360" rmb="60元/年" value="1">神州行阅读包全年包60元/年</option>
        </select>
        <input type="hidden" name="spCode" value="698001"><!-- spCode -->
