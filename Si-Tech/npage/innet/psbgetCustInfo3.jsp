...
<%  //绘制界面表头  
    ...
    %>
					...
					<wtc:service name="sCustTypeQryB"  routerValue="<%=regionCode%>"  retcode="return_code" retmsg="return_message" outnum="<%=fieldNum%>" >
						<wtc:param value="0" />
						<wtc:param value="01" />	
						<wtc:param value="1102" />	
...
<%  	
    System.out.println("result==========sCustTypeQryB服务========================="+result.length);  		
