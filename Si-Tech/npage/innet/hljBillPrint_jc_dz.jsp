...
<FORM method=post name="spubPrint" target="_parent">
  ...
  <div class="popup" >
	    ...
	    <div align="center"  style="line-height:100%">
	    	<!-- 备注信息： --><input  name="comments" id="comments"  type=hidden value="" style="width:250px;" maxlength="499">&nbsp;&nbsp;&nbsp;&nbsp;
	    	<!-- 139邮箱： --><input  name="email" id="email"  type=hidden value="" style="width:250px;" maxlength="19" onBlur="addemailend()">
	    	<input class="b_text" name=commit onClick="doclean()"   type=hidden value="清空">
	    	
	      <input class="b_text" name=commit onClick="doTest()"  style="width:60px;" type=button value="确定">&nbsp;&nbsp;
	      <input class="b_text" name=back onClick="doSub()" style="width:60px;" type=button value="取消">
	      <input class="b_text" name=commit onClick="doSubTest()" style="width:100px;"  type=hidden value="电子工单合并打印">&nbsp;&nbsp;
	      <input type="hidden" name="iccidprint" class="b_text"   style="width:100px;" value="身份证扫描打印" onClick="doIccidPrint()" >&nbsp;&nbsp;
	      <input class="b_text" name=commit onClick="doPrint()"  <%=disabledFlag%> type=hidden value="打印">&nbsp;&nbsp;
	      <%if(pType.equals("subprint")){%>
	      <input class="b_text" name=commit onClick="doSubPrint()"  <%=disabledFlag%> type=hidden value="合并打印">&nbsp;&nbsp;
	      <input class="b_text" name=back onClick="doSub()"  type=hidden value="打印存储">&nbsp;&nbsp;
  ...
  <input type="hidden" id="groupTrans" name="groupTrans" value="<%=loginacceptJT%>">
