...
<%  String path=request.getRealPath("");
    ...
    String selectRegionCode = request.getParameter("selectRegionCode") == null? "":request.getParameter("selectRegionCode");
	 		//得到写卡数据
...
//	path = "http://10.110.26.27:34000/writecard/writecard/NewWriteCard.jsp";
