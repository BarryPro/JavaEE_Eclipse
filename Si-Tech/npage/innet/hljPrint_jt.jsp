...
function doPrint()
{
    try
    {
       ...
       //基本信息 	
        ...
        printctrl.Print(startCol - 2, startRow + 6, 10, 0, oneTok(infoStr, "|", 5));        //证件地址
        printctrl.Print(startCol + 40, startRow + 6, 10, 0, oneTok(infoStr, "|", 6));        //联系电话
        
        //printctrl.Print(startCol - 2, startRow + 9, 10, 0, oneTok(infoStr, "|", 7));        //新客户姓名
        //printctrl.Print(startCol + 40, startRow + 9, 10, 0, oneTok(infoStr, "|", 8));       //新手机号码
        printctrl.Print(startCol - 2, startRow + 9, 10, 0, oneTok(infoStr, "|", 7));       //新证件号码  
        printctrl.Print(startCol - 2, startRow + 12, 10, 0, oneTok(infoStr, "|", 8));      //新证件地址  
        printctrl.Print(startCol - 2, startRow + 15, 10, 0, oneTok(infoStr, "|", 9));      //新联系地址  
        printctrl.Print(startCol + 40, startRow + 15, 10, 0, oneTok(infoStr, "|", 10));      //新联系电话  
        printctrl.Print(startCol - 2, startRow + 18, 10, 0, oneTok(infoStr, "|", 11));      //新付费方式
        ...
        //备注类    
        printctrl.Print(startCol - 2, startRow + 40, 10, 0, oneTok(infoStr, "|", 25));      //系统备注
        //printctrl.Print(startCol-2,startRow+42,10,0,oneTok(infoStr,"|",30));      //操作备注
        //换行打印广告词
        var lineLen = 45;
        var temStr = oneTok(oneTok(infoStr, "|", 36));//广告词
