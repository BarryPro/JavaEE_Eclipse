...
<wtc:sequence name="sPubSelect" key="sMaxSysAccept" id="loginAccept" />
			<wtc:service name="sQrySPOffCheck" routerKey="region" routerValue="<%=regionCode%>" outnum="11" retmsg="msg2" retcode="code2">
    		  ...
    		  <wtc:param value="<%=phoneNo%>"/>
					...
					<wtc:param value="<%=offeridstr2%>"/>
					<wtc:param value="<%=statustr2%>"/>
					<wtc:param value="<%=typestr2%>"/>
    	</wtc:service>
