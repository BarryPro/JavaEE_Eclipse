...
//	for(int j=0;j<rst_doGetProdAA[i].length;j++){
		System.out.println("chenlei---"+i+"-"+0+"------"+rst_doGetProdAA[i][0]);
		System.out.println("chenlei---"+i+"-"+1+"------"+rst_doGetProdAA[i][1]);
		System.out.println("chenlei---"+i+"-"+2+"------"+rst_doGetProdAA[i][2]);
		System.out.println("chenlei---"+i+"-"+3+"------"+rst_doGetProdAA[i][3]);
		System.out.println("chenlei---"+i+"-"+4+"------"+rst_doGetProdAA[i][4]);
		System.out.println("chenlei---"+i+"-"+5+"------"+rst_doGetProdAA[i][5]);
		System.out.println("chenlei---"+i+"-"+6+"------"+rst_doGetProdAA[i][6]);
//	}
