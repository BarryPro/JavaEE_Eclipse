...
<SCRIPT type=text/javascript>
    function saveTo()
    {
        ...
        if(retValue!=""&&retValue!=null){
          window.opener.document.all.ecsiid.value=retValue;
        	window.opener.document.getElementById("ecsiname").value=retValue1;
        	window.opener.document.getElementById("BaseServCodeProp1").value="<%=BaseServCodeProp%>";        	
        	window.opener.document.all.BaseServCodeProp.disabled =true;
					var ty=document.all.combobox.value;
        	if(ty=="02"){
        	window.opener.document.all.confirm.disabled=false;
       		 }else{
       		window.opener.document.all.confirm.disabled=true; 	
       		}
       	
        	window.opener.document.all.combobox1.disabled =true;
        	window.opener.document.getElementById("ecsiname").readOnly=true;    
        	window.opener.document.all.ecsiid.readOnly=true;
...
<input type="hidden" name="combobox" value="<%=combobox%>">    	
<table cellspacing="0">
    <tr align="center">
        <th nowrap>集团编码</th>
        <th nowrap>集团客户名称</th>
