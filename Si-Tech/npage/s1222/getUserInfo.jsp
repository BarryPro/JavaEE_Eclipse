...
<%
    ...
    //ArrayList arr = impl.callF1222Init(workNo,phoneNo,opCode,orgCode);
%>
...
<%
    ...
    System.out.println("totalOwe		当前欠费                      is : "+userInfo[0][16]);
    System.out.println("totalPrepay		当前预存                      is : "+userInfo[0][17]);
    System.out.println("firstOweConNo	第一个欠费帐号                is : "+userInfo[0][18]);
    System.out.println("firstOweFee		第一个欠费帐号金额            is : "+userInfo[0][19]);
    System.out.println("firstOweFee		第一个欠费帐号金额            is : "+userInfo[0][20]);
    System.out.println("firstOweFee		第一个欠费帐号金额            is : "+userInfo[0][21]);
...
<%                                                      
    ...
    for(int i = 0 ; i < moreInfo.length ; i ++){            
        for(int j = 0 ; j < moreInfo[i].length ; j ++){   
            //System.out.println(moreInfo[i][j]);                                                         
