...
<%
session.getAttribute("themePath")==null?"default":(String)session.getAttribute("themePath");
...
<body>
	<div id="tabset">
		<div id="tab">
			<ul id="tabtag">
				<li id="child_index" class="current"><span class="fristab"><img src="../../nresources/<%=cssPath%>/images/tab_user.gif" id="tab_user" />基本信息</span></li>
			</ul>
			<div class="clr"></div>
		</div>
