...
//查询 近两个月的记录
//增加s_type_flag判断 !=4 
inParas_dx[0]="select tax_name,to_char(phone_no),begin_ym,end_ym,to_char(login_accpet),to_char(op_time,'YYYYMMDD hh24:mi:ss')  from DINVOICE_TAX_split where spr=:s_no and flag='1' and  to_char(op_time,'YYYYMM')>=to_char(add_months(sysdate,-1),'yyyymm') order by op_time desc";
...
<script language="JavaScript">
 ...
 {
	document.frm.action="zgb8_qf.jsp?login_accept="+phone_no;
