...
function doProcess(packet)
{
	...
	if(s_flag=="Y")
	{
		...
		if(s_flag_new=="O")
		{
			...
			//1.查询cust_id 让用户去选
			//alert("1");
			returnValue = window.showModalDialog('../zg12/getContractByCustId.jsp?cust_id='+oCustId+"&tax_no="+tax_no+"&qry_flag=2","",prop);
			//alert(returnValue);
			...
			returnValue = window.showModalDialog('../zgb7/getCount.jsp?cust_id='+oCustId,"",prop);
			//alert("2?phone_no="+returnValue);
			document.frm.action="../zg12/zg12_2_qf.jsp?s_flag=0&phone_no="+returnValue;
		...
		if(s_qry_flag=="1")
		{
			...
			document.frm.action="../zg12/zg12_2_qf.jsp?s_flag=0&phone_no="+phone_no;
			//alert("test?"+document.frm.action);
			document.frm.submit();
		}
		else
 ...
 function sel2()
 {
	 window.location.href='zgb8_tax.jsp';
 } 
 function sel3()
 {
	 window.location.href='zgb8_dx.jsp';
 }
 function sel4()
 {
	 window.location.href='zgb8_cf.jsp';
 }
 </script> 
        ...
        <tbody>
            <tr>
                ...
                <td colspan="3">
					...
					<!--add for sunqy需求-->
					<q vType="setNg35Attr">
                    <input name="busyType4" type="radio" onClick="sel4()" value="4">
                    拆分预开查询
                    </q>
                </td>
