...
//查询 近两个月的记录
//增加s_type_flag判断 !=4 
inParas_dx[0]="select tax_name,phone_no,begin_dt,end_dt, to_char(login_accept),to_char(op_time,'YYYYMMDD hh24:mi:ss') from dinvoice_tax_sp where spr=:s_no and to_char(op_time,'YYYYMM')>=to_char(add_months(sysdate,-1),'yyyymm') and  s_type_flag =4 order by op_time desc";
...
<script language="JavaScript">
 ...
 {
	document.frm.action="../zg12/zg12_2_new_qf.jsp?login_accept="+phone_no;
...
<input type="hidden" name="tax_khh">
  ...
  <table cellSpacing="0">
    <tr> 
	  ...
	  <input type="button" id="back_id" name="back" class="b_foot" value="返回" onclick="window.location.href='zgb8_1.jsp'" >
