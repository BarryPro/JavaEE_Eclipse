...
System.out.println(sql_pack_type);
System.out.println(sql_pack_code);
%>
...
<DIV ID = "Operation_Table">
	<DIV ID = "d0" NAME = "d0" STYLE = "display:none">
		...
		<TABLE>
			...
			<TR>
				<TD WIDTH = '25%' ALIGN = 'CENTER' class = 'blue' >已办理套餐类型:</TD>
				<TD WIDTH = '25%'>
					<select ID = 'biz_type' NAME= 'biz_type' ch_name = '已办理套餐类型' 
						style = 'width:200px'>
						<option value = "" >---请选择---</option>
						<%
						String biz_sql = " SELECT pack_type,type_name FROM swlanmode "
							+ " where pack_type in ( "+sql_pack_type+" ) and pack_code <>'00014' "
				...
				<TD WIDTH = '25%' ALIGN = 'CENTER' class = 'blue' >已办理套餐代码:</TD>
				<TD WIDTH = '25%'>
					<select ID = 'biz_code' NAME= 'biz_code' ch_name = '已办理套餐代码' 
						style = 'width:200px'>
					</select>    
				</TD>      				
			</TR>												
