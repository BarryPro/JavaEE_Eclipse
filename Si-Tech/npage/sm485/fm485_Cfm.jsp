...
<%
	...
	String op_time_str    = WtcUtil.repNull(request.getParameter("op_time_str"));
	String con_phone_no   = WtcUtil.repNull(request.getParameter("con_phone_no"));
  ...
  String regionCode     = (String)session.getAttribute("regCode");
	...
	paraAray[6] = "";                                       //用户密码
	paraAray[7] = con_phone_no;  

	String serverName = "sm485Cfm";
try{
%>
