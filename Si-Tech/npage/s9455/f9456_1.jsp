...
<%
    ...
    inParas[6] = iUserPwd;
%>
<wtc:service name="s9456Init" routerKey="region" routerValue="<%=regionCode%>" retcode="retCode1" retmsg="retMsg1" outnum="12">			
...
<%
	...
	if (result1.length>0 && retCode1.equals("000000"))
	{
		...
		vBlackBerryStatus = result1[0][10];
...
<body>
<form name="frm" action="f9456_Cfm.jsp" method="post">
...
<table cellspacing="0">
	...
	<tr>
		<td class="blue">BlackBerry状态</td>
		<td><input  name="blackBerryStatus" type="text" value="<%=vBlackBerryStatus%>" class="InputGrey" readonly></td>
		<td class="blue">备注</td>
