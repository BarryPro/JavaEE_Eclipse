...
<%@ page contentType="text/html;charset=GBK"%>
 ...
 <%
	...
	String iUserPwd = "";
	String iLevelId = request.getParameter("iLevelId");
	String iIpAddr = (String)session.getAttribute("ipAddr");
	String opName = request.getParameter("opName");
	String iChangeType = request.getParameter("iChangeType");
	...
	inParas[7] = iIpAddr;
	inParas[8] = iLevelId;
	inParas[9] = iChangeType;
%>

	 <wtc:service name="s9457Cfm" routerKey="phone" routerValue="<%=iPhoneNo%>" retcode="retCode" retmsg="retMsg" outnum="2">
