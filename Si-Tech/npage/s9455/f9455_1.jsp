...
onload=function()
{
	rdShowMessageDialog("若取消139邮箱业务，将同时取消黑莓个人邮箱业务！");
}
...
function printInfo(printType)
{
  ...
  {
  	opr_info+="黑莓个人邮箱：98元/月。免除30M国内GPRS流量费、超出套餐所包含的国内流量后按照0.29元/M计费。"+"|";
  }
  if(document.frm.iLevelId.value=="2")
  {
  	opr_info+="黑莓个人邮箱：108元/月。免除50M国内GPRS流量费、超出套餐所包含的国内流量后按照0.29元/M计费。"+"|";
  }
...
function frmCfm()
{
 	...
 	{
 		rdShowMessageDialog("请选择有效的业务类型和资费类别!");
 		return;	
 	}
 	frm.submit();
	return true;
...
<table cellspacing="0">
	...
	<tr>
		...
		<td><select name="iBusiType" onchange="selectLevel()">
			...
			<option value="01">BlackBerry个人邮箱服务</option>
			<!--<option value="02">BlackBerry个人全服务</option>-->
			</select>
		</td>
