...
<%
  ...
  String print_note = "0";
	...
	String returnPage ="g683_1.jsp?activePhone=123456789";
...
<SCRIPT language="JavaScript">
    function printInvoice()
    {
		...
		printctrl.Print(47, 13, 9, 0, "业务类别:<%=result[0][2]%>");
    ...
    function ifprint()
    {
		...
		//alert("返回 号码是"+"<%=jzPhone%>");
		 
		window.location = "g683_1.jsp?activePhone=<%=jzPhone%>";
    }
</SCRIPT>
