...
<%
	...
	inParas2[0]="select phone_no,to_char(op_time,'YYYYMMDD hh24:mi:ss'),trim(err_msg),b.bank_cust from wgroupchargecfgerr a,dconmsg b where group_contract_no=:s_no and a.group_contract_no = b.contract_no and to_char(op_time,'YYYYMMDD')>=:d1 and to_char(op_time,'YYYYMMDD')<=:d2 order by a.op_time desc ";
