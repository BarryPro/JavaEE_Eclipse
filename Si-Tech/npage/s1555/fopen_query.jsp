...
/****************由移动号码得到密码、机主姓名、 等信息 s1251Init***********************/
  ...
  //retList = impl.callFXService("s1557openinit", paraAray1, "9","phone",phoneNo);
%>
	<wtc:service name="s1557openinit" routerKey="phone" routerValue="<%=phoneNo%>" retcode="retCode1" retmsg="retMsg1" outnum="9">			
...
<!--
  ...
  //***
  function frmCfm(){
	document.frm.action = "fopen_2.jsp";
	document.frm.submit();
	return true;
  }
  //***//校验是否选中领奖纪录
