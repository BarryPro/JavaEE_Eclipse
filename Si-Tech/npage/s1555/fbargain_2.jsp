...
<%	
	...
	//String[] ret = impl.callService("s1557barCfm",paraAray,"2","phone",request.getParameter("phoneNo"));
%>
	<wtc:service name="s1557barCfm" routerKey="phone" routerValue="<%=phoneNo%>" retcode="retCode1" retmsg="retMsg1" outnum="2">			
...
<script language="JavaScript">
   rdShowMessageDialog("签约赠礼品领奖成功！",2);
   removeCurrentTab();
</script>
<%
	}else{
%>   
<script language="JavaScript">
	rdShowMessageDialog("签约赠礼品领奖失败!<br>errCode:"+"<%=errCode%>"+"<br>errMsg:"+"<%=errMsg%>",0);
	history.go(-1);
</script>
<%}%>
