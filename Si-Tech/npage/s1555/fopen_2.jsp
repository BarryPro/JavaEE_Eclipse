...
<%	
	...
	//String[] ret = impl.callService("s1557openCfm",paraAray,"2","phone",request.getParameter("phoneNo"));
%>
	<wtc:service name="s1557openCfm" routerKey="phone" routerValue="<%=phoneNo%>" retcode="retCode1" retmsg="retMsg1" outnum="2">			
...
<script language="JavaScript">
   rdShowMessageDialog("入网送福领礼品成功！",2);
   removeCurrentTab();
</script>
<%
	}else{
%>   
<script language="JavaScript">
	rdShowMessageDialog("入网送福领礼品失败!<br>errCode:"+"<%=errCode%>"+"<br>errMsg:"+"<%=errMsg%>",0);
	history.go(-1);
</script>
<%}%>
