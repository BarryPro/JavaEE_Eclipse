...
/*业务数量	biznum*/
param.prototype.setBiznum = function(biznum){
	this.biznum = biznum;
};
param.prototype.getBiznum = function(){
	return this.biznum;
}; 

/*业务类型	biztype*/
param.prototype.setBiztype = function(biztype){
	this.biztype = biztype;
};
param.prototype.getBiztype = function(){
	return this.biztype;
}; 

/*企业代码	spid*/
param.prototype.setSpid = function(spid){
	this.spid = spid;
};
param.prototype.getSpid = function(){
	return this.spid;
}; 

/*业务代码	bizcode*/
param.prototype.setBizcode = function(bizcode){
	this.bizcode = bizcode;
};
param.prototype.getBizcode = function(){
	return this.bizcode;
}; 

/*操作代码	oprcode    06  07*/
param.prototype.setOprcode = function(oprcode){
	this.oprcode = oprcode;
};
param.prototype.getOprcode = function(){
	return this.oprcode;
}; 
