...
<%
	...
	for(int i = 0;i<attrAry.length;i++){
		...
		System.out.println("----gaopengSeeLog22-----attrId------"+attrId+"------>"+attrValue);
			if("60001".equals(attrId) && ("".equals(attrValue) || attrValue == null)){
				retCode ="444444";
				retMsg = "获取小区资费错误!，请联系系统管理员";
				%>
...
<%
	 ...
	 retMsg  = retVal.getValue(1).replaceAll("\\n"," ");
