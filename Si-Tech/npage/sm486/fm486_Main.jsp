...
*/
  ...
  String myphoneNo = WtcUtil.repStr(request.getParameter("myphoneNo"),"");
%>
...
<%
    ...
    /*lijy chage@20110726*/
		...
		String sOpType="";
			if("q034".equals(opCode)|| "m486".equals(opCode)||"e150".equals(opCode) ||"m074".equals(opCode) ||"m095".equals(opCode)){
...
function checkOperation(obj){
	...
	if(((obj.v_masterservid =="50") && ("<%=opCode%>"=="m486" || "<%=opCode%>"=="e084" || "<%=opCode%>"=="e085" || "<%=opCode%>"=="e086"))||((obj.v_masterservid =="0" || obj.v_masterservid =="10"||obj.v_masterservid =="20") && ("<%=opCode%>"=="q034" || "<%=opCode%>"=="m074" || "<%=opCode%>"=="m095"  )))
...
function commitJsp3(a,b)
{
  ...
  if( judge_valid()==false )
  {
	...
	*/
	...
	if("<%=opCode%>" == "m486" || "<%=opCode%>" == "e084" || "<%=opCode%>" == "m074" || "<%=opCode%>" == "m095"){
...
function showInfo(ch,bt){
    ...
    if("<%=opCode%>"=="m486" || "<%=opCode%>" == "m074" || "<%=opCode%>" == "m095"){
...
<%@ include file="/npage/include/header.jsp" %>
	...
	<table><!--查询按钮-->
		...
		<%if(opCode.equals("m486") || opCode.equals("m074") || opCode.equals("m095")){%>
