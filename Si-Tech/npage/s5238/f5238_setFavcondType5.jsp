...
<table width="767" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr>
    <td background="../../images/jl_background_1.gif">
            ...
            <table width="535" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td valign="bottom" width="493">
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td background="/images/jl_background_4.gif"><font color="FFCC00"><strong>优惠条件设置-月底优惠为条件</strong></font></td>
	  ...
	  <input type="hidden" name="favour_condition" value="06">
	  	<TR >
	  		<TD >
	            ...
	            <TBODY>
	  				...
	  				<tr bgcolor="#F5F5F5">
	  					<TD height="25">&nbsp;&nbsp;属性值：</TD>
	  					<TD >
	  						<input type=text  v_type="int" v_must=1 v_minlength=1 v_maxlength=30 v_name="属性值" name=cond_attr maxlength=30 value="1"></input>
