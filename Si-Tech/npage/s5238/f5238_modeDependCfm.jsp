...
<%
	...
	if(aold_mode_array!=null)
	{
		...
		//acceptList = impl.callService("s5238_DependCfm",paramsIn,"2");
		%>
		
	   <wtc:service name="s5238_DependCfm" outnum="2" retmsg="msg" retcode="code" routerKey="region" routerValue="<%=regionCode%>">
		...
		errCode=code;
		errMsg=msg;
		System.out.println("----------errCode----------f5238_modeDependCfm.jsp-----------------"+errCode);
	}
