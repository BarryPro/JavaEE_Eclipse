...
{
	document.form1.action="f5238_modeDependFrame2.jsp";
...
<body  onMouseDown="hideEvent()" onKeyDown="hideEvent()">
	...
	<div class="title">
		<div id="title_zi">其他产品代码到该产品代码的依赖关系配置</div>
	</div>
	  ...
	  <form name="form1"  method="post">
	  	...
	  	<input type="hidden" name="trans_type" value="<%=trans_type%>">
      		    ...
      		    <Th width="10%" >选择</Th>
	  				...
	  				<tr  height="22">
	  					<td colspan="4">
	  						<IFRAME src="f5238_modeDependFrame2.jsp?login_accept=<%=login_accept%>&mode_code=<%=mode_code%>&mode_name=<%=mode_name%>&region_code=<%=region_code%>&trans_type=<%=trans_type%>" frameBorder=0 id=middle name=middle scrolling="yes" style="HEIGHT: 300; VISIBILITY: inherit; WIDTH: 100%; Z-INDEX: 1">
      		  	  			</IFRAME>
      		  	  		</td>
	  				</tr>
	          	</TABLE>
	  			  ...
	  			  <TR >
	  				<TD height="30" align="center" id="footer">
	  					<input name="selectall" type="button" class="b_foot_long" value="全部选中" onClick="selectAll();">
	          	 	    ...
	          	 	    &nbsp;
	          	 	    <input name="cancel" type="button" class="b_foot" value="取消" onClick="window.opener.document.form1.otherTransModeButton.disabled=false;window.close();">
	  				</TD>
	  			  </TR>
	  	    	</TABLE>
