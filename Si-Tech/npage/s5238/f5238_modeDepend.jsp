...
{
	document.form1.action="f5238_modeDependFrame.jsp";
...
<body onMouseDown="hideEvent()" onKeyDown="hideEvent()">
	...
	<div class="title">
		<div id="title_zi">该产品代码到其他产品代码的依赖关系配置</div>
	</div>
	  	...
	  	<input type="hidden" name="trans_type" value="<%=trans_type%>">
	  		  	<TABLE    id="mainOne"  cellspacing="0">
	  				<tr  height="22">
	  					...
	  					<TD width="34%" colspan=3>
	  						<input type=text size="8" v_type="string"  v_must=0 v_minlength=1 v_maxlength=8 v_name="品牌"  name=sm_code_new maxlength=8 readonly   Class="InputGrey" ></input>
					...
					<tr  height="22">
	  					...
	  					<TD width="34%" colspan=3>
		                    ...
		                    <input  type="button" name="query_modeType"  class="b_text"onclick="queryModeType()" value="选择">
	  					</TD>
	  				</tr>
					<tr  height="22">
					...
					<tr>
		                <td colspan=4 align="center">
		                   <input  type="button" name="query_smcode" class="b_text" onclick="queryModeCode()" value="查询">						   
						   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		                   <input  type="button" name="do_reset"  class="b_text" onclick="doReset()" value="重置">
		                </td>
	                </tr>	  				
	  			</table>
	  			<table id="mainThree" cellspacing="0">
	  				...
	  				<tr  height="22">
	  					<td colspan="4">
	  						<IFRAME src="f5238_modeDependFrame.jsp?login_accept=<%=login_accept%>&mode_code=<%=mode_code%>&mode_name=<%=mode_name%>&region_code=<%=region_code%>&trans_type=<%=trans_type%>" frameBorder=0 id=middle name=middle scrolling="yes" style="HEIGHT: 300; VISIBILITY: inherit; WIDTH: 100%; Z-INDEX: 1">
      		  	  			</IFRAME>
      		  	  		</td>
	  				</tr>
	          	</TABLE>
