...
<body  onMouseDown="hideEvent()" onKeyDown="hideEvent()">
	...
	<div class="title">
		<div id="title_zi">该产品代码到其他产品代码的转换关系配置</div>
	</div>
	  	...
	  	<input type="hidden" name="trans_type" value="<%=trans_type%>">
	  		  	<TABLE    id="mainOne"  cellspacing="0">
	  				<tr  height="23">
	  					<TD colspan="4"><font class="orange">请选择需要转换的产品代码！</font></td>
	  				</tr>
	  				<tr  height="22">
	  					<TD width="16%" class="blue" >业务品牌</TD>
	  					<TD width="34%">
	  						<input type=text  v_type="string" size=8 v_must=0 v_minlength=1 v_maxlength=8 v_name="品牌"  name=sm_code_new maxlength=8 readonly Class="InputGrey" ></input>
					...
					<tr  height="22">
	  					<TD width="16%" ><font class="orange">  指定生效方式</font></TD>
	  					<TD width="34%" colspan="3">
					...
					<tr>
		                <td colspan=4 align="center">
		                   <input  type="button" name="query_smcode" onclick="queryModeCode()" value="查询" class="b_text" >						   
						   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		                   <input  type="button" name="do_reset" onclick="doReset()" value="重置" class="b_text" >
		                </td>
	                </tr>
	  			</table>
	  			  ...
	  			  <TR >
	  				<TD height="30" align="center" id="footer">
	  					<input name="selectall" type="button"  class="b_foot_long" value="全部选中" onClick="selectAll();">
	          	 	    ...
	          	 	    &nbsp;
	          	 	    <input name="conmit" type="button"  value="确认" onClick="submitAdd();" class="b_foot" >
	          	 	    &nbsp;
	          	 	    <input name="cancel" type="button"  value="取消"  class="b_foot" onClick="window.opener.document.form1.modeTransOtherButton.disabled=false;window.close();">
	  				</TD>
	  			  </TR>
	  	    	</TABLE>
