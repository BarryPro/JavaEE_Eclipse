...
<div id="Main">
   ...
   <DIV id="Operation_Table">                        
			...
			//	retArray=callView.callFXService("s5238_LimitQry",paramsIn,"6");	
				%>
									 
    <wtc:service name="s5238_LimitQry" outnum="6" retmsg="msg" retcode="code" routerKey="region" routerValue="<%=regionCode%>">
		...
		<wtc:array id="result_t" scope="end"  />
				...
				<%
				System.out.println("----------------code------------f5238_deployLimitFrame.jsp-----------"+code);
				...
				%>        
					<script language="javascript">
						rdShowMessageDialog("错误代码：<%=code%>,错误信息：<%=msg%>",0);
					</script>       
				<%            
				}
