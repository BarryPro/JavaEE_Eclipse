            ...
            <table width="535" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td valign="bottom" width="493">
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td background="/images/jl_background_4.gif"><font color="FFCC00"><strong>优惠条件设置-本月优惠为条件</strong></font></td>
	  		...
	  		<TD >
	            ...
	            <TBODY>
	  				...
	  				<tr bgcolor="#F5F5F5">
	  					<TD>&nbsp;&nbsp;条件属性:</TD>
	  					<TD>
	  						<input type="radio" name="cond_attr" value="0" checked>优惠后话费
	  						<input type="radio" name="cond_attr" value="1" >优惠前话费
	  					</TD>
	  				</tr>
					<tr bgcolor="#F5F5F5">
	  					<TD>&nbsp;&nbsp;关系表达式：</TD>
