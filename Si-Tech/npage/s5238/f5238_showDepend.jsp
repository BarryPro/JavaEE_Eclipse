...
<%@ include file="/npage/include/header_pop.jsp" %>                         
	...
	<div class="title">
		<div id="title_zi">产品依赖规则配置信息查看</div>
	</div>
      		    ...
      		    <th align="center">产品代码</Th>
	  					...
	  					<th align="center">产品代码</Th>
	  					<th align="center">产品名称</Th>
	  					<th align="center" width="10%">生效方式</Th>
      		  		</tr>
    ...
    String errMsg = "";
    %>  		  		
    <wtc:service name="s5238_DependShw" outnum="6" retmsg="msg" retcode="code" routerKey="region" routerValue="<%=regionCode%>">
