	...
	//获取所有的优惠信息
		...
		//		retArray=callView.callFXService("s5238_ModLimQry",paramsIn,"4");	
				%>
				    ...
				    <wtc:service name="s5238_ModLimQry" outnum="4" retmsg="msg" retcode="code" routerKey="region" routerValue="<%=regionCode%>">
		...
		<wtc:array id="result_t" scope="end"  />
				...
				<%
				System.out.println("----------------code------------f5238_modeLimitFrame.jsp-----------"+code);
