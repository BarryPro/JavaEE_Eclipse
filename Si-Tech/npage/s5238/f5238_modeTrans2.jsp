...
{
	document.form1.action="f5238_modeTransFrame2.jsp";
...
<div id="Main">
   ...
   <DIV id="Operation_Table">                         
	...
	<div class="title">
		<div id="title_zi">其他产品代码到该产品代码的转换关系配置</div>
	</div>
	  	...
	  	<input type="hidden" name="trans_type" value="<%=trans_type%>">
	  		  	<TABLE  id="mainOne"  cellspacing="0"  >
	  				<tr  height="23">
	  					<TD colspan="4"><font color="blue">请选择需要转换的产品代码！</font></td>
	  				</tr>
	  				<tr  height="22">
	  					<TD width="16%" class="blue">业务品牌</TD>
	  					<TD width="34%">
	  						<input type=text  v_type="string"  v_must=0 v_minlength=1 v_maxlength=2 v_name="业务品牌"  name=sm_code_new maxlength=2 size="8" readonly ></input>
					...
					<tr  height="22">
	  					<TD width="16%"  class="blue"><font color="blue">指定生效方式</font></TD>
	  					<TD width="34%" colspan="3">
	  						<select name="defSendFlag"  >
	  						<option value=""> ---请选择--- </option>
	  						<option value="0">0-> 24小时之内生效</option>
	  						<option value="1">1->预约生效</option>
	  						<option value="2">2->个性化预约</option>
							  </select>
	  					</TD>
	  				</tr>
					<tr>
      		    ...
      		    <Th width="10%" >选择</Th>
	  				...
	  				<tr  height="22">
	  					<td colspan="5">
	  						<IFRAME src="f5238_modeTransFrame2.jsp?login_accept=<%=login_accept%>&mode_code=<%=mode_code%>&mode_name=<%=mode_name%>&region_code=<%=region_code%>&trans_type=<%=trans_type%>" frameBorder=0 id=middle name=middle scrolling="yes" style="HEIGHT: 300; VISIBILITY: inherit; WIDTH: 100%; Z-INDEX: 1">
      		  	  			</IFRAME>
      		  	  		</td>
	  				</tr>
	          	</TABLE>
	  			  ...
	  			  <TR >
	  				<TD height="30" align="center" id="footer">
	  					<input name="selectall" type="button" class="b_foot_long" value="全部选中" onClick="selectAll();">
	          	 	    ...
	          	 	    &nbsp;
	          	 	    <input name="conmit" type="button"  value="确认" class="b_foot"  onClick="submitAdd();">
	          	 	    &nbsp;
	          	 	    <input name="cancel" type="button"  value="取消"  class="b_foot" onClick="window.opener.document.form1.otherTransModeButton.disabled=false;window.close();">
	  				</TD>
	  			  </TR>
	  	    	</TABLE>
