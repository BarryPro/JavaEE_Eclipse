...
function commit()
{
	...
	{
		rdShowMessageDialog("没有需要转换的产品代码！");
      		...
      		<table  cellspacing="0">
				...
				%>
						<tr   height="20">
							...
							<TD width="137"><input type="text" name="old_mode" size="10" class="InputGrey" readonly value="<%=result_t[i][1]%>"></TD>
							<TD width="418"><input type="text" name="old_name" size="30" class="InputGrey" readonly value="<%=result_t[i][2]%>"></TD>
							<TD width="53"><input type="text" name="mode_flag" size="6" class="InputGrey" readonly value="<%=result_t[i][3]%>"></TD>
							<TD width="53"><input type="text" name="power_right" size="6" class="InputGrey" readonly value="<%=result_t[i][4]%>"></TD>
						</tr>
				<%
						}
					}
