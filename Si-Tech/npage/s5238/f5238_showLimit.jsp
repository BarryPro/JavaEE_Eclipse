...
<body  onMouseDown="hideEvent()" onKeyDown="hideEvent()">
	...
	<div class="title">
		<div id="title_zi">产品互斥规则配置信息查看</div>
	</div>
    ...
    String errMsg = "";
    %>  
	    <wtc:service name="s5238_LimitShw" outnum="6" retmsg="msg" retcode="code" routerKey="region" routerValue="<%=regionCode%>">
