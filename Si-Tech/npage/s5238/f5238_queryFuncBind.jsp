...
<%
	...
	sqlStr1 ="select a.function_bind, trim(b.function_name)||'-'||decode(a.off_on,'0','关','1','开') "
		+ "from sBillFuncBind a, sFuncList b "
		+ "where a.region_code = '" + region_code	+ "' and a.region_code = b.region_code "
		+ "and a.sm_code = b.sm_code and a.function_code = b.function_code and a.sm_code='"+sm_code+"'"
		+ "order by a.function_bind";
...
<table width="99%" id="tab1" border="0" align="center" cellpadding="1" cellspacing="1">
	<tr bgColor="#eeeeee">
		<td height="26" align="center" width="10%" nowrap>
			选择
		</td>
