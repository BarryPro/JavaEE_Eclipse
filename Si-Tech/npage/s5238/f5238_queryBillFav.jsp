...
<table width="99%" align="center" id="mainThree" bgcolor="#FFFFFF" cellspacing="1" border="0">
	<tr bgcolor="#F5F5F5" height="22">	    
		<TD width="16%">代码：</TD>
	  	<TD width="34%">
		  <input type=text  v_type="string"  v_must=0 v_minlength=0 v_maxlength=10 v_name="代码"  name=favourCodeCond maxlength=10 value="">
		  </input>
		</TD>
		<TD width="16%">名称：</TD>
	  	<TD width="34%">
		    <input type=text  v_type="string"  v_must=0 v_minlength=0 v_maxlength=25 v_name="名称"  name=favourNameCond maxlength=25 value="">
		  </input>
		</TD>
	</tr>
	<tr>
