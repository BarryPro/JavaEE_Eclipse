...
<table width="767" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr>
    <td background="../../images/jl_background_1.gif">
            ...
            <table width="535" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td valign="bottom" width="493">
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td background="/images/jl_background_4.gif"><font color="FFCC00"><strong>优惠条件设置-用户属性为条件</strong></font></td>
	  ...
	  <input type="hidden" name=condition_step value="0" ></input>
	  	<TR >
	  		<TD >
	            ...
	            <TBODY>
	  				...
	  				<tr bgcolor="#F5F5F5">
	  					...
	  					<TD >
	  						<select name="favour_condition" v_name="属性类型">
    		        			<option value="01">01-->sm_code的值</option>
    		        			<option value="04">04-->run_code的值</option>
    		        			<option value="06">06-->attr_code3、4的值</option>
	  						</select>
	  					</TD>
	  				</tr>
	  				<tr bgcolor="#F5F5F5">
	  					<TD height="25">&nbsp;&nbsp;属性值：</TD>
	  					<TD >
	  						<input type=text  v_type="string" v_must=1 v_minlength=1 v_maxlength=30 v_name="属性值" name=cond_attr maxlength=30 size="30" readonly></input>
	  						<input class="button" type="button" name="query_condAttr" onclick="queryCondAttr()" value="选择">
	  					</TD>
	  				</tr>
					<tr bgcolor="#F5F5F5">
	  					<TD>&nbsp;&nbsp;关系表达式：</TD>
