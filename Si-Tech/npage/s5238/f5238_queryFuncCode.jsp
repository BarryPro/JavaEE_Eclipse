...
<%
	...
	String sqlStr1="";
	sqlStr1 ="SELECT function_code,function_name FROM sfunclist where region_code = '"+region_code+"' and sm_code = '"+sm_code+"' order by function_code";
