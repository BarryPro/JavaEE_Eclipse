...
<%  //绘制界面表头  
     ...
     {  
        ...
        if(valueStr.equals("包年周期") || valueStr.equals("付费方式")){
        	if("m215".equals(op_code)){
        		titleStr = "<th nowrap style='display:none'>&nbsp;&nbsp;" + valueStr + "</th>";
        	}else{
        		titleStr = "<th nowrap  >&nbsp;&nbsp;" + valueStr + "</th>";
        	}
        }
        else if(valueStr.equals("有无小区")){
        	titleStr = "<th nowrap style='display:none'>&nbsp;&nbsp;" + valueStr + "</th>";
        }
        else{
	        titleStr = "<th nowrap  >&nbsp;&nbsp;" + valueStr + "</th>";
    ...
    String styleType = "";
   	for(int iii=0;iii<result.length;iii++){
				for(int jjj=0;jjj<result[iii].length;jjj++){
					System.out.println("-gaopengSeeLogm215--------------------result["+iii+"]["+jjj+"]=-----------------"+result[iii][jjj]);
            ...
            recordNum = result.length;
      		...
      		for(int i=0;i<recordNum;i++)
      		{
      		    ...
      		    for(int j=0;j<Integer.parseInt(fieldNum);j++)
      		    {
                    ...
                    if(j==Integer.parseInt(fieldNum)-1) {  
                    	styleType = "none";  
                    }else {
                    	styleType= "";
                    }
                    if((j==3 || j==4) && "m215".equals(op_code)){
                    	styleType = "none";
                    }
