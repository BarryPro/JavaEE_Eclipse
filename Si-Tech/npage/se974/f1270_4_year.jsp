<%
     ...
     *
     2015/01/08 10:28:51 gaopeng e975确认服务页面
     ********************/
%>
...
<%
    ...
    } else if (theop_code.equals("e975")||theop_code.equals("m216")) {
    ...
    if (theop_code.equals("1255") || theop_code.equals("e974") || theop_code.equals("1201")) {           				
...
<%   
    ...
    } else if (theop_code.equals("1257") || theop_code.equals("1258") || theop_code.equals("e975")||theop_code.equals("m216")) {
        ...
        String serviceName = "";
        serviceName = theop_code.equals("m216")?"sKHReNewOffBack":"s1257CfmPM";
        System.out.println("gaopengSeeLoge975======serviceName==="+serviceName);
        
        for(int i=0; i<paraAray.length; i++){
        
        	System.out.println("gaopengSeeLoge975 - -- - - paraAray["+ i +"]   ---"+paraAray[i]);
 ...
 %>
			<wtc:service name="<%=serviceName%>" routerKey="phone" routerValue="<%=themob%>" retcode="retCode1" retmsg="retMsg1" outnum="2" >
			<wtc:param value="<%=paraAray[0]%>"/>
			<wtc:param value="<%=paraAray[1]%>"/>
			<wtc:param value="<%=paraAray[2]%>"/>
			<wtc:param value="<%=paraAray[3]%>"/>
