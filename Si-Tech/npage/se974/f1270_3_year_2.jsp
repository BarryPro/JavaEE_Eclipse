...
*add by qiansheng e975需要使用老版本的f1270_3_yeah.jsp
2015/01/08 10:28:51 gaopeng e975跳转页面
 ********************/
%>
...
<%
    ...
    if (iop_code.equals("e974")) {
        ...
        titleStr = "宽带包年续签冲正";
    }else if (iop_code.equals("m216")) {
        titleStr = "铁通宽带主资费预约取消";
    }
...
<%
    ...
    if (iop_code.equals("e975") || iop_code.equals("m216")) {
        back_bz = "N";
    } else {
        back_bz = "Y";
    }
...
{  //显示打印对话框 
	...
	var fav_code=null;
	var area_code=null;
	if("<%=iop_code%>"!="e975" || "<%=iop_code%>"!="m216"){
		if(rate_code=="$"){
			area_code=null;
		}else{
...
<%}else if(iop_code.equals("e975") || iop_code.equals("m216")){%>
    retInfo = printInfoE975();
<%}%>
    return retInfo;
}
...
<%}%>
    ...
    if(pubSmCode == "kf" || pubSmCode == "kg" || pubSmCode == "kh"){
			...
			note_info4 += "备注："+"|";
			note_info4 += "1、当联系电话变动时，请及时与移动公司联系，以便于有新活动或服务到期时及时收到通知。"+"|";
			note_info4 += "2、如需帮助，请拨打服务热线：10086。"+"|";
		}
...
function senddata()
{
   ...
   // alert(modestr.length);
    ...
    {
        /********liucm可选资费取消提示*******************/
    <% if(iop_code.equals("1257")||iop_code.equals("1258")||iop_code.equals("e975")||iop_code.equals("m216")) {%>
