...
/*
	...
	String sql = "select to_char(login_accept),decode(op_code,'g573','物联网缴费','e006','铁通宽带缴费','e034','宽带银行托收') as opName,to_char(sum(pay_money),'9999999990.00') as sumPayMoney,to_char(op_time,'YYYY-MM-DD HH24:MI:SS') as opTime from wPay? where contract_no=? and back_flag ='0' and op_code in('g573') group by login_accept,op_code,op_time order by op_time desc";
