...
<%
    ...
    String phoneNo = request.getParameter("phoneNo"); //10648转义之前的
	...
	{
		 // xl add for 宽带号码
	String sql_kd = "select new_phoneno from dbbillprg.s_rs_iot_phonenoswitch_info where old_phoneno= '?' ";
	String phone_kd = "";
	...
	{
		%>
		<wtc:pubselect name="TlsPubSelBoss"   retcode="retCode12" retmsg="retMsg12" outnum="1">
	...
	if(((phoneNo == null) || ("".equals(phoneNo))) && phone_kd_new!=null && !"".equals(phone_kd_new) )
	{
		...
		String sql_phone = "select new_phoneno from dbbillprg.s_rs_iot_phonenoswitch_info where old_phoneno = '?' ";
		%>
			<wtc:pubselect name="TlsPubSelCrm"   retcode="retCode22" retmsg="retMsg22" outnum="1">
