...
<%
	...
	String phoneNo = "";
	//xl add 判断 10648开头的就转义 否则不转义
	System.out.println("aaaaaaaaaaaaaaaaaaaaaaaaaaa kd_phoneNo is "+kd_phoneNo);
	if(kd_phoneNo.substring(0,4)=="1064" ||kd_phoneNo.substring(0,4).equals("1064"))
	//if((kd_phoneNo.substring(0,5)=="10648" ||kd_phoneNo.substring(0,5).equals("10648")) ||(kd_phoneNo.substring(0,3)=="147" ||kd_phoneNo.substring(0,3).equals("147")))
	{
		
		String[] inParas = new String[2];
		inParas[0]="select new_phoneno from dbbillprg.s_rs_iot_phonenoswitch_info where old_phoneno = :phone_no";
	...
	<%
		...
		{
			phoneNo = result2[0][0];
			System.out.println("cccccccccccccccccccccccc 10648的 phoneNo is "+phoneNo);
		}
	}
	else
	{
		phoneNo=kd_phoneNo;
		System.out.println("非10648的fffffffffffffffffffffff phoneNo is "+phoneNo);
	}
