...
function doQry()
{
	...
	var myPacket = new AJAXPacket("../zg62/getKdNo_new.jsp","正在查询客户，请稍候......");
		...
		myPacket.data.add("return_page","zg66_1.jsp");
 ...
 function doProcess(packet)
 {
	...
	//alert("sm_code is "+sm_code+" s_accept is "+s_accept);
    ...
    {
		rdShowMessageDialog("非单品需在e031进行宽带补收!");
		return false;
	}
	else
	{
...
return false;
	...
	var str=window.showModalDialog('../e005/getCount_e031.jsp?phoneNo='+document.getElementById("pno").value,"",prop);
	//alert("!! "+str);
	...
	if( typeof(str) != "undefined" ){
		if (parseInt(str)==0) {
			...
			document.form.action="zg66_select.jsp";
			form.submit();
			return true; }
	}
}
