...
%>
<wtc:service name="sQryKdState" routerKey="regionCode" routerValue="<%=regionCode%>" retcode="errCode" retmsg="errMsg"  outnum="12">
...
<body>
	...
	<table cellspacing="0" name="t1" id="t1">
		...
		<tr id="row_<%=i%>">
			...
			<td class="<%=tbclass%>" style="color:<%=styleCol%>"><%=result1[i][9]%></td>
			<td class="<%=tbclass%>" style="color:<%=styleCol%>"><%=result1[i][10]%></td>
			<td class="<%=tbclass%>" style="color:<%=styleCol%>"><%=result1[i][11]%></td>
		<!--	<%
