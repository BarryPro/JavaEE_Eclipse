...
<%
	...
	String cfm_lg = request.getParameter("cfm_lg");

	String colNum = "4";
	String sqlStr = "select to_char(a.contract_no),a.bank_cust,to_char(b.open_time,'yyyy-mm-dd hh24:mi:ss'),b.user_passwd,to_char(b.phone_no) from dConMsgDead a,dCustMsgDead b,dbroadbandmsghis c where a.contract_no=b.contract_no and b.phone_no=c.phone_no and c.cfm_login='"+cfm_lg+"' ";
	sqlStr += " order by b.open_time desc";
	System.out.println("EEEEEEEEEEEEEEEEEEEEEEEEE test for "+sqlStr+" and phoneNo_new is  "+phoneNo);
...
%>
	<wtc:pubselect name="TlsPubSelBoss"  routerKey="region" routerValue="<%=regionCode%>" outnum="5">
   		<wtc:sql><%=sqlStr%></wtc:sql>
    <wtc:param value="<%=cfm_lg%>"/>
    </wtc:pubselect>
...
//	int retval=Integer.parseInt((String)arlist.get(0));
	...
	System.out.println("AAAAAAAAAAAAAAAAAAretval==========="+retval);
