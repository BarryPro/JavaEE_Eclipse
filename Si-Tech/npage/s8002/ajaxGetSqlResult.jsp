...
<%
		...
		String sqlV1   = ((String)request.getParameter("sqlV1")).replaceAll("#@#@#","+");  
		String regionCode = (String)session.getAttribute("regCode");
		
		
		System.out.println("mylog \n\n\n\n\n\n\n\n");
		System.out.println("mylog             "+sqlV1);
		System.out.println("mylog \n\n\n\n\n\n\n\n");
%>		
 	<wtc:pubselect name="sPubSelect" outnum="50" retmsg="msg" retcode="code" routerKey="region" routerValue="<%=regionCode%>">
