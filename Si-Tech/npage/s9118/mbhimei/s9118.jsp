          ...
          if( parseInt(error_code,10) == 0 ){
					...
					if(backArrMsg.length>0){
						...
						if(document.all.optype.value=="08" && inputName=="value302"){
							...
							rdShowMessageDialog("错误信息:IMEI不在库无法销售",0);
							 return false;
						}
       ...
       // }
        ...
        if(form.optype.value=="08") {
            if(form.value312.value==""){
            	...
            	rdShowMessageDialog("新机顶盒IMEI不正确请重新填写");
                document.form.value312.focus();
                return false;
            }
        }
...
//发票打印方法
function print(){
	if(document.all.optype.value!="06"){
...
<table cellSpacing="0">
	...
	<tbody id="cibp">
		<tr id="cibp01">
			...
			<td><input type="text" name="value311" value="" size="40" maxlength="32" onblur="checkImei(this.value,'value302')"> 
				<input type="hidden" class="button"  name="code311" value="311">
				
				<input id="value302" type="text" name="value302" value="" size="40" maxlength="32"> 
				<input type="hidden" class="button"  name="code302" value="302">
			</td>
			<td class=blue>
			<div>新机顶盒IMEI</div>
			</td>
			<td><input type="text" name="value312" value="" size="40" maxlength="32" onblur="checkImei(this.value,'value306')"> 
					<input type="hidden" class="button"  name="code312" value="312">
					
					
					
					<input id="value306" type="hidden" name="value306" value="" size="40" maxlength="32"> 
