...
String webGroupType = request.getParameter("webGroupType")==null?"":request.getParameter("webGroupType");
...
*/
	...
	paraArr[0] = loginNo;
	paraArr[1] = nopass;
  if("b890".equals(opCode)&&"19".equals(webGroupType)){//当为在线支付网上开户时
	  paraArr[2] = "b890";
  }else{
    paraArr[2] = "8021";
  }
...
<%
	...
	else
	{
		...
		for (int i = 0; i < len; i++)
		{
			...
			if(flag.equals("N"))
			{
				String url = "groupTreeXml.jsp?groupId="+groupId2.trim()+"&groupName="+groupName2.trim()+"&isDel="+isDel+"&roleCode="+roleCode+"&opCode="+opCode+"&webGroupType="+webGroupType;
