...
<%
	...
	String dataJsp = "groupTreeXml_workNo.jsp?isRoot=true&webGroupTypeQry1="+webGroupTypeQry1;
	System.out.println(webGroupTypeQry1+"????????????????????????????????????????111111");
	...
	String groupId = request.getParameter("grpId")==null?"groupId":request.getParameter("grpId");
	String groupName = request.getParameter("grpName")==null?"groupName":request.getParameter("grpName");
	
	System.out.println("groupTree_workNo.jsp");
%>
