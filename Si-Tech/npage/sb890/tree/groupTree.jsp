...
<%
	...
	String webGroupType = request.getParameter("webGroupType")==null?"":request.getParameter("webGroupType");//营业厅办理业务类型
	...
	String dataJsp = "groupTreeXml.jsp?isRoot=true&opCode="+opCode+"&webGroupType="+webGroupType;
