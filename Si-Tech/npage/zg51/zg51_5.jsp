...
String total_no = "";
	int flag = 0;
%>
	<wtc:service name="zg51_import" routerKey="regionCode" routerValue="<%=regionCode%>"  retcode="sReturnCode" retmsg="sErrorMessage"  outnum="21" >
...
%>
<HEAD><TITLE>黑龙江BOSS-测试卡限额设定文件导入</TITLE>
...
function gohome()
{
	document.location.replace("zg51_1.jsp");
}
...
<BODY>
<FORM action="zg51_1.jsp" method=post name=form>
   ...
   <%@ include file="/npage/include/header.jsp" %>
		...
		<table cellspacing="0">
		   <tbody> 
		    <tr > 
		      <td colspan="2">
		        <div align="center"测试卡限额设定文件导入配置完成。
