...
<%
	...
	int		flag = 0;
	%>
	<wtc:service name="sbatchDel1"  retcode="errCode" retmsg="errMsg"  outnum="2" >
...
%>
			<wtc:service name="sbatchWrite1"  retcode="errCode2" retmsg="errMsg2"  outnum="2" >
...
<%
	...
	paraAray2[1] = phoneText;
%>
	<wtc:service name="sbatchWrite1"   outnum="2" >
	<wtc:param value="<%=paraAray2[0]%>"/>
	<wtc:param value="<%=paraAray2[1]%>"/>
	</wtc:service>
...
<html>
<body onload="ifprint()">
<form action="zg51_5.jsp" name="frm_print_invoice" method="post">
