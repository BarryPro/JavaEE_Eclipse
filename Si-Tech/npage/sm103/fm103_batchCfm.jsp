...
%>
				<SCRIPT language=javascript>
						...
						window.location.href = "fm103_main.jsp?opCode=<%=opCode%>&opName=<%=opName%>";
				</script>
<%
        return;
		}
...
%>
		<wtc:service name="sM103CfmAdd" routerKey="region" routerValue="<%=regionCode%>" retcode="Code" retmsg="Msg" outnum="6" >
