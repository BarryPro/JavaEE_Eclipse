...
<head>
	...
	function getLocalCfg()
	{
	    ...
	    var chkPacket = new AJAXPacket("<%=request.getContextPath()%>/npage/callbosspage/K006/K006.jsp","正在获取本机配置信息,请稍后...");
	    chkPacket.data.add("retType", "sK006insert");
	    ...
	    core.ajax.sendPacket(chkPacket,doProcessK006,true);
		chkPacket =null;
