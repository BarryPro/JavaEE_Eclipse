...
//导出Excel
    public void toExcel(String[][] queryList,String[] strHead,HttpServletResponse response){
        ...
        String headname = "外呼记录查询";//Excel文件名
        try {
...
<%
    String opCode="k223";
    String opName="呼叫查询-外呼记录查询";
	  String loginNo = (String)session.getAttribute("workNo");  
	  String orgCode = (String)session.getAttribute("orgCode"); 

  	String sqlStr = "select SERIAL_NO,CONTACT_ID id,to_char(oper_date,'yyyy-MM-dd hh24:mi:ss'),contact_id,login_no,pre_call_cause_id,pre_call_cause_des,last_call_cause_id,last_call_cause_des  from DLOGCALLCAUSEHIS";
    ...
    String[] strHead= {"外呼流水号","业务流水号","话务员工号","客户姓名","客户电话","开始时间","结束时间","呼出时长（秒）","成功通话号码"};
...
function submitMe(){
   ...
   window.sitechform.action="k223_callRecQry.jsp";
...
function expExcel(expFlag){
	  document.sitechform.action="<%=request.getContextPath()%>/npage/callbosspage/k220/k223_callRecQry.jsp?exp="+expFlag;
...
<%@ include file="/npage/include/header.jsp"%>
    ...
    <!-- THE FIRST LINE OF THE CONTENT -->
      ...
      <td >
		  ...
		  <td > 外呼业务类型 </td>
      <td >
      	<select id="login_no" name="1_=_login_no" size="1" onchange="skill.value=this.options[this.selectedIndex].text">
  ...
  <div id="Operation_Table">
    ...
    <tr >
      ...
      <table  cellSpacing="0" >
          ...
          <tr >
            <th align="center" class="blue" width="10%" > 外呼流水号 </th>
            <th align="center" class="blue" width="10%" > 业务流水号 </th>
            <th align="center" class="blue" width="30%" > 话务员工号 </th>
            <th align="center" class="blue" width="30%"  > 客户姓名 </th>
            <th align="center" class="blue" width="10%" > 客户电话 </th>
            <th align="center" class="blue" width="10%"  > 开始时间 </th>
            <th align="center" class="blue" width="30%"  > 结束时间 </th>
            <th align="center" class="blue" width="30%" > 呼出时长（秒） </th>
            <th align="center" class="blue" width="30%" > 成功通话号码 </th>
          </tr>
