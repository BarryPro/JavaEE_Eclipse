...
//导出Excel
    public void toExcel(String[][] queryList,String[] strHead,HttpServletResponse response){
        ...
        String headname = "工作量查询";//Excel文件名
        try {
...
<%
    ...
    String[] strHead= {"话务员工号","呼出数（次）","总时长（秒）","呼出成功次数","服务成功次数","呼出成功率","服务成功率"};
...
function showCallTypeTree(strflag){
   openWinMid("k174_callCauseSelectTree.jsp?flag="+strflag,'外呼类型',600, 400);
}
