...
<head>
	...
	function getLocalCfg()
	{
	    ...
	    var chkPacket = new AJAXPacket("<%=request.getContextPath()%>/npage/callbosspage/K005/sign_log.jsp","正在获取本机配置信息,请稍后...");
	    chkPacket.data.add("retType", "chkExample");
	    chkPacket.data.add("login_no", "102");
	    chkPacket.data.add("ipaddress", "10.204.16.104");
	    chkPacket.data.add("grade_code", "5");
