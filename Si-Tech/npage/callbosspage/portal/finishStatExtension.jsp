...
<script type="text/javascript">
	usedTime.innerHTML = window.opener.g_usedSecs;
 ...
 function sub1ExtendTime()
 {
   ...
   var usedTime=eval(document.getElementById("usedTime").innerHTML);
   ...
   if(tempAllTime>120){
	   ...
	   //计算新的延长时间并返回
	   var newTime =parseInt(tTime)-parseInt(usedTime)+parseInt(extendTime);
 ...
 function refreshUsedTime(){
 	if(window.opener.g_usedSecs==0){
 		...
 		document.getElementById('usedTime').innerHTML = window.opener.g_usedSecs; 	
	}
 }
