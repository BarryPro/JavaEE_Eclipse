...
if(flag.equals("0")){
	...
	sqlStr += " and a.citycode = '"+cityCode+"' ";
	sqlStr += " and a.servicename like '%"+searchName+"%' ";
	sqlStr += " and not exists( select 1 from DZXSCETRANSFERTAB b where b.superid = a.id ) order by a.id" ;
	searchStr.append("<div>");
	searchStr.append("<span style='font: bold ;' style='cursor:hand'>");
...
for (int i = 0; i < queryList.length; i++) {
  if(queryList[i][2].equals("2001")||queryList[i][2].equals("2003")){
	...
	searchStr.append("<img style='cursor:hand' src='/npage/callbosspage/k170/tree/images/T.gif'>");
	searchStr.append("<img style='cursor:hand' src='/npage/callbosspage/k170/tree/images/icon-page.gif'>");
