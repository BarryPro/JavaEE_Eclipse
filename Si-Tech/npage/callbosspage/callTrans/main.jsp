...
<div class="content_02">
	<div id="tabtit">
		<ul>
			...
			<li id="tb_3" class="normaltab" onclick="HoverLi(3);">转自动业务</li>
		</ul>
	</div>
	<div class="dis" id="tbc_01">
    <%@ include file="transToQueueMain.jsp" %>
	</div>
	<div class="undis" id="tbc_02">
	<%@ include file="transToAgentMain.jsp" %>
	</div>
	<div class="undis" id="tbc_03">
	<%@ include file="transToIVRMain.jsp" %>
	</div>
</div>
</body>
</html>
