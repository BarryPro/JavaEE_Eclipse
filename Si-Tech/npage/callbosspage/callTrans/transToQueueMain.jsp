...
<!--
function transToQueue(){
	window.opener.cCcommonTool.TransToQueue(0, 3, 105);
}
//-->
</script>
...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" id=tb0>
      ...
      <tr><td>
        	<iframe id="frameright" name="frameright" scrolling=auto src="transToQueueList.jsp" width=100%height=100% frameBorder=0 marginheight=0 marginwidth=0></iframe>
      </td></tr>
      </table>
      ...
      <table width="100%"  border="0" cellpadding="0" cellspacing="0">
        <tr> 
          ...
          <td align="right"> 
            ...
            <input class="b_foot" name="button" type="button" value="呼叫" onclick="transToQueue()">
