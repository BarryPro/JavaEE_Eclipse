...
<%
 ...
 System.out.println("pppppppppppppppppppppppppp: "+querySql);
...
<%
   this.toExcel(queryList, strHead, response); 
  System.out.println("pppppppppppppppsdfdsfhsdjhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhppppppppppp");
%>
