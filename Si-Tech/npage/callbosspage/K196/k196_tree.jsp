...
function initBaseTree(){	
	tree=new dhtmlXTreeObject("baseTree","100%","100%",-1);    
     ...
     tree.loadXML(<%=request.getContextPath()%>"/npage/callbosspage/K196/k196_createXml.jsp");
     // 初始展开第一层
...
function getTreeListByNodeId(){
	...
	var packet = new AJAXPacket(<%=request.getContextPath()%>"/npage/callbosspage/K196/k196_getChildNodeList.jsp","aa");
...
function showNewNodeWin(){
	...
	window.showModalDialog("k196_newNodeWin.jsp?time="+time,window, winParam);
}
//做修改操作的函数
function showModifyNodeWin(){
	...
	window.showModalDialog("k196_modifyNodeWin.jsp?time="+time,window, winParam);
}
...
function deleteNode(login_group_id,par_id,nodeName){
	var packet = new AJAXPacket(<%=request.getContextPath()%>"/npage/callbosspage/K196/k196_deleteNode.jsp","\u6b63\u5728\u5904\u7406,\u8bf7\u7a0d\u540e...");
