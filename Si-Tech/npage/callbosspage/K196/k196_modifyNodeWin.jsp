...
function getJsCode(){
	var pdoc = window.dialogArguments;
	var selectItemId =pdoc.tree.getSelectedItemId();	
	var packet=new AJAXPacket(<%=request.getContextPath()%>"/npage/callbosspage/K196/k196_getNodeJsCode.jsp","\u6b63\u5728\u5904\u7406,\u8bf7\u7a0d\u540e...");	
...
function modifyNode(){
	...
	var packet = new AJAXPacket(<%=request.getContextPath()%>"/npage/callbosspage/K196/k196_modifyNewNode.jsp","\u6b63\u5728\u5904\u7406,\u8bf7\u7a0d\u540e...");
