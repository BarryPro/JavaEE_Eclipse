...
<input name="area[]" type="checkbox" id="area[]" seq="0" sql="accesscode" value="接入码" onclick="judgeCheckAll('area[]')"/>接入码<br>
<input name="area[]" type="checkbox" id="area[]" seq="1" sql="citycode" value="地市代码" onclick="judgeCheckAll('area[]')"/>地市代码<br>
<input name="area[]" type="checkbox" id="area[]" seq="2" sql="digitcode" value="按键路由" onclick="judgeCheckAll('area[]')"/>按键路由<br>
<input name="area[]" type="checkbox" id="area[]" seq="3" sql="transfercode" value="后续码" onclick="judgeCheckAll('area[]')"/>后续码<br>
<input name="area[]" type="checkbox" id="area[]" seq="4" sql="messegecontent" value="短信内容" onclick="judgeCheckAll('area[]')"/>短信内容<br>
<input name="area[]" type="checkbox" id="area[]" seq="5" sql="typeid" value="特定流程标志" onclick="judgeCheckAll('area[]')"/>特定流程标志<br>
<input name="area[]" type="checkbox" id="area[]" seq="6" sql="servicename" value="流程的中文名称" onclick="judgeCheckAll('area[]')"/>流程的中文名称<br>
<input name="area[]" type="checkbox" id="area[]" seq="7" sql="visiable" value="是否显示" onclick="judgeCheckAll('area[]')"/>是否显示<br>
