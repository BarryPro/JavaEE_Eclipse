...
<%  
 ...
 String regionCode = org_code.substring(0,2);
	...
	String querySql = "select msg_mod_content from DMESSAGEMODELCONTENT_CON where msg_mod_content_id =:msg_mod_content_id ";
	myParams = "msg_mod_content_id="+msg_mod_content_id ;
...
<script language=javascript>
	function doedit(){
		var mypacket = new AJAXPacket(<%=request.getContextPath()%>"/npage/callbosspage/K083/editContent_rpc.jsp","正在发送短信，请稍候......");
