...
<body onload=''>
	...
	<div id="Operation_Table">
		...
		<font color=''>&nbsp;&nbsp;多个号码请用","隔开!如(1343430011,13400222333)</font>&nbsp;
		<input name="clearnum" type="button"  id="clearnum" value="清除号码" onClick="document.getElementById('user_phone').value='';">  
		</div></div>
		<table cellspacing="0">
		</table>   
    ...
    <table id="particularinfo" width="100%" border="0" cellpadding="0" cellspacing="0" >
    	<tr><td width='35%' height="100%">
			共<input name=charsmonitor style="border:none;" tabindex=100 value=0 e=5 size="2" readonly>字符  分
			<input name=sendnum style="border:none;" tabindex=100 value=0 e=5 size="2" readonly>次发送<br />
			<textarea name="msg_content" id="msg_content"  style="width:100%;word-break:break-all"  
			rows="20" title='最大允许250个汉字或500个字符' onpaste="return onCharsChange(this);" 
			onkeyup="return onCharsChange(this);"></textArea>
							    </td>
      </tr>
		</table>
