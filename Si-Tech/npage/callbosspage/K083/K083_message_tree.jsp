...
function insertChildNodeList(retData){
    ...
    //过滤当前节点下子节点与数据库是否相同
       if(!isStr(retData[i][0],str)){
        ...
        tree.setUserData_preconcertContent_1(retData[i][0],"isleaf",retData[i][3]);
        tree.setUserData_preconcertContent_1(retData[i][0],"isscored",retData[i][4]);
        tree.setUserData_preconcertContent_1(retData[i][0],"object_id",retData[i][5]);
       }
       //设置节点显示的图片
       if(retData[i][3]=='N'){
