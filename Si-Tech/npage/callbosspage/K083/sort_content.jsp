...
<%
	...
	//查询条件
	String sqlTemp = "select to_char(count(*)) count  from DMESSAGEMODELCONTENT_CON t where msg_mod_id = :msg_mod_id";
	String params = "msg_mod_id="+msg_mod_id;
...
<%
	...
	String dsql = "select CREATE_LOGIN_NO, MSG_MOD_CONTENT, msg_mod_content_id from DMESSAGEMODELCONTENT_CON where msg_mod_id = :msg_mod_id";
	String params2 = "msg_mod_id="+msg_mod_id;
	...
	<div id="Operation_Table">
		<table cellspacing="0">
			...
			<table cellSpacing="0" width="100%">
				<tr>
					<th align="center">
						<input type="checkbox" name="chkall" value="" onClick="checkAll();" /><font id="words">全选</font>
					</th>
					<th align="center">
						序号
					</th>
        ...
        <wtc:param value="<%=params2%>"/>
				...
				<tr>
					...
					<td align="center" class="<%=tdClass%>">
						<input type="checkbox" name="chk" value="<%=dataRows[i][3] %>">
					</td>
					<td align="center" class="<%=tdClass%>">
			...
			<table cellspacing="0">
				<tr>
					<td class="blue" align="left" width="720">
						<input type="button" class="b_foot" value="新增" onClick="addYjsp();" >&nbsp;<input type="button" class="b_foot" value="删除" onClick="dodel();" >&nbsp;<input type="button" class="b_foot" value="修改" onClick="doedit();" >
					</td>
				</tr>
			</table>
	</div>
...
function dodel(){	
	...
	if(chks != undefined){
		if(chks.length == undefined){
			if(chks.checked){
				var mypacket = new AJAXPacket(<%=request.getContextPath()%>"/npage/callbosspage/K083/delContent_rpc.jsp","正在处理，请稍候......");
