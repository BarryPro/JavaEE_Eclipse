...
<%
  ...
  String sqlb = "update DMESSAGEMODEL set msg_leaf_flag = 'N' where msg_mod_id = :v1 and is_del= 'N' &&"+parent_item_id;
  
  String sqlc = "select count(msg_mod_id) from DMESSAGEMODEL where trim(msg_mod_par_id) =:v1  and is_del='N'";             
