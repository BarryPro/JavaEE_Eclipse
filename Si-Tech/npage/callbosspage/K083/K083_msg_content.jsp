	...
	<div id="Operation_Table">
        ...
        <wtc:param value="<%=params2%>"/>
				...
				<%
							...
							tdClass = "grey";
				%>
				<tr onClick="parent.parent.document.getElementById('msg_content').value='<%=dataRows[i][2] %>';parent.parent.onCharsChange(parent.parent.document.getElementsByName('msg_content')[0]);" style="cursor:pointer">
					<%
					} else {
					%>
...
function doLoad(operateCode){
   ...
   window.sitechform.action="K083_msg_content.jsp?msg_mod_id=<%=msg_mod_id %>";
