...
<%
    ...
    String tableNamea = "";
    String tableNameb = "";
    String bizFilter = " and a.chn_code='WS' ";
...
System.out.println("\n\n=====rowCount==========="+rowCount);
        ...
        sqlStr = "select to_char(a.begin_time,'yy-MM-dd hh24:mi:ss'),a.login_no,a.phone_no,b.op_name from "+tableNamea+" a,"+tableNameb+" b  "+sqlFilter+" and a.contact_id=b.contact_id(+)"+bizFilter+strOrderSql;     
...
function doSubmit(){
    ...
    window.sitechform.action="k195_olService.jsp";
...
for(var i=0;i<e.length;i++){
  ...
  window.location="k195_olService.jsp";
}
