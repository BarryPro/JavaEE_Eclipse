...
<input name="area[]" type="checkbox" id="area[]" seq="0" sql="decode(contact_id,null,'',contact_id)" value="接触流水号" onclick="judgeCheckAll('area[]')"/>接触流水号<br>
<input name="area[]" type="checkbox" id="area[]" seq="1" sql="t2.boss_login_no login_no" value="工号" onclick="judgeCheckAll('area[]')"/>工号<br>
<input name="area[]" type="checkbox" id="area[]" seq="2" sql="to_char(listentime,'yyyy-MM-dd hh24:mi:ss')" value="时间" onclick="judgeCheckAll('area[]')"/>时间<br>
<input name="area[]" type="checkbox" id="area[]" seq="3" sql="filepath" value="文件路径" onclick="judgeCheckAll('area[]')"/>文件路径<br> 
