...
<table id="sQryCnttOnlyTable">
			<tr>
				...
				<td  align="left"  width="70%" ><input name="search" type="button"   class="b_text"  id="search" value="关闭" onClick="window.close();return false;"><input name="search" type="button"   class="b_text"  id="search" value="保存" onClick="saveTreeData();return false;"><input name="search" type="button"   class="b_text"  id="search" value="取消" onClick="unCheckBoxs();return false;">
				</td>
			</tr>	
			<tr>
				<td colspan="2">
