...
<%
    ...
    sqlStr = "select CONTACT_ID,to_char(BEGIN_DATE,'yyyy-MM-dd hh24:mi:ss'),CALLER_PHONE,ACCEPTID,CUST_NAME,ACCEPT_PHONE,CONTACT_PHONE,FAX_NO,grade_code,ACCEPT_LOGIN_NO,SERVICECITY,REGION_CODE,to_char(ACCEPT_LONG),CONTACT_PHONE,CONTACT_PHONE,CALLEE_PHONE,MAIL_ADDRESS,CONTACT_ADDRESS,BAK,TRANSFER_BAK from "+tableName+" where CONTACT_ID=:contact_id";
    myParams="contact_id="+contact_id ;
%>	
					<wtc:service name="TlsPubSelCrm" routerKey="region" routerValue="<%=regionCode%>"  outnum="20">
...
<%@ include file="/npage/include/header.jsp"%>
   ...
   <input name="search" type="button"  id="search" value="查询" onClick="submitInput('k171_2_callDetail.jsp?myaction=doLoad')"> &nbsp;&nbsp;
    ...
    <!-- THE FIRST LINE OF THE CONTENT -->
	  ...
	  <!-- THE THIRD LINE OF THE CONTENT -->
	   ...
	   <tr >
	     <td > 备注 </td>
	     <td colspan="7">
<%=(dataRows.length!=0 && dataRows[0][18].length()!=0)? dataRows[0][18]:" &nbsp;"%>
	     </td> 
	    </tr>
	  ...
	  <!-- THE SEVENTH LINE OF THE CONTENT -->
	   <tr >
	     <td > 转接备注 </td>
	     <td colspan="7">
<%=(dataRows.length!=0 && dataRows[0][19].length()!=0)? dataRows[0][19]:" &nbsp;"%>
	     </td>
		</table> 
