	...
	<head>
		...
		<script language="javascript">
			...
			function SendValueToParent(py, img){
			  ...
			  if(op_code=="240"){
			  	 alert(op_code);
			  	alert(window.opener.sitechform.errorclassid);
			    window.opener.sitechform.errorclassid.value=py.id;
			    window.opener.sitechform.errorclassName.value=py.innerText;
			  }else if(op_code=="250"){
			  	 alert(op_code);
			  	alert(window.opener.sitechform.errorclassid);
			    window.opener.sitechform.errorclassid.value=py.id;
			    window.opener.sitechform.errorclassName.value=py.innerText;
			  	 ...
			  	 alert(op_code);
			  	alert(window.opener.sitechform.qcserviceclassid);
			    window.opener.sitechform.qcserviceclassid.value=py.id;
			    window.opener.sitechform.qcserviceclassName.value=py.innerText;
			  }
			  window.close();
			}
