...
function onDbClickSelect(){
  // 访问另外一个框架页面
	 if(tree.getUserData(tree.getSelectedItemId(),"isleaf")=='Y'){
		//window.opener.document.getElementById("beQcObjId").value=tree.getSelectedItemId();
	  //window.opener.document.getElementById("beQcObjName").value=tree.getSelectedItemText();
