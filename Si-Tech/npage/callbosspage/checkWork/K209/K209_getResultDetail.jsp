...
<%
 ...
 String regionCode = org_code.substring(0,2);
    ...
    sqlStr = "select "                                             
            ...
            +"t3.object_name,   " //被检对象
            +"t4.name,          " //考评内容
            +"to_char(decode(substr(to_char(trim(t1.score)),0,1),'.','0'||to_char(trim(t1.score)),to_char(t1.score)))," //总得分
            ...
            +"t1.signataryid,   " //确认人
            +"to_char(t1.affirmtime,'yyyyMMdd hh24:mi:ss'),    " //确认日期
