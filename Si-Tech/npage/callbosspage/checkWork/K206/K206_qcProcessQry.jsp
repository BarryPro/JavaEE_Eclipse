...
<%
    ...
    String[] strHead= {"操作","流水号","类型","业务流水号","状态","处理工号","生成工号","生成时间"};
  ...
  <div id="Operation_Table">
    ...
    <tr >
      ...
      <table  cellSpacing="0" >
          ...
          <tr >
            <th align="center" class="blue" width="11%" > 操作 </th>
            <th align="center" class="blue" width="18%" > 流水号 </th>
            <th align="center" class="blue" width="11%" > 类型 </th>
            <th align="center" class="blue" width="18%" > 业务流水号 </th>
            <th align="center" class="blue" width="10%" > 状态 </th>
            <th align="center" class="blue" width="11%" > 处理工号 </th>
            <th align="center" class="blue" width="11%" > 生成工号</th>
            <th align="center" class="blue" width="15%" > 生成时间 </th>
          </tr>
