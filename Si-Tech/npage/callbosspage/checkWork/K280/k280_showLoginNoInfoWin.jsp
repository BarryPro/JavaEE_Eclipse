...
function findMemberMsg(flag,loginNo){
  var packet = new AJAXPacket(<%=request.getContextPath()%>"/npage/callbosspage/checkWork/K280/k280_getMemberInfoList.jsp","aa");
...
<form id=sitechform name=sitechform>
	<div id="Operation_Table">
      ...
      <input type="radio" name="findType" id="findType" value="1">按工号名</input>
  		...
  		<td width="55%">
      <input type="text" name="loginNo" id="loginNo" value="" size="15">
