 ...
 String regionCode = org_code.substring(0,2);
  ...
  String sql = "";
	...
	if(opType.equals("add")){
		...
		parent_error_class_id = parentnod;
	...
	<head>
		...
		<script language="javascript">
			...
			function modCfm()
			{
				...
				else if(!checkElement(document.all("error_class_name"))) {
					similarMSNPop("输入值非法！");
					return;
	...
	<body>
		...
		<div id="Main">
			<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
		      ...
		      -->
		      <td valign="top">
		<div id="Operation_Title"><B>差错类别定义</B></div>
<!--add by zhengjiang 20090930 end-->
		<div id="Operation_Table" style="width: 100%;"><!-- guozw20090828 -->
			<!--modify by zhengjiang 20090930 增加<div id="title_zi"></div> -->
				<div class="title"><div id="title_zi">差错类别<%=title%></div></div>
				<table cellspacing="0">
					<tr>
						<td>
					...
					<tr>
						...
						<td>
							<div align="left"><input type="text" name="parent_error_class_id" value="<%=parent_error_class_id%>" maxlength="10" readonly/></div>
						</td>
					</tr>
					<tr>
						<td>
					...
					<tr>
						<td colspan="2">
							<div align="center">
								<input type="button" id="cfmfoot" name="cfm" class="b_foot" value="确认" onclick="modCfm()"/>
