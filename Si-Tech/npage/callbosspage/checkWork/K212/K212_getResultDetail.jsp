...
<%           
    	...
    	if(detailRecList.length>0){
         sqlStr="select t.item_name, t.formula, to_char(t.weight), t.item_id " +
               "from dqccheckitem t "+
...
<%              
    	   ...
    	   sqlStr = "select "
		            ...
		            + "t2.orgvalue, " //原始值
		            + "t1.item_id "   //考评项目id
		            + "from dqccheckitem t1, dqcinfodetail t2 where t1.object_id=:object_id and t1.contect_id=:contect_id  and t1.bak1='Y' and t2.serialnum= :serialnum ";
		      myParams = "object_id="+detailRecList[0][23]+",contect_id="+detailRecList[0][24]+",serialnum="+contact_id;
         ...
         sqlStr+=strJoinSql;
    	   for(int i=0;i<detailItemList.length;i++){
    	     	...
    	     	myParams = "object_id="+detailRecList[0][23]+",contect_id="+detailRecList[0][24]+",serialnum="+contact_id+",parent_item_id="+detailItemList[i][3];
%>	            
