...
//导出Excel
    public void toExcel(String[][] queryList,String[] strHead,HttpServletResponse response){
        ...
        String headname = "取消默认语种";//Excel文件名
        try {
...
function submitInputCheck(){
   if( document.sitechform.start_date.value == ""){
    	   showTip(document.sitechform.start_date,"受理号码不能为空"); 
  ...
  <div id="Operation_Table">
    ...
    <tr >
      ...
      <table  cellSpacing="0" >
          ...
          <tr >
            <th align="center" class="blue" width="20%" > 操作 </th>
            <th align="center" class="blue" width="40%" > 手机号码 </th>
            <th align="center" class="blue" width="40%" > 默认语种 </th>
          </tr>
