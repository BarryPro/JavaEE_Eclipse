...
//导出Excel
    public void toExcel(String[][] queryList,String[] strHead,HttpServletResponse response){
        ...
        String headname = "电子违规单";//Excel文件名
        try {
...
<%
    ...
    String opName="质检查询-电子违规单";
  	...
  	String sqlStr = "select CONTACT_ID,CUST_NAME,ACCEPT_PHONE,CALLER_PHONE,CALLEE_PHONE,to_char(BEGIN_DATE,'yyyy-MM-dd hh24:mi:ss'),ACCEPT_LONG,ACCEPT_LOGIN_NO,QC_LOGIN_NO,BAK,TRANSFER_BAK  from dcallcall200810";
    ...
    String[] strHead= {"操作","流水号","违规时间","违规工号","违规类型","巡查工号","附件名称","违规者电话","巡查者电话","确认","分数","违规详细记录"};
...
<%	if ("doLoad".equals(action)) {
      ...
      sqlTemp = strCountSql+sqlFilter;
        ...
        %>		           
           <wtc:service name="s151Select" outnum="12">
				...
				<wtc:array id="queryList"  start="1" length="11"   scope="end"/>
				<%
				dataRows = queryList;
    }
   ...
   if("all".equalsIgnoreCase(expFlag)){
     sqlStr+=sqlFilter;    
%>	
					<wtc:service name="s151Select" outnum="11">
...
function submitMe(){
   ...
   window.sitechform.action="K205_eViolationBill.jsp";
...
function expExcel(expFlag){
	  document.sitechform.action="<%=request.getContextPath()%>/npage/callbosspage/checkWork/K205/K205_eViolationBill.jsp?exp="+expFlag;
    keepValue();
    ...
    <!-- THE FIRST LINE OF THE CONTENT -->
      ...
      <td >
        ...
        <%if(op_type==null || op_type.equals("")|| request.getParameter("opType").equals("")|| request.getParameter("opType")==null){%>
		  	<option value="" selected>--所有违规类型--</option>
		  	<%}else {%>
      	 		<option value="<%=op_type%>" selected >
      	 			<%=request.getParameter("opType")%>
      	 		</option>
      	 	 	<option value="" >--所有违规类型--</option>
      	 	<%}%>
  ...
  <div id="Operation_Table">
    ...
    <tr >
      ...
      <table  cellSpacing="0" >
          ...
          <tr >
            <th align="center" class="blue" width="8%"  > 操作 </th>
            <th align="center" class="blue" width="10%" > 流水号 </th>
            <th align="center" class="blue" width="10%" > 违规时间 </th>
            <th align="center" class="blue" width="10%" > 违规工号 </th>
            <th align="center" class="blue" width="10%" > 违规类型 </th>
            <th align="center" class="blue" width="8%"  > 巡查工号 </th>
            <th align="center" class="blue" width="10%" > 附件名称</th>
            <th align="center" class="blue" width="8%"  > 违规者电话 </th>
            <th align="center" class="blue" width="8%"  > 巡查者电话 </th>
            <th align="center" class="blue" width="8%"  > 确认 </th>
            <th align="center" class="blue" width="8%"  > 分数 </th>
            <th align="center" class="blue" width="10%" > 违规详细记录 </th>            
          </tr>
