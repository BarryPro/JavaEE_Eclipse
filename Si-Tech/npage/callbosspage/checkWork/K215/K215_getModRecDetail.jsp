...
<%
    ...
    sqlStr = "select "                                             
            ...
            +"t1.modmemo        " //修改说明
            +"from dqcmodinfo t1,dqcobject t3,dqccheckcontect t4 where t1.serialnum=:contact_id ";  
...
<%           
        ...
        +"to_char(t1.score)"    //得分
        +"to_char(t1.orgvalue)" //原始值
        +"from dqcmodinfodetail t1,dqccheckitem t2 where t1.serialnum= :contact_id ";
      myParams = "contact_id="+contact_id;   
