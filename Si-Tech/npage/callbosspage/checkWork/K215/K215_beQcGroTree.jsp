...
function onDbClickNodeSelect(){        
  ...
  // 访问另外一个框架页面
		//window.opener.document.getElementById("beQcGroupId").value=tree.getSelectedItemId();
	  //window.opener.document.getElementById("beQcGroupName").value=tree.getSelectedItemText();
