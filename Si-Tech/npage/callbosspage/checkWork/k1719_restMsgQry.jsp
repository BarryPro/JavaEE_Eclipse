...
<%
    ...
    //String[] content= {"请假申请","休假中","正常销假","超时未销假","超时销假","取消请假申请"};
...
System.out.println("=========sqlFilter=========="+sqlFilter);
    if(sqlFilter==null || sqlFilter.trim().length()==0){
       ...
       // if(oper_code!=null && !oper_code.equals("")){
        //    sqlFilter = sqlFilter+" and  ='"+oper_code.trim()+"' ";
       // }
      }
    }
    ...
    <tr >
      ...
      <td>
       ...
       <input name="statText" type="hidden" value="<%=request.getParameter("statText")%>"> 
		  ...
		  <td >员工地市</td>
      <td>
      	<select id="oper_code" name="oper_code" size="1" >
             <option value="Y">省中心</option>   
        </select>
		  </td>     
     </tr>
