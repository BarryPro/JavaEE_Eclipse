...
function onClickNodeSend(){        
  ...
  // 访问另外一个框架页面
		//window.opener.document.getElementById("object_id").value=tree.getSelectedItemId();
	  //window.opener.document.getElementById("beCheckedGroName").value=tree.getSelectedItemText();
...
function initBaseTree(){	
    ...
    tree.setOnDblClickHandler(onClickNodeSend);
