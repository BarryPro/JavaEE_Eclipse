...
function onDbClickSelect(){
	 if(tree.getUserData(tree.getSelectedItemId(),"isleaf")=='Y'){
		//window.opener.document.getElementById("objectid").value=tree.getSelectedItemId();
		//alert(window.opener.document.getElementById("objectid").value);
	  //window.opener.document.getElementById("objectTypeName").value=tree.getSelectedItemText();
...
function initBaseTree(){	
          ...
          tree.setXMLAutoLoading(<%=request.getContextPath()%>"/npage/callbosspage/checkWork/K204/K280_createObjectIdTreeXml.jsp");      
          tree.setOnClickHandler(onNodeSelect);
          tree.setOnDblClickHandler(onDbClickSelect);
          tree.enableHighlighting(1);
          tree.loadXML(<%=request.getContextPath()%>"/npage/callbosspage/checkWork/K204/K204_createObjectIdTreeXml.jsp");   
...
function getTreeListByNodeId(strSelectedNodeid){
	var packet = new AJAXPacket(<%=request.getContextPath()%>"/npage/callbosspage/checkWork/K204/K204_getObjectIdChildTreeList.jsp","\u6b63\u5728\u5904\u7406,\u8bf7\u7a0d\u540e...");
