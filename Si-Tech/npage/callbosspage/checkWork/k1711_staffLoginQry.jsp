...
<%@ include file="/npage/include/header.jsp"%>
	<div id="Operation_Table">
		<div class="title">坐席签入签出班记录查询</div>
		<table cellspacing="0" >
  ...
  <div id="Operation_Table">
    ...
    <tr >
      ...
      <table  cellSpacing="0" >
          ...
          <tr >
            <th align="center" class="blue" width="10%" > 时间 </th>
            <th align="center" class="blue" width="10%" > 工号 </th>
            <th align="center" class="blue" width="10%" > 地址</th>
            <th align="center" class="blue" width="10%"  >类别</th>
          </tr>
