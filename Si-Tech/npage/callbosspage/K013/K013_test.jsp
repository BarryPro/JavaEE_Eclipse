...
<head>
	...
	{
		alert("Begin call doProcessK013()......");
	...
	function getLocalCfg()
	{
	    ...
	    var chkPacket = new AJAXPacket("<%=request.getContextPath()%>/npage/callbosspage/K013/K013.jsp","正在获取本机配置信息,请稍后...");
	    chkPacket.data.add("retType","sK013insert");
	    chkPacket.data.add("contact_id","111120081000000000000235");
	    ...
	    core.ajax.sendPacket(chkPacket,doProcessK013,true);
		chkPacket =null;
