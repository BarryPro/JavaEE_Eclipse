...
String sqlMulKfCfm="";
	...
	String workNo = (String)session.getAttribute("workNo");	// boss工号代码
     ...
     String sql_update="delete from dcallftpservercfg a where a.ftp_ip=:v1 and a.ftp_port=:v2 and a.ftp_dir=:v3&&"+ip+"^"+port+"^"+panfu;
	String sql_log="insert into dbcalladm.wloginopr(LOGIN_ACCEPT,OP_CODE,OP_TIME,OP_DATE,LOGIN_NO,ORG_CODE,PHONE_NO,IP_ADDR,OP_NOTE,FLAG,CALL_ID,CONTACT_ID,CONTACT_FLAG) values(seq_wloginopr.nextval,'K103',sysdate,to_char(sysdate,'yyyymmdd'),:v1,'','',:v2,:v3,'D','','','')&&"+workNo+"^"+myip+"^删除FTP配置信息,ip="+ip+" dir="+panfu;
