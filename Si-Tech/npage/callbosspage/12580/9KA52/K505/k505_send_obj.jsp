...
<% 
	...
	String[] arySql1 = new String[user_phone.length-1];
...
<%
	...
	for(int i = 1; i < user_phone.length; i++){
		...
		//		"sysdate,to_date('"+VALID_TIME+"','yyyy-MM-dd hh24:mi:ss'),'','"+shortmessage+"','','01','0','','0','01','"+scucc_flag+"','"+loginNo+"','"+callerphone+"' from dual";
