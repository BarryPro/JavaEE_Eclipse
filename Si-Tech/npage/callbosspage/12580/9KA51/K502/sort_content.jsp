	...
	<div id="Operation_Table">
		<table cellspacing="0">
			...
			<table cellspacing="0">
				<tr>
					<td class="blue" align="left" width="720">
						<input type="button" class="b_text" value="新增" onClick="addYjsp();" >&nbsp;
						<input type="button" class="b_text" value="删除" onClick="dodel();" >&nbsp;
						<input type="button" class="b_text" value="修改" onClick="doedit();" >
					</td>
				</tr>
			</table>
	</div>
