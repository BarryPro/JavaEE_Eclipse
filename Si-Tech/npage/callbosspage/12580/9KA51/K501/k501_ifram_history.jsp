...
<%
	...
	//查询条件
	String sqlTemp = "select to_char(count(*)) count  from SMS_PUSH_REC_LOG_12580 t where t.user_phone = '"+rphone+"'";
%>
...
<%
	...
	String dsql = "select to_char(t.insert_time,'yyyy-MM-dd HH24:MI:ss'),t.user_phone,t.send_content,caller_phone,'mubiao',t.success_flag,t.send_login_no "
			+ " from SMS_PUSH_REC_LOG_12580 t where t.user_phone = '"+rphone+"' order by t.insert_time desc,t.user_phone";
...
function doLoad(operateCode){
   ...
   window.sitechform.action="k501_ifram_history.jsp?rphone=<%=rphone %>";
