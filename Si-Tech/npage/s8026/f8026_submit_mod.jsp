...
<%  
	...
	try
	{   
	  	//acceptList = impl.callFXService("s8027_update",paramsIn,"2","region", regionCode);
%>

    <wtc:service name="s8027_update" outnum="2" retmsg="msg5" retcode="code5" routerKey="region" routerValue="<%=regionCode%>">
