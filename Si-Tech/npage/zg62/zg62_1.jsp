...
<!--	
   ...
   
  {
	...
	//alert(i_dp+" and retResult is "+retResult);
	...
	if(sm_code!="kh")
	{
		rdShowMessageDialog("只有kh品牌可以在该页面进行缴费!");
		return false;
	}
	/*else if(i_dp==0)
    {
		rdShowMessageDialog("非单品需在e006进行宽带缴费!");
		return false;
	}*/
	else
	{
  ...
  function getpasswd(){
  	...
  	document.frm.query.disabled=true;
   	var myPacket = new AJAXPacket("getKdNo_new.jsp","正在查询客户，请稍候......");
		...
		myPacket.data.add("return_page","zg62_1.jsp");
 ...
 function sel1()
 {
            window.location.href='zg62_1.jsp';
 }
 function sel2()
 {
           window.location.href='zg62_1.jsp';
...
<input type="hidden" name="op_code"  value="zg62">
 ...
 <%@ include file="/npage/include/header.jsp" %>   
		...
		<div class="title">
			<div id="title_zi">请选择缴费方式</div>
              ...
              <table cellspacing="0" >
                <tr> 
                  <td  class="blue" width="15%">铁通宽带号码</td>
                  <td> 
...
function querylast()
{
 ...
 function docheck()
 {
	document.frm.action="zg62_2.jsp";
    document.frm.submit();
}
