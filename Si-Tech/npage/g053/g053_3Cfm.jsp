<%
	...
	String filedownload = bak_dir+"invoice"+region_code+bank_code+from+to+".txt";//即将下载的文件的相对路径
//System.out.println("filedownload:"+filedownload);
    ...
    try
    {
		if(!f.exists())
		{
		   ...
		   out.println("<SCRIPT LANGUAGE=\"JavaScript\">alert(\"您下载的文件不存在!\");window.location.href=\"g053_3.jsp\";</SCRIPT>");	
		   throw new Exception("文件不存在请联系管理员");		   		
		}
		response.setContentType("APPLICATION/OCTET-STREAM"); 
		response.setHeader("Content-Disposition", "attachment;filename=\"" + "invoice"+region_code+bank_code+from+to+".txt" + "\""); 
