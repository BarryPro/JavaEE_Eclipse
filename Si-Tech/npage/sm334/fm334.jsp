...
<script type="text/javascript">
  onload=function()
  {
	...
	var myPacket = new AJAXPacket("fm334Qry.jsp","正在查询信息，请稍候......");
 ...
 function deleteoffer(offerid){
			  	//if(confirm("确定取消此条资费？"))
			  	if(rdShowConfirmDialog("确定取消"+offerid+"这条资费？")==1)
			{
       document.form1.action="fm334Cfm.jsp?offer_id="+offerid;
       document.form1.submit();
  		...
  		function frmCfm(){
				document.form1.action = "fm334Cfm.jsp";
   			document.form1.submit();
        return true;
      }
    ...
    function printInfo(printType){
 	...
 	function resetPage(){
 		window.location.href = "fm334.jsp?opCode=<%=opCode%>&opName=<%=opName%>&activePhone=<%=activePhone%>";
	}
