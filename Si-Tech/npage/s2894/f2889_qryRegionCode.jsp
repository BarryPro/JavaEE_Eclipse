...
<%
		...
		sqlStr1 = " select  region_code, region_name from ( " + 
	            ...
	            " and to_number(a.region_code)<=13 and  b.login_no ='" + loginNo + "' " + 
	            " union " +
	            " select a.region_code region_code , a.region_name region_name from sRegionCode a where region_code ='"+ regionCode+ "' and to_number(region_code)<=13 ) " + 
