...
<%
    ...
    System.out.println("----------------------------f7983_no_infor.jsp-------------------------------");
    ...
    String j1     = request.getParameter("j1");    //综合v网标记
    System.out.println("====wanghfa==== j1 = " + j1);
    ...
    if(!checkPhone(phone_no,session)){
         System.out.println("---------------------------非移动号码------------------------------");
         ...
         if("0".equals(zhww)){
         	    ...
         	    if("0".equals(phone_type))
         	      {
					...
					if ("1".equals(j1)) {
						sql = "select count(*) from dj1otherusermsg where phone_no='"+ phone_no +"'";
					} else {
						sql = "select count(*) from dvpmnotherusermsg where phone_no='"+ phone_no +"'";
					}
			...
			<wtc:array id="result" scope="end" />	
         	        ...
         	        if(iCountNum>0){
                         ...
                         error_code="-3";
						if ("1".equals(j1)) {
							error_msg="集团总机移动号码表中已经存在该号码"+phone_no+"，不能再添加!";
						} else {
							error_msg="智能网非移动号码表中已经存在该号码"+phone_no+"，不能再添加!";
						}
         	         }else{
