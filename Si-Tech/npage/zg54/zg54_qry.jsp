      ...
      <table cellspacing="0"  >
			...
			for(int i=0;i<sArr.length;i++)
			{
				%>
					<tr>
						...
						<a href="zg54_detail.jsp?loginaccept=<%=sArr[i][0]%>"><%=sArr[i][1]%></a></td>
		...
		<input type="hidden"  name="year_month" value="<%=year_month%>">
          ...
          <tr id="footer"> 
			...
			-->
    	      <input class="b_foot" name=back onClick="window.location = 'zg54_1.jsp'  " type=button value=返回>
...
<script language="JavaScript">
	...
	window.location="zg54_1.jsp?opCode=zg27&opName=增值税红字发票开具申请";
	</script>
<%}
%>
		<%
