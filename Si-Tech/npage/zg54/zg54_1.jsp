...
function xnjttj()
{
	...
	document.frm.action="zg54_qry.jsp?unit_id="+unit_id+"&year_month="+year_month;
...
<form action="" method="post" name="frm">
  ...
  <table cellspacing="0">
    <tr> 
      ...
      <td> 
        <input class="button"type="text" name="phoneNo" size="20" maxlength="20"  onKeyPress="return isKeyNumberdot(0)">
      </td>
    </tr>
	<tr> 
