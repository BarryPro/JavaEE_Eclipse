...
<%    	        
			...
			{
				 inParas_detail[1]="phone_No="+result[y][3];
				 %>
...
%>	
<tr>
 <td colspan=7 align="center"><input class="b_foot" name=back onClick="window.location.href='zg54_1.jsp'" type=button value=返回></td>
</tr>
	</TBODY>
	    </TABLE>
...
<div id="fade" class="black_overlay">
      <table cellspacing="0">
        <tbody> 
          <tr> 
      	    <td id=footer>
    	      &nbsp; <input class="b_foot" name=back onClick="zg54_1.jsp" type=button value=返回>
