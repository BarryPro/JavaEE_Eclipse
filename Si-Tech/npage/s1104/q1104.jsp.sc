...
<table cellSpacing=0>	
	<TR>
		<td class="blue" width="15%">账号ID </td>
	  <TD width="35%"><input type="text" name="contractNo" id="contractNo" class="required for0_9" size="16" maxlength="14" readonly>
