...
<%
	...
	/*20170613 校园营销完善需求*/
	String isType = WtcUtil.repNull(request.getParameter("isType"));
	String isFeeTypes = WtcUtil.repNull(request.getParameter("isFeeTypes"));
	...
	System.out.println("chenleig784==========isType="+isType);
	System.out.println("chenleig784==========isFeeTypes="+isFeeTypes);
	...
	if(isFeeTypes == null || "".equals(isFeeTypes)){
		isFeeTypes = "";
	}
%>
<%
...
//2010-7-7 9:04 wanghfa修改 铁通开户费用问题报文中费用的修改 end
            ...
            /*20170612 add 使用证件类型和反费规则*/
            if(!("".equals(isType))){
            	UType realUserUtype1= new UType();  
    			realUserUtype1.setUe("LONG","20401");
    			realUserUtype1.setUe("INT","0");  
    			realUserUtype1.setUe("STRING",isType);
    			UserExtMsgListUtype.setUe(realUserUtype1);
            }
            if(!("".equals(isFeeTypes))){
            	UType realUserUtype2= new UType();  
    			realUserUtype2.setUe("LONG","20402");
    			realUserUtype2.setUe("INT","0");  
    			realUserUtype2.setUe("STRING",isFeeTypes);
