...
%>
<input type="hidden" name="offerDetailQry_valid" id="offerDetailQry_valid" value="<%=valid%>" />
<input type="hidden" name="offerDetailQry_retCode" id="offerDetailQry_retCode" value="<%=errCode%>" />
<input type="hidden" name="offerDetailQry_retMsg" id="offerDetailQry_retMsg" value="<%=errMsg%>" />
<script>
