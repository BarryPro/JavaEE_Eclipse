...
<%
    ...
    System.out.println("# fgetBizTypeL.jsp -> iSmCode = "+iSmCode);
    
    String retCode = "";
    String retMessage = "";
    String sqlStr = "";
    try{
        sqlStr = "select distinct main_type,main_type||'->'||main_name from sbiztypecode where sm_code='"+iSmCode+"' and to_number(external_code)<=800  ";
        %>
