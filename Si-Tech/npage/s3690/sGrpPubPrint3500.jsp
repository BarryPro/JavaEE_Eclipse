...
<%
	...
	String  grp_user_no= request.getParameter("grp_user_no");
...
var startCol=18;
	var startRow=20;
    //基本信息 	
    printctrl.Print(startCol+45,startRow-6,10,0,"<%=in_work_no%>");       //登陆工号
    ...
    printctrl.Print(startCol-2,startRow+2,10,0,"集团用户ID: <%=grp_user_no%> ");        //联系地址
    printctrl.Print(startCol-2,startRow+3,10,0,"付费方式: <%=in_pay_type%>");        //证件号码
    printctrl.Print(startCol-2,startRow+4,10,0,"付费帐号：<%=account_id%>");        //证件地址
    ...
    printctrl.Print(startCol-2,startRow+30,10,0,"申请产品: <%=in_mode_name%>");      //
	...
	//备注类    
	printctrl.Print(startCol-2,startRow+41,10,0,"系统备注: <%=in_system_note%>");  
	printctrl.Print(startCol-2,startRow+42,10,0,"用户备注: <%=in_op_note%>"); 
