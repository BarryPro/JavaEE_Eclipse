	...
	function saveTo()
	{
	      ...
	      {     return false;   }
	       //返回单条记录
	        ...
	        opener.getvaluecustForAPro(retValue);
	        window.close();
	}
    ...
    try
    {
		...
		<%		
           ...
           // allNumStr = (String[][])retArray1.get(0);
			...
			System.out.println("3691~~~~recordNum="+recordNum);
		 	 System.out.println("3691~~~~Integer.parseInt(fieldNum)-1="+(Integer.parseInt(fieldNum)-1));
