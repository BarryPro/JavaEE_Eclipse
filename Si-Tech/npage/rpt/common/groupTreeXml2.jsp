...
if(isRoot==null||isRoot.length()==0){
	...
	if ("true".equals(isRoot)){
		String paraArr[] = new String[2];
		paraArr[0] = "select c.group_id,c.group_name from dloginmsg a,dchngroupinfo b,dchngroupmsg c where a.login_no=:loginNo and a.group_Id=b.group_id and b.denorm_level='1' and b.parent_group_id=c.group_id";
		paraArr[1] = "loginNo="+loginNo;
%>
		<wtc:service name="TlsPubSelCrm" retcode="errCode2" retmsg="errMsg2" outnum="3">
...
<%
	if(!errCode.equals("0") && !errCode.equals("000000")){
		...
		for (int i = 0; i < len; i++) {
			...
			//如果不是叶节点将作为目录
			if(flag.equals("N")){
				String url = "groupTreeXml2.jsp?groupId="+groupId2.trim()+"&groupName="+groupName2.trim();			  
