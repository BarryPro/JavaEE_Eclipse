...
<!--	
 ...
 function init()
 {
	...
	<%
		if(opCode1.equals("1768") ||opCode1=="1768")
		{
			%>	
				document.getElementById("sl1").checked=true;<%
		}
		if(opCode1.equals("4952") ||opCode1=="4952")
		{
              ...
              <table cellspacing="0">
                ...
                <tr> 
                  ...
                  <td colspan="3"> 
                    ...
                    <input name="busyType1" id="sl1" type="radio" value="1768" checked >
                    [1768]银行代收统计表
				          &nbsp;&nbsp;&nbsp;
					<input name="busyType1" id="sl2" type="radio" value="4952"  >
                    [4952]银行代收移动话费全省汇总表
...
function doCfm()
{
    ...
    for(var i=0;i<radios.length;i++)
	{
	 ...
	 if(radioButtonVal=="1768")
	 {
			frm.action="../../page/rpt/f1768.jsp?activePhone=<%=activePhone%>";
     }
	 if(radioButtonVal=="4952")
	 {
			frm.action="../rpt/f4952.jsp?activePhone=<%=activePhone%>";
     }
	 frm.submit();
}
<!--
