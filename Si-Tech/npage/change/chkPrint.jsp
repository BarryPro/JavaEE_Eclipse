...
function doPrint()
{
  ...
  try
  {
    ...
    var startRow=7;
		...
		printctrl.Print(startCol-10,startRow+7,10,0,oneTok(infoStr,"|",9));     //付款方式

        //大小写金额
		printctrl.Print(startCol,startRow+9,10,0,chineseNumber(oneTok(infoStr,"|",10)));
		printctrl.Print(startCol+35,startRow+9,0,0,oneTok(infoStr,"|",10));     
