...
<%
        ...
        try {
            /* ningtn 铁通宽带 */
        		...
        		kshString = CGI_PATH + "cp4141.sh" + " "; 	            paramterString = workNo + " " + phoneNo + " " + "78" + " " + "0" + " " + billTime + " " + predictionNO + " " + dateStr + " " + "26 "; 	            outFile = phoneNo + qryType + dateStr1 + ".txt"; 	            exePath = "/usr/bin/ksh " + CGI_PATH + "cp4141.sh " + paramterString + DETAIL_PATH + outFile + " " + "1" + " "+passWord;
					  ...
					  // 首页传递first，下一页传递next，上一页传递prev，尾页传递last
						$('#nextPage').click(function() {
							...
							if(parseInt(count) > 1) {
									...
									//alert("test location is "+location);
							}
						});
