...
<HTML>
	<HEAD>
		<TITLE>黑龙江BOSS-批量关闭客户语音功能</TITLE>
		<script language="JavaScript">
			...
			function form_load()
			{
				...
				else 
				{
					...
					var seled = $("#seled").val();
					document.form.action="f1008cfm1.jsp?remark="+document.form.remark.value+"&regCode="+"<%=regionCode%>"+"&sysAccept="+"<%=sysAccept%>"+"&seled="+seled;
			...
			function setOpNote()
			{
				...
				{
				  document.all.remark.value = "操作员："+document.all.loginNo.value+"进行了关闭语音功能的批量信息导入"; 
				}
				return true;
			}	
	...
	<BODY  onLoad="form_load();">
		<FORM action="f1008cfm1.jsp" method=post name=form ENCTYPE="multipart/form-data">
			...
			<div class="title">
				<div id="title_zi">批量信息导入---关闭客户语音</div>
			</div> 
			<table cellspacing="0">
		              <tbody> 
			              <tr> 
		       ...
		       <table  cellspacing="0">
		              <tbody> 
						...
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color="red">注意号码的正确性，否则会造成错误关停用户的语音功能</font>:<br>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;手机号码  回车<br>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;如： <br>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;13604511111 <br>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;13704511111 <br>
