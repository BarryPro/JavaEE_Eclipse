...
//	comImpl implSel = new comImpl();
//	ArrayList tmpSelList = implSel.spubqry32("15",sqlBuffer.toString());
...
//	ArrayList tmpSelList2 = implSel.spubqry32("6",sqlBuffer2.toString());
...
//	ArrayList tmpSelList3 = implSel.spubqry32("2",sqlBuffer3.toString());
