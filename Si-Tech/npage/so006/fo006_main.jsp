...
$("input[name='selType']").click(function(){
	...
	function doQueryApprove()
	{
		...
		var packet = new AJAXPacket("fo006_ajax_doQuery.jsp");
	...
	{
		window.open("fo006_TaxpayerView.jsp?UpCustId="+UpCustId+"&queryflag="+queryflag, "展示信息", "height=500, width=1000,top=200,left=450,scrollbars=yes, resizable=no,location=no, status=yes");
	}
		

	function uptTaxrel(CustIdRel,UpFlag)
	{
		var packet = new AJAXPacket("fo006_ajax_doApproveRel.jsp","请稍后...");
...
<table id="selTab">
	<tr>
		<th>查询类型</th>
		<td>
			<input type="radio" name="selType" value="2"  style="display:none" /> 
			<input type="radio" name="selType" value="3" checked />税务审批人
