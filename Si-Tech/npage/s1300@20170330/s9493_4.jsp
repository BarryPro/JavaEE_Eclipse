...
function sel4(){
 ...
 function init()
 {
	...
	String sql_init = "select S_INVOICE_NUMBER,E_INVOICE_NUMBER,INVOICE_CODE from WLOGININVOICE where LOGIN_NO = '"+login_no+"'  and flag='O' "; 
	%>
...
<BODY onload = "init()">
<form action="s9493_billPrint.jsp" method="post" name="frm">
