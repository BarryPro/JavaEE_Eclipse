...
<%
    String dzhm = request.getParameter("zzhm");
	String dzdm = request.getParameter("zzdm");
	String kyny = request.getParameter("zzkyny");
...
//select nvl(sum(xmdj*xmsl),0) from winvoice201702 where phone_no='15046775560' and  fp_hm='01184139' and fp_dm='023001600211';
	String s_invoice = "dinvoiceprint"+kyny;
	String[] inParas = new String[2];
	String s_money="";
	String s_flag="";
	inParas[0]="select to_char(nvl(sum(small_money),0)) from "+s_invoice+" where phone_no=:s_2 and  invoice_number=:s_3 and invoice_code=:s_4 and invoice_flag='1'";
