...
<SCRIPT language="JavaScript">
	...
	//	printctrl.Print(13, 13, 9, 0, "客户名称:<%=result[0][4].trim()%>     业务类别:<%=result[0][2].trim()%>      客户品牌:<%=sm_name%>");
		...
		if(smop_code.equals("b301")){
		%>
			printctrl.Print(16, 19, 9, 0, "本次发票金额:(小写)￥<%=result[0][9].trim()%> 大写金额合计:<%=result[0][8]%> 滞纳金：");					
		<%}
		else{%>
