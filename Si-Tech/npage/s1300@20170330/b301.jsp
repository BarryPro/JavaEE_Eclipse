...
function docheck()
{
  ...
  if( document.frm.phoneNo.value.length != 11 )
  {
   ...
   document.frm.action="s1300Cfm_td.jsp?phone="+document.frm.phoneNo.value+"&ispopmarket="+document.frm.ispopmarket.value;
...
<title>黑龙江BOSS-TD集团统付缴费</title>
</head>
<BODY>
<form action="" method="post" name="frm">
		<input type="hidden" name="busy_type"  value="1">
		<input type="hidden" name="op_code"  value="b301">
  ...
  <table cellSpacing="0">
    <tr> 
      <td id="footer"> 
          ...
          &nbsp;
		  <input type="button" name="return2" class="b_foot" value="关闭" onClick="javascript:window.location='/page/s1400/s4499.jsp'" >
       </td>
    </tr>
  </table>
