...
%>
  ...
  <tr> 
		...
		<div align="center">
			...
			<input type="button" name="return1" class="b_foot" value="返回" onClick="window.location='g139_1.jsp';">
...
<table cellspacing="0">
	...
	<tr> 
		...
		<td> 
		  	<input type="text" name="payMoney" value="<%=sPayMoney%>" onKeyPress="return isKeyNumberdot(1)" onkeydown="if(event.keyCode==13) DoCheck();">
		</td>
