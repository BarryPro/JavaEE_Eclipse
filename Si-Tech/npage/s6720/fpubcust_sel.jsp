...
<%
    //根据传人的Sql查询数据库，得到返回结果
            ...
            System.out.println("allNumStr[0][0]="+allNumStr[0][0].trim());
            System.out.println("recordNum="+recordNum);
            //wuxy alter 20090430 因申告修改 解决数组越界问题 将i<recordNum替换为i<result.length
      		for(int i=0;i<result.length;i++)
      		{
      		    ...
      		    {
      		        System.out.println("result["+i+"]["+j+"]="+result[i][j].trim());
                    if(j==0)
                    {
                        typeStr = "<TD>";
