...
<%
		...
		String astatus   	      = (String)request.getParameter("astatus");  
		...
		paraAray[12] = astatus;                         				 //groupId
		paraAray[13] = custName;                         				 //客户姓名
...
%>
	<wtc:service name="sm018Upd" outnum="1" retmsg="msg" retcode="code" routerKey="region" routerValue="<%=regionCode%>">
