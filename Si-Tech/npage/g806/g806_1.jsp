...
// 	alert(opCodeType.value);
	...
	{
		var checkPwd_Packet = new AJAXPacket("checkRegion.jsp","正在进行密码校验，请稍候......");
...
<form action="" method="post" name="frm">
	...
	<table cellspacing="0">
      ...
      <td colspan=5> 
        <select id="opCodeType" name="opCodeType" >
	...
	<tr >
      ...
      <td> 
        <input type="text" name="myffje" size="20" maxlength="20" onKeyPress="return isKeyNumberdot(1)" >
      </td>
      
	  <td class="blue">返费专款类型</td>
      <td> 
        <select id="ffzklx" name="ffzklx">
	...
	<tr>
      ...
      <td> 
        <input class="button"type="text" name="ffys" size="8" maxlength="8"  onKeyPress="return isKeyNumberdot(0)" >
      </td>
		  <td class="blue">消费月数</td>
      <td> 
        <input class="button"type="text" name="xfys" size="8" maxlength="8"  onKeyPress="return isKeyNumberdot(0)" >
      </td>
	</tr>
	<tr>
		 	<td class="blue">是否累积到次月</td>
      <td colspan=5> 
     		<select id="sfljcy" name="sfljcy">
					<option value="0" selected>--请选择</option>
