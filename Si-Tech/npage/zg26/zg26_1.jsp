...
function docheck()
{
	...
	else
	{
		...
		document.frm.tax_contract_no.value=returnValue.split(",")[6];
		document.frm.action="zg26_2.jsp";
	    document.frm.submit();
	}
...
function doProcess(packet)
{
	...
	if(s_flag=="Y")
	{
		document.frm.action="zg26_2.jsp?s_good_name="+s_good_name+"&s_ggxh="+s_ggxh+"&s_dw="+s_dw+"&s_sl="+s_sl+"&s_dj="+s_dj+"&s_je="+s_je+"&s_tax_rate="+s_tax_rate+"&s_se="+s_se+"&tax_number="+tax_number+"&tax_code="+tax_code+"&cust_id="+cust_id;
	    document.frm.submit();
	}
	else
	{
