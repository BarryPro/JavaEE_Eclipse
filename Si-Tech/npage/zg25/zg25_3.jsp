...
<%	
	...
	String radio_value =  request.getParameter("radio_value");//是否审批通过 0通过 1不通过
...
<script language="JavaScript">
	rdShowMessageDialog("审批办理成功！");
	window.location="zg25_1.jsp?opCode=zg25&opName=增值税红字发票开具申请";
	</script>
<%
	}else{
%>   
<script language="JavaScript">
	rdShowMessageDialog("审批办理失败: <%=retMsg%>,<%=sCode%>",0);
	window.location="zg25_1.jsp?opCode=zg25&opName=增值税红字发票开具申请";
	</script>
<%}
%>
