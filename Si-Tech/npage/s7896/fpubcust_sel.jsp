...
function saveTo()
{
      ...
      {     return false;   }
		...
		//alert(obj.busiFlag + ' ' + obj.phoneHeader);
...
%> 
            <wtc:service name="sGetGroupInit" routerKey="region" routerValue="<%=regionCode%>" retcode="retCode1" retmsg="retMsg1" outnum="26" >
            	<wtc:param value="<%=iccid%>"/>
            	<wtc:param value="<%=cust_id%>"/>
                <wtc:param value="<%=unit_id%>"/>
                <wtc:param value="<%=service_no%>"/>
                <wtc:param value="<%=regionCode%>"/>
                <wtc:param value="7896"/>
                <wtc:param value="m02"/>
...
<%
            ...
            int recordNum = result.length;
      		for(int i=0;i<recordNum;i++)
      		{
      		    ...
      		    for(int j=0;j<26;j++) /*diling update*/
      		    {
                    if(j==0)
                    {
                        typeStr = "<TD>";
