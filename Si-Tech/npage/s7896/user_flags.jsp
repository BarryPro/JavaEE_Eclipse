...
<%
  ...
  String requestType = request.getParameter("requestType"); /*操作选项：1-其他修改*/
  String[][] temfavStr = (String[][])session.getAttribute("favInfo");
	...
	if(operFlag&&"vp".equals(sm_code)&&"m02".equals(requestType)){
	  sele1disabledFlag = "";
	}
	...
	<div class="title">
        ...
        <table  cellspacing="0" >
          <tr> 
            ...
            <td >
            	<select name="FLAGS1" id="FLAGS1" <%=sele1disabledFlag%> >
            ...
            <td>
            	<select name="FLAGS2" id="FLAGS2" <%=sele1disabledFlag%> >
                <option value="0">0--&gt;禁止</option>
                <option value="1">1--&gt;市话</option>
                <option value="2">2--&gt;市话+省内</option>
                <option value="3">3--&gt;市话+省内+省外</option>
