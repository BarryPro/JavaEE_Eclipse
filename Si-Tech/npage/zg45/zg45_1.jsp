...
function xnjttj()
{
	...
	document.frm.action="zg45_qry.jsp?unit_id="+unit_id;
...
<form action="" method="post" name="frm">
  ...
  <table cellspacing="0">
    <tr> 
      ...
      <td> 
        <input class="button"type="text" name="phoneNo" size="20" maxlength="20"  onKeyPress="return isKeyNumberdot(0)" onKeyDown="if(event.keyCode==13) check_HidPwd();">
      </td>
