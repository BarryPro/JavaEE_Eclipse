...
<%
	...
	System.out.println("=====msType======"+msType);
	String inputSql = "select OFFER_ATTR_CHARACTER,OFFER_ATTR_VALUE from  product_offer_attr where offer_id = "+offerId+" and EXCLUABLITY='1' ";
%>	
