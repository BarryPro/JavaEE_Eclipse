...
%>
		<wtc:service name="sE999Cfm" routerKey="phone" routerValue="<%=srv_no%>" retcode="retCode1" retmsg="retMsg1" outnum="2" >
...
%>
      <script language="javascript">
	     	 rdShowMessageDialog("IMS固话过户成功！",2);  
         removeCurrentTab();
	    </script>
<%
   }else{
