...
function docheck()
{
  ...
  if( document.frm.phoneNo.value.length != 11 )
  {
   ...
   document.frm.action="e749_1_show.jsp";
...
<form action="" method="post" name="frm">
		...
		<input type="hidden" name="op_code"  value="e749">
  ...
  <table cellspacing="0">
    <tr> 
      <td class="blue" width="15%">查询方式</td>
        <td colspan="4"> 
          <input name="busyType1" id="busyType1" type="radio" onClick="sel1()" value="1" checked>全部优惠信息查询 
          <input name="busyType2" type="radio" onClick="sel2()" value="2"> 详细优惠信息查询 
				</td>
    </tr>
  </table>
  <table cellspacing="0">
