...
/*jingang@关于调整客户信誉度管理模式的需求增加了@'80','81','12','50','51','52','53','54','55','56'*/
	String sBillCond = "select owner_code,type_name  from scustgradecode  where owner_code not in('01','02','10','11','97','99','91','80','81','12','50','51','52','53','54','55','56') and region_code = '" + region_codeT + "'";
...
function resett(){
	...
	timeFlag=0;
	flag=0;
	window.location="f1256.jsp?activePhone=<%=activePhone%>";
}
</script>
<body>
...
<table cellspacing="0">
	...
	<tr align="center" id="footer">
		<td colspan="6">
			...
			<input class="b_foot" name=back type=button value="清除" onclick="window.location='f1256.jsp?activePhone=<%=activePhone%>'">
...
function printBill(){
	 ...
	 location.href="chkPrint.jsp?retInfo="+infoStr+"&dirtPage=f1256.jsp";                    
}
</script>
</BODY></html>
