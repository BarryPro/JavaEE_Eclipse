...
function query()
{
	...
	if(beginTime=="")
	{
		...
		document.frm1527.beginTime.focus();
		return false;
	}
	else
	{
		document.frm1527.action="zgbc_2.jsp?beginTime="+beginTime;
		frm1527.submit();
	}	
...
<TABLE cellSpacing=0>
    ...
    <TR> 
        ...
        <TD colspan=3>
            <input type="text" name="phoneNo" size="20" value="<%=activePhone%>" readonly  maxlength="11" >
            
        </TD>
    </TR>
	<TR> 
        <TD class=blue>查询时间</TD>
        <TD colspan=3>
            <input type="text" name="beginTime" size="20" value="<%=mon[0]%>" onKeyPress="return isKeyNumberdot(0)"  maxlength="8" >(YYYYMMDD)
