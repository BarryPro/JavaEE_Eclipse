...
%>
		<wtc:service name="s1234Cfm" routerKey="phone" routerValue="<%=activePhone%>" retCode="retCode1" retMsg="retMsg1" outnum="1" >
...
%>
				<script>
						...
						window.location="f1234.jsp?activePhone=<%=activePhone%>&opCode=<%=cnttOpCode%>&opName=<%=cnttOpName%>&broadPhone=<%=broadPhone%>";
				</script>
<%
		}else{
%>
