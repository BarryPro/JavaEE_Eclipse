		...
		<script language="JavaScript">
 		...
 		window.location.href='g273_1.jsp';
			...
			function setOpNote()
			{
				...
				{
				  document.all.remark.value = "操作员："+document.all.loginNo.value+"进行了二码合一投诉号码批量信息导入"; 
				}
				return true;
			}	
          ...
          <input name="busyType2" type="radio" onClick="sel2()" value="2"> 页面录入 
						  ...
						  <tr> 
				                ...
				                <td width="30%" colspan="2">
					                    <input type="text" size="30" class="InputGrey" readonly value="二码合一投诉号码批量信息导入">
				                </td>				               		              
		       ...
		       <table  cellspacing="0">
					  ...
					  <!--
						...
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color="red">录入的号码为2012年8月7日之前（不包括8月7日）激活的二码合一号码。</font><br>
						 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 文件内容为:手机号码  回车 如： <br>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;15004675829<br> 
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;15004675828<br> 
				                </td>
