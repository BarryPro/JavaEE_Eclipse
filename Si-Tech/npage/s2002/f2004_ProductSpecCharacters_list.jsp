...
<div id="form">
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
		<form id="bug_form" method="post" action="">			  
	      <tr>
	        <th width="25%" nowrap>产品属性代码</th>
	        <th width="25%" nowrap>属性名称</th>
	        <th width="50%" nowrap>枚举值</th>	        
	      </tr>
        <tbody>
<wtc:service name="s9100DetQry" outnum="7" routerKey="region" routerValue="<%=regionCode%>">
...
%>
  			  <tr 
				    ...
				    <td><a class="p_RatePlanID" style="cursor: hand;"><%=result[i][1]%></a>
					  &nbsp;</td>
					  <td class="p_Description"><%=result[i][2].trim()%>					  	
					  &nbsp;</td>
				    <td class="p_Description"><%=result[i][3].trim()%>&nbsp;					  	
					  &nbsp;</td>					 					 					 					 
	        </tr>
<%
       }
