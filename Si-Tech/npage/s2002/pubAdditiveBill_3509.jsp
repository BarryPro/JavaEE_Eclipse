...
<%
  ...
  //  	String smCode = request.getParameter("smCode");
	...
	String productId=request.getParameter("productId");
		...
		System.out.println("luxc:productId 有效");
		sqlStr=	"SELECT b.offer_attr_type,b.offer_attr_type,b.offer_id,b.offer_name,"
           +"       '0' CHOICED_FLAG,'1' MAX_OPEN"
           +"  FROM sproductspecmoderela  a,product_offer b,region c ,sregioncode f, dproductorderdet d,dpoorderrateInfo e "
           +" WHERE a.region_code = f.region_code  and f.group_id=c.group_id "
           +"   AND substr(b.user_range,1,1)=any('1','4') "
           +"   AND f.region_code = '" + regionCode + "'"
           +"   and a.offer_id=b.offer_id and b.offer_id=c.offer_id  "
           +"	and a.productspec_number=d.productspec_number and d.product_order_id=e.poorder_id "
           +"	and e.rate_attrcode='X2' and e.rate_code=a.product_rateplanid  "
           +"	and b.eff_date<=sysdate and b.exp_date>=sysdate and d.product_id='"+productId+"'";      	
