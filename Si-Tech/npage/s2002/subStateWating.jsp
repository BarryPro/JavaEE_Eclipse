...
<wtc:service name="s2029wfCfm" routerKey="region" routerValue="<%=regionCode%>" outnum="0"  retcode="Code" retmsg="Msg">
...
<script language="JavaScript">
		...
		window.location.replace("showStateWating.jsp");
</script>
<%
}else{
%>
