...
function doProcess(packet)
{
		var retType = packet.data.findValueByName("retType");
	   	...
	   	if(retType!="3")
	   	{
	   			if(retFlag!="0")
	   			{
	   				rdShowMessageDialog("变更属性不可修改失败"+retType);
					  return;
	   			}
	   			else
	   			{
...
<wtc:pubselect name="sPubSelect" outnum="9" routerKey="region" routerValue="<%=regionCode%>">
	<wtc:sql>
		select a.pospec_number,a.productspec_number,c.productspec_name,a.productcharacter_num,a.productcharacter_name,b.field_code,b.character_name,decode(substr(a.character_attr_code,2,1),'0','否','1','是') from dproductcharacterinfo a,sprodcharactercode b,dproductspecinfo c
...
<form name="form1" method="post" action="">	
  ...
  <table cellspacing=0>		
			...
			<tr>		
				...
				<th nowrap align='center'><b>是否为不可修改属性</b></th>
				<th nowrap align='center'><b>修改不可修改标志</b></th>
