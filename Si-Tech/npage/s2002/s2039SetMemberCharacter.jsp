...
{	
	...
	var spCode = document.all.spCode.value;    
 	var bizCode = document.all.bizCode.value;
	document.middle.location="s2039getMemberCharacter.jsp?sPOSpecNumber=" + spCode
...
function doSubmit(){
  ...
  //}
	...
	document.middle.document.form2.action="#"; 
    
	document.middle.document.form2.submit();
