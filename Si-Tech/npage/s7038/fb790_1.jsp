...
<%
   ...
   * 作者: leimd
   * 版权: si-tech
   * update:zhangyan 2011-11-2 9:02:20
  */
%>
...
function doSubmit()
{
	...
	if (queryType.value == "$$$$$$")
	{
		rdShowMessageDialog("查询类型必须选择！" , 0);
		return false;
	}
	var phone_no = document.getElementById("phone_no");
	if ( "0"==queryType.value )
	{
		if (""==phone_no.value)
		{
			rdShowMessageDialog("客户手机号码必须选择！" , 0);
			return false;		
		}		
		if ( !forPhone(phone_no) )
		{
			return false;
		}
	}
...
<table cellSpacing="0">
	<tr>
		...
		<td colspan="3">
			<select name = "queryType" id = "queryType" onchange = "showRows()">
				<option value = "$$$$$$">---请选择---</option>
				<option value = "0">按手机号</option>
				<option value = "1">按操作工号</option>
			</select>
		</td>
	</tr>
	<tr id = "phone_no_row" style = "display:none">
		<td class="blue">手机号</td>
		<td colspan="3">
			<input type="text" id = "phone_no" name="phone_no" maxlength="60">
