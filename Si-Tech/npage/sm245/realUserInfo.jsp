<TR id="realUserInfo1" > 
  ...
  <TD> 
    <input name="realUserName" id="realUserName" value="" v_type="string"  maxlength="60" size=20 index="19" v_maxlength=60 class="InputGrey" readonly v_must="1" />
 ...
 <TD class="blue" > 
  ...
  <TD> 
    <input name="realUserAddr" id="realUserAddr"  v_type="addrs"  size="45" index="21"  class="InputGrey" readonly v_must="1" v_maxlength="60" />
 ...
 <tr id="realUserInfo2" > 
  ...
  <td width=34%> 
    <select name="realUserIdType" id="realUserIdType" onchange="validateRealIdTypes(this.value)" v_must="1" >
    ...
    <input type="button" name="scan_idCard_two222" id="scan_idCard_two222" class="b_text"   value="读卡(2代)" onClick="Idcard2('22')" />
  </td>
  <td width=16% class="blue" > 
    <div align="left">实际使用人证件号码</div>
  </td>
  <td width=34%> 
    <input name="realUserIccId"  id="realUserIccId"  value=""  v_minlength=4 v_maxlength=20 v_type="string"  maxlength="18"    value="" class="InputGrey" readonly v_must="1" />
    <font class=orange>*</font>
    </td>
</tr>
