...
<%
		System.out.println("===gaopengSeeLog========= fm280CheckImei.jsp ==========");
		...
		String iFamImei =  request.getParameter("iFamImei");
		String iPhoneNoMem =  request.getParameter("iPhoneNoMem");
		...
		inputParsm[7] = iQryType;
		inputParsm[8] = iFamImei;
		inputParsm[9] = iPhoneNoMem;
...
try{		
%>
		<wtc:service name="sFamImeiChk" routerKey="region" routerValue="<%=regionCode%>"
...
<%
		...
		if("000000".equals(retCode)){
			...
			System.out.println("============ fm280CheckImei.jsp 失败==========");
		}
		}catch(Exception e){
			retCode11 = "444444";
