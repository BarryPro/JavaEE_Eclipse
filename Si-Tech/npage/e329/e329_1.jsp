...
function doCheck2()
{
    if (!<%=pwrf%>)//无免密权限 需要输入密码
	{
		...
		{
			var checkPwd_Packet = new AJAXPacket("pubCheckPwd_tt.jsp","正在进行密码校验，请稍候......");
...
{	
  ...
  if ( document.frm1527.beginTime.value >= '200201'&& (  ( 0 <= decmonth && decmonth<= 5 ) || ( 89 <= decmonth && decmonth<= 93 ) ))
	{
			document.frm1527.action="e329_2.jsp";
...
<div class="title">
	<div id="title_zi">宽带交费信息查询</div>
</div>
<input type="hidden" name="opCode"  value="e329">
...
<TABLE cellSpacing=0>
    <TR> 
        ...
        <TD>
            <select size="1" name="otherFlag" onchange="changsearchtype()">
                <option class=button value=0>宽带号码</option>
				<!--
    ...
    <TR> 
        ...
        <TD>
            <input type="text" name="phoneNo" size="25" maxlength="25" onKeyDown="if(event.keyCode==13){ return query() }"      >
