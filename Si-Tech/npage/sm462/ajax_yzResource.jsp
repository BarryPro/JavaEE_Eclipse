...
String propertyUnit = request.getParameter("propertyUnit")==null?"":request.getParameter("propertyUnit");
...
String relationProductName = request.getParameter("relationProductName")==null?"":request.getParameter("relationProductName");
...
*/
content=content+"CRM"+"|"+serviceOrder+"|"+yzFlag+"||13|"+customerCode+"|||"+relationProductName;

String iMsg=content;
System.out.println("传给应用集成平台数据是 " +iMsg);
String opName="宽带开户";
%>
<wtc:service name="sIMSYzResource" routerKey="region"   retcode="retcode" retmsg="retmsg"  outnum="2" >
	  <wtc:param value="<%=iMsg%>"/> 
		<wtc:param value="<%=opCode%>"/>   
		<wtc:param value="<%=loginNo%>"/>
		<wtc:param value="<%=setType%>"/>  	 	 	
</wtc:service>	
