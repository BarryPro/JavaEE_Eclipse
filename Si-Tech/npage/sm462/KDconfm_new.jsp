...
<%
  ...
  String standardCode = WtcUtil.repNull(request.getParameter("standardCode"));
	...
	String offerType = WtcUtil.repStr(request.getParameter("offerType"),"0");
  ...
  if("0".equals(ifMBH)){
	...
	String userpwd = WtcUtil.repStr(request.getParameter("userpwd"),"123123");	//密码加密
 ...
 //--------------产品群组-------------------------------
	...
	String cfm_login   = WtcUtil.repNull((String)request.getParameter("kuangdaiZhanghao"));  //宽带登录账号
	String cfmPwd = WtcUtil.repStr((String)request.getParameter("cfmPwd"),"123123");//宽带账号密码 
	...
	*/
	...
	String constructRequest=WtcUtil.repStr((String)request.getParameter("construct_request"),"无");//施工要求
	...
	String ipAddType=WtcUtil.repStr((String)request.getParameter("ipAddType"),"0");//标准地址名称
		         ...
		         if(isGPhoneFlag.equals("1")){  
		          	System.out.println("mylog--------------p拼过户的节点--------------GoodPhoneDate-------"+request.getParameter("GoodPhoneDate"));
		           	UType UserExtMsgUtypeh = new UType();
							...
							if(!"".equals(cfm_login)&&null!=cfm_login){
					...
					//		  UserExtMsgListUtype.setUe(UserExtMsgUtype11);
							...
							UType UserExtMsgUtype16= new UType(); /*端口编号*/
							  ...
							  String phone_h20104 = phoneNo_h;
								if("0".equals(phoneNo_h.substring(0,1))){
									phone_h20104 = phoneNo_h.substring(1);
								}
							UType UserExtMsgUtype17= new UType(); /*tel号码*/
								UserExtMsgUtype17.setUe("LONG","20127");
								UserExtMsgUtype17.setUe("INT","0");  
							  UserExtMsgUtype17.setUe("STRING","tel:+86"+phone_h20104);       
							  UserExtMsgListUtype.setUe(UserExtMsgUtype17);
							    
							UType UserExtMsgUtype18= new UType(); /*账号密码*/
								UserExtMsgUtype18.setUe("LONG","20128");
								UserExtMsgUtype18.setUe("INT","0");
							  UserExtMsgUtype18.setUe("STRING",cfmPwd);       
...
if(!"".equals(marketPhoneNo_58_88)){
					 ...
					 if("ONT".equals(kdZd))	{			
							UType UserExtMsgUtype42= new UType();  /*费用收取方式*/
									...
									if(!"2".equals(fysqfs)&&!"".equals(snNumber)&&"kf".equals(smCode)){
						...
						/* UType UserExtMsgUtype40= new UType();  //有线电视
									...
									UserExtMsgUtype40.setUe("STRING","");       
						...
						UType UserExtMsgUtype41= new UType();  //机顶盒ID
								...
								UserExtMsgUtype41.setUe("STRING","");       
						...
						*/
						...
						UType UserExtMsgUtype50= new UType();  /*IMS用户标识SUBID*/
						UserExtMsgUtype50.setUe("LONG","20100");
						UserExtMsgUtype50.setUe("INT","0");  
						UserExtMsgUtype50.setUe("STRING","86"+phone_h20104+"@ims.hl.chinamobile.com");
						UserExtMsgListUtype.setUe(UserExtMsgUtype50);
						
						
						
						UType UserExtMsgUtype51= new UType();  /*sip号码*/
						UserExtMsgUtype51.setUe("LONG","20104");
						UserExtMsgUtype51.setUe("INT","0");
						UserExtMsgUtype51.setUe("STRING","sip:+86"+phone_h20104+"@ims.hl.chinamobile.com");
						UserExtMsgListUtype.setUe(UserExtMsgUtype51);
						
						UType UserExtMsgUtype52= new UType();  
						UserExtMsgUtype52.setUe("LONG","20198");
						UserExtMsgUtype52.setUe("INT","0");  
						UserExtMsgUtype52.setUe("STRING",WtcUtil.repNull(request.getParameter("custAttr")));
						UserExtMsgListUtype.setUe(UserExtMsgUtype52);
						System.out.println("liangyl------------------"+request.getParameter("anzhuangFangshi"));
						UType UserExtMsgUtype53= new UType();  
						UserExtMsgUtype53.setUe("LONG","20300");
						UserExtMsgUtype53.setUe("INT","0");  
						UserExtMsgUtype53.setUe("STRING",request.getParameter("anzhuangFangshi"));
						UserExtMsgListUtype.setUe(UserExtMsgUtype53);
						
						UType UserExtMsgUtype54= new UType();  
						UserExtMsgUtype54.setUe("LONG","20301");
						UserExtMsgUtype54.setUe("INT","0");  
						UserExtMsgUtype54.setUe("STRING",phoneNo_h);
						UserExtMsgListUtype.setUe(UserExtMsgUtype54);
						
						UType UserExtMsgUtype55= new UType();  
						UserExtMsgUtype55.setUe("LONG","20302");
						UserExtMsgUtype55.setUe("INT","0");  
						UserExtMsgUtype55.setUe("STRING",cfmPwd);
						UserExtMsgListUtype.setUe(UserExtMsgUtype55);
						
						UType UserExtMsgUtype56= new UType();  
						UserExtMsgUtype56.setUe("LONG","20305");
						UserExtMsgUtype56.setUe("INT","0");  
						UserExtMsgUtype56.setUe("STRING","宽带");
						UserExtMsgListUtype.setUe(UserExtMsgUtype56);
						
						UType UserExtMsgUtype57= new UType();  
						UserExtMsgUtype57.setUe("LONG","20306");
						UserExtMsgUtype57.setUe("INT","0");  
						UserExtMsgUtype57.setUe("STRING",WtcUtil.repNull(request.getParameter("kuangdaiZhanghao")));
						UserExtMsgListUtype.setUe(UserExtMsgUtype57);
						
						UType UserExtMsgUtype58= new UType();  
						UserExtMsgUtype58.setUe("LONG","20307");
						UserExtMsgUtype58.setUe("INT","0");  
						UserExtMsgUtype58.setUe("STRING",WtcUtil.repNull(request.getParameter("kuandaiQuxian")));
						UserExtMsgListUtype.setUe(UserExtMsgUtype58);
	  ...
	  if(retCode=="0")
	  {
	    ...
	    var validVal = packet.data.findValueByName("validVal"); 
	  	...
	  	if(pageUrl.indexOf("sq046/fq046.jsp")!=-1){//没有与营销业务一起做,原逻辑不变
	  		tpageUrln = "/npage/sm462/fq046.jsp?gCustId=<%=gCustId%>"; /*diling update for 将ADSL宽带和手机用户 统一缴费页面个性化@2012/9/19 */ 
	  	}else{
