...
<BODY onload="OnInputPwd(document.all.inputpassword);" onBeforeUnload="CloseInputPort();" >
  ...
  <TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr > 
	  ...
	  <td height="25" class="blue"> 
        <div align="left">
		   <input name="inputpassword" type="password" maxlength="15" class="button"  onKeyPress="return isKeyNumberdot(0)" filedtype="pwd" functype="0">
		</div>
      </td>     
    </tr>
	  <tr> 
  ...
  <jsp:include page="/npage/se887/pwd_comm.jsp"/>
  </div>
</body>
</html>
