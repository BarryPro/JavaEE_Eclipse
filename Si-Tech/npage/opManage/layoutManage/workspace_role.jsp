	...
	<%@ include file="/npage/include/header_pop.jsp" %>
		...
		<div style="float:right;margin-right:10px">
			<table cellspacing="0">
				...
				<tr height="25px">
					<td class="blue">
						<input type="button"  class="b_text" id="up" value="上移" onClick="upDownFunc('moduleHide','up')"/>
				        <input type="button"  class="b_text" id="down" value="下移" onClick="upDownFunc('moduleHide','down');"/>
					</td>
					<td class="blue">&nbsp;</td>
				    <td class="blue">&nbsp;</td>
				</tr>
