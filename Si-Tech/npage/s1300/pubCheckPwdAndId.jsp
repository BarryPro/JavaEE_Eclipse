...
<%
   ...
   int i_count=0;
   inParas2[0]="select to_char(count (*))  from (select b.phone_no from dcustdoc a,dcustmsg b where a.cust_id = b.cust_id and b.phone_no=:phone_no and trim(a.id_iccid)=:id_card )  ";
   inParas2[1]="phone_no="+phone_no+",id_card="+id_card;	
   String s_flag="";
   String s_count="";
