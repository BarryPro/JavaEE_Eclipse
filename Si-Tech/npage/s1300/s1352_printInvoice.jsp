...
<%
	...
	//xl add for zlc 发票展示开票日期为sysdate 
	String s_sysdate="";
	...
	inParam_yyt[0]="select group_name,to_char(sysdate,'YYYYMMDD') from dchngroupmsg where group_id=:s_group_id";
...
{ 
	...
	<%
		...
		%>
	printctrl.Print(20, 10, 9, 0, "222开票日期:<%=s_sysdate.substring(0,4)%>年<%=s_sysdate.substring(4,6)%>月<%=s_sysdate.substring(6,8)%>日");
