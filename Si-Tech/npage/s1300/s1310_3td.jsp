...
function ifprint()
{
	    ...
	    {%>
				...
				else if(returnValue=="3")
				{
					...
					var s_hjse=0;
					var s_xmmc="td统付缴费冲正";//项目名称 crm可能为多条? 看下zg17多组怎么传的
					var s_ggxh="";
				...
				else
				{
					...
					document.frm_print_invoice.action="PrintInvoice_qx.jsp?opCode="+opCode+"&paySeq="+paySeq+"&phoneno="+phoneno+"&kphjje="+kphjje+"&s_hjbhsje="+s_hjbhsje+"&hjse="+s_hjse+"&returnPage="+return_page+"&hsbz=1&xmdj="+kphjje+"&contractno="+contractno+"&id_no="+id_no+"&sm_code="+sm_code+"&chbz=1&s_xmmc="+s_xmmc+"&paynote=缴费";
