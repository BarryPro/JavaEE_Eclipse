...
<%
   ...
   java.util.Random r = new java.util.Random();
	...
	String d1 = (new DecimalFormat("0.00")).format(Double.parseDouble(i_money_small) );
...
%>
			var myPacket = new AJAXPacket("PrintInvoiceInDB.jsp","正在进行发票底联入库操作，请稍候......");
<%    
		 ...
		 if(rdShowConfirmDialog("当前发票号码是"+"<%=check_seq%>"+",是否打印发票?")==1)
		 {
          ...
          <%
			...
			// begin
	          ...
	          out.println("printctrl.Print(110, 8, 9, 0,'发票号码:"+check_seq+"')"); 		
			  ...
			  out.println("printctrl.Print(13, 13, 9, 0,'合计金额：(大写)"+i_money+"')");
          ...
          %>
            ...
            document.location.replace("s1321_2.jsp");
          } catch(e) {
          } finally {
          }
		 }
