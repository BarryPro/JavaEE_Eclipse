...
<script language="JavaScript">   
	...
	function add_submit(){
		...
		var feeIndex_name = document.form1.feeIndex_name.value;
		...
		if(isNaN(feeIndex_code)){
			rdShowMessageDialog("主套餐编号不是数字,请您重新输入!");
			return false;
		}
		if(feeIndex_name==''){
...
<body>
  ...
  <form name="form1"  method="post" action="f809_addFeeIndex_submit.jsp">
   ...
   <DIV id="Operation_Table">                     
	...
	<div class="title">
		<div id="title_zi">添加智能网VPMN主套餐</div>
	</div>
				...
				<table cellspacing="0" >
	             ...
	             <%
	  					...
	  					<TD width="16%" class="blue">&nbsp;&nbsp;&nbsp;主套餐编号</TD>
	  					<TD width="34%" >
	  						<input type="text" name="feeIndex_code" maxlength="10"/>&nbsp;<font class="orange">*<font>
	  						&nbsp;</TD>
	  		 </tr>		
	  		 
	  		 <tr  height="22">				
	  					<TD width="16%" class="blue">&nbsp;&nbsp;&nbsp;主套餐名称</TD>
	  					<TD width="34%" >
	  							<input type="text" name="feeIndex_name" maxlength="18"/>&nbsp;<font class="orange">*<font>
	  						&nbsp;</TD>
