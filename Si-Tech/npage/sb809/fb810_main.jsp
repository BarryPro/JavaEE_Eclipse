...
String iOfferId       	=request.getParameter("feeIndex_code");
String iOfferAttrType="";
...
else
{
  ...
  %>
  	<wtc:service name="sb810Qry" routerKey="workno" routerValue="<%=iLoginNo%>"
		...
		<wtc:param value="<%=iOfferAttrType%>"/>
	</wtc:service>
	<wtc:array id="result" scope="end"/>

<%
	System.out.println("====zhangyan====fb810_main.jsp====  : " + retCode1 + "," + retMsg1 );
	int number = result.length;
	System.out.println("====zhangyan====fb810_main.jsp==== number = " + number);

	if (!retCode1.equals("000000")) {
	%>
		<script language="JavaScript">
			rdShowMessageDialog("sb810Qry代码：<%=retCode1%>，信息：<%=retMsg1%>",0);
			history.go(-1);
		</script>
	<%
	}
