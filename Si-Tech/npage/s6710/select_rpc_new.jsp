...
<%
    String retType = request.getParameter("retType");
	  String sqlStrNo = request.getParameter("sqlStrNo");
	  String sqlStrVal = request.getParameter("sqlStrVal");
   ...
   String regionCode = orgCode.substring(0,2);
	  ...
	  int recordNum1=0;
		...
		%>
		    <wtc:service name="sCrmDefSqlSel" routerKey="region" routerValue="<%=regionCode%>"  retcode="retCode1" retmsg="retMsg1" outnum="2">
