...
<%
		System.out.println("===liangylSeeLog========= fm407Qry.jsp ==========");
    ...
    inParamsMigu[0] = "select count(1) from dServOrderPrt"+nowMonth+" where op_code = 'm407' and login_accept =:login_accept order by op_time desc";
...
<%
		...
		if("000000".equals(retCode)){
			if(result_migu.length>0){
				System.out.println("liangylTest========================================"+result_migu[0][0]);
        if(Integer.parseInt(result_migu[0][0]) > 0){
			...
			System.out.println("============ fm407Qry.jsp 失败==========");
			miguFlag = "N";
		}
		}catch(Exception e){
			retCode11 = "444444";
