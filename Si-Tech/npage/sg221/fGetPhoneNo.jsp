...
%>
    <wtc:service name="sGetPhoneInfo" routerKey="region" routerValue="<%=regionCode%>" retcode="retCode" retmsg="retMsg" outnum="6" >
    	<wtc:param value="0"/>
    	<wtc:param value=""/>
      		    ...
      		    for(int j=0;j<Integer.parseInt("6");j++)
      		    {
                    ...
                    if(j==3)  {
                    	...
                    	distyle="block";
          		        ...
          		        inputStr = inputStr + "<TD title=\'"+(result[i][j])+"\' class='"+tdClass+"' style='display:"+distyle+"'>&nbsp;" + (result[i][j]) + "<input type='hidden' " +
          		            " id='Rinput" + i + j + "'  value='" + 
          		            (result[i][j]) + ","+(result[i][4]) + ","+(result[i][5])+"' readonly></TD>";          		            
                    }         		            
      		    }
