...
<%
		...
		String checkSql = "select root_distance from dloginmsg a,dchngroupmsg b where a.login_no = '"+createLoginNo+"' and a.group_id = b.group_id";
...
<%
		...
		/*zhangyan 如果是客服工号就不关联root_distance*/
		...
		if (accountType.equals("2"))
		{
			getAuditLoginSql = "select login_no, login_name "
				...
				+" in (select parent_group_id from dChnGroupInfo  where group_id = '"+groupId+"' )"
				+" and root_distance='4'  )" ;
			System.out.println("zhangyan getAuditLoginSql="+getAuditLoginSql);
