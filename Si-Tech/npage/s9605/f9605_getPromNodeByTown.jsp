...
<%
		...
		String getTownSql = "select group_id,group_name from dChnGroupMsg where group_id in (select group_id from dChnGroupInfo where parent_group_id = '"+prom_group_id+"' and denorm_level = 1) and class_code in ('6','202','203','5','50')";
