...
<%
			if("000000".equals(code1)){
				System.out.println("$$$$$$$$$$$$$ ningnt 调用sd287Qry成功  " + code1 + " | " + msg1);
...
<html>
	...
	<script language="javascript">
			function doChange(radioObj){
				...
				parent.document.all.msgCode.value=impArr[12];
				parent.document.all.msgCodeHide.value=impArr[12];
				parent.document.all.msgNote.value=impArr[0];
				parent.document.all.msgNoteHide.value=impArr[0];
				...
				/* 提示类型 */
				parent.document.all.iPromptType.value=impArr[10];
				parent.document.all.iPromptTypeHide.value=impArr[10];
				parent.document.all.iPromptType.disabled = true;
				/* 提示序号 */
				parent.document.all.iPromptSeq.value=impArr[3];
				parent.document.all.iPromptSeqHide.value=impArr[3];
...
%>
					<tr align="center" id="row_<%=i%>">
						...
						<td style="word-break:break-all" class="<%=tbclass%>"><%=impResultArr[i][4]%>&nbsp;</td>
