...
var item=document.getElementById("tb2"); 
...
{ 
   ...
   { 
   		if(j==3){
  		 oSheet.Cells(i+1,j+1).value = item.rows(i).cells(j).innerText.substring(0,2); 
  	  }else{
...
<div class="title">
	<div id="title_zi">受理结果&nbsp;<input type="button" value="导出到EXCEL" class="b_text" onclick="saveToExcel()"></div>
</div>
