...
%>
	<wtc:service name="se631Cfm" retcode="retCode1" retmsg="retMsg1" outnum="3" >
...
<script language="JavaScript">
	rdShowMessageDialog("集团补做托收失败！",0);
	window.location.href="e631_1.jsp?opCode=<%=opCode%>&opName=<%=opName%>";
</script>
<%}%>

<%if(!errorCode.equals("000000")){%>
<script language="JavaScript">
	rdShowMessageDialog("集团补做托收失败，错误代码:<%=errorCode%><%=errorMsg%>。",0);
	window.location.href="e631_1.jsp?opCode=<%=opCode%>&opName=<%=opName%>";
</script>
<%}else{%>
	<script language="JavaScript">
