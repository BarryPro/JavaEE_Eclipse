...
//关于11月上旬集团客户部CRM、BOSS和经分系统需求的函-3-ESOP系统中新增商机管理支撑内容 liangyl 20160823
  ...
  %>
            <script language="JavaScript">
                ...
                var cusId = "<%=custId%>";
                          ...
                          /*begin diling update for 集团开户后，直接跳转到1902·集团合同协议录入模块 @2012/5/28 */
                          if("<%=ownerType%>"=="02"||"<%=ownerType%>"=="04"){
                            parent.addTab(true,"to1902","集团合同协议录入",'../s1901/f1902_main.jsp?gCustId='+custId+'&loginType='+loginType+'&phone_no='+phone_no+'&activePhone='+phone_no);
                          }	
