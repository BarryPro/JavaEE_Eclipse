...
else if (s_ajaxType.equals("doGetProdAA"))
{
	...
	try{
%>
	<wtc:service name="sg599QrySerAttr" outnum="14"
...
//	}
	...
	for (int i=0;i<rst_doGetProdAA.length;i++){
		...
		System.out.println("liangyl------------------------------------------------------");
//		System.out.println("liangyl---------"+rst_doGetProdAA[i][0]);
//		System.out.println("liangyl---------"+rst_doGetProdAA[i][1]);
//		System.out.println("liangyl---------"+rst_doGetProdAA[i][2]);
//		System.out.println("liangyl---------"+rst_doGetProdAA[i][3]);
//		System.out.println("liangyl---------"+rst_doGetProdAA[i][4]);
//		System.out.println("liangyl---------"+rst_doGetProdAA[i][5]);
//		System.out.println("liangyl---------"+rst_doGetProdAA[i][6]);
//		System.out.println("liangyl------------------------------------------------------");
		String ifNeeds="否";
		...
		<tr>
			...
			<td align="center">
				...
				<%}else if("select".equals(rst_doGetProdAA[i][5])){%>
					<select id="t_prodAADef" name="t_prodAADef_1">
						<%
							...
							for(int j=0;j<selectVal.length;j++){
								...
								%>
								<option value="<%=selValue[0]%>" <%=selValue[0].equals("2")?"selected='selected'":""%>><%=selValue[1]%></option>
								<%
							}
						%>
					</select>
			...
			<td align="center">
				<input type="text" name="t_prodAAIfNeeds_1" value="<%=ifNeeds%>" class="InputGrey" readOnly>
