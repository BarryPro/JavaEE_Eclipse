...
<%
	...
	String kdZdFee = "";
	String kdZd = "";
	if(("4977".equals(functionCode) || ("m028".equals(functionCode)) || ("m094".equals(functionCode)) || "e916".equals(functionCode)) && ("130".equals(orderStatus) || "131".equals(orderStatus) || "170".equals(orderStatus))){
