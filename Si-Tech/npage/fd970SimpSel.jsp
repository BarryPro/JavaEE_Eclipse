...
<%
    ...
    String vIccid = request.getParameter("vIccid");
    String vUnitId = request.getParameter("vUnitId");
    String vVpmnGrpNo = request.getParameter("vVpmnGrpNo");
    String sqlStr="select b.id_iccid,a.Unit_id,a.BOSS_VPMN_CODE,a.unit_name from dgrpcustmsg a,dcustdoc b where a.cust_id = b.cust_id ";
    if(vIccid != ""){
