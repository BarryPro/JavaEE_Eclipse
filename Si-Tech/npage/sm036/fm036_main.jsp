...
function query(){
	...
	var myPacket = new AJAXPacket("fm036_ajax_qryInfo.jsp","正在查询信息，请稍候......");
...
function subInfo(){
  ...
  var v_hlrCode = $("input[@name=qryRadio][@checked]").attr("v_hlrCode"); 
	var myPacket = new AJAXPacket("fm036_ajax_subInfo.jsp","正在查询信息，请稍候......");
