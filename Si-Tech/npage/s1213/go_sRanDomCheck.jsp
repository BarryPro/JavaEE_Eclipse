...
<%
	...
	String ipt_sRanDomSend        = WtcUtil.repNull(request.getParameter("ipt_sRanDomSend"));
	String ipt_sRanDomCheck        = WtcUtil.repNull(request.getParameter("ipt_sRanDomCheck"));
  ...
  String regionCode     = (String)session.getAttribute("regCode");
	...
	paraAray[6] = "";                                       //用户密码
	paraAray[7] = ipt_sRanDomSend;
	paraAray[8] = ipt_sRanDomCheck;	

	String serverName = "sRanDomCheck";
try{
%>
