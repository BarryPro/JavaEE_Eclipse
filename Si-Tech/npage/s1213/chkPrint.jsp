...
function printIt(packet){
    ...
    try
    {
		...
		/*liujian 2012-3-26 15:45:36 发票修改 begin */
		//              列       行               字体大小              字体粗细
		...
		printctrl.PrintEx(13, rowInit + 3,  fontType, fontSizeInit,vR, fontStrongInit,lineSpace,"工    号：");//工号
		...
		printctrl.PrintEx(13, rowInit + 6, fontType, fontSizeInit,vR, fontStrongInit,lineSpace,"合计金额：(大写)" + chineseNumber(oneTok(infoStr, "|", 10)));//合计金额(大写)
		printctrl.PrintEx(100,rowInit + 6, fontType, fontSizeInit,vR, fontStrongInit,lineSpace,"(小写)￥" + oneTok(infoStr, "|", 10));//金额(小写)
		...
		for(var i=0;i<getTokNums(busiStr,"~");i++) {
			if (i % 2 == 0) {
				...
				printctrl.PrintEx(100,rowInit + 9 + row,fontType, fontSizeInit,vR, fontStrongInit,lineSpace,oneTok(busiStr,"~",i+1));  //业务项目
				row ++;
			}
		}
		printctrl.PrintEx(20,rowInit + 15,fontType, fontSizeInit,vR, fontStrongInit,lineSpace,oneTok(infoStr, "|", 8));  //联系地址
		
		printctrl.PrintEx(20,rowInit + 16,fontType, fontSizeInit,vR, fontStrongInit,lineSpace,oneTok(infoStr, "|", 9));  //付款方式
		...
		/*liujian 2012-3-26 15:45:36 发票修改 end */
		//打印结束
        printctrl.PageEnd();
        printctrl.StopPrint();
    }
