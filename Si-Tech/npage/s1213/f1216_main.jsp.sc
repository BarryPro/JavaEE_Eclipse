...
<tr id=backDivsss style="display:none">
    ...
    <td width="19%" colspan=4>
    	<input type="text" name="contactPhone" v_must=1 id="contactPhone" size="14" v_minlength=0 v_maxlength=11 v_type=mobphone  v_name="客户联系电话" maxlength="11"  onBlur="if(this.value!=''){if(checkElement(document.all.contactPhone)==false){return false;}}" >
...
<tr style="display:none">
    ...
    <tr>
     ...
     <tr>
        ...
        <td colspan="3"><input  type="text" size="17" id="wxyuhya" name="wxyuhya"  class="InputGrey" readonly /></td>
    </tr>
    <tr>
