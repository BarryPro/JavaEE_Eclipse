...
<%
    System.out.println("----1213chk------chkTwoPrint.JSP------------");
...
function printIt(packet){
    ...
    try
    {
        ...
        printctrl.PrintEx(13, rowInit + 5, fontType, fontSizeInit,vR, fontStrongInit,lineSpace, "手机号码："+oneTok(infoStr, "|", 5));      //手机号码 
        ...
        printctrl.PrintEx(13, rowInit + 6, fontType, fontSizeInit,vR, fontStrongInit,lineSpace, "合计金额：(大写)"+chineseNumber(oneTok(infoStr, "|", 10)));
	    printctrl.PrintEx(100,rowInit + 6, fontType, fontSizeInit,vR, fontStrongInit,lineSpace, "(小写)￥"+oneTok(infoStr, "|", 10));
        ...
        printctrl.PrintEx(20, rowInit + 9, fontType, fontSizeInit,vR, fontStrongInit,lineSpace, "联系方式："+oneTok(infoStr, "|", 8));     //联系地址
        printctrl.PrintEx(20, rowInit + 10, fontType, fontSizeInit,vR, fontStrongInit,lineSpace, "付款方式："+oneTok(infoStr, "|", 9));     //付款方式
        printctrl.PrintEx(20, rowInit + 11, fontType, fontSizeInit,vR, fontStrongInit,lineSpace, "应退金额大写："+chineseNumber(zonghe));
        printctrl.PrintEx(20, rowInit + 12, fontType, fontSizeInit,vR, fontStrongInit,lineSpace, "应退金额小写："+zonghe);
      
        //业务项目
        var busiStr = oneTok(infoStr, "|", 11);
        
        printctrl.PrintEx(20, rowInit + 13,fontType, fontSizeInit,vR, fontStrongInit,lineSpace, "其中: ");
        printctrl.PrintEx(20, rowInit + 14, fontType, fontSizeInit,vR, fontStrongInit,lineSpace, "本金(元): "+benjin);
        printctrl.PrintEx(20, rowInit + 15,fontType, fontSizeInit,vR, fontStrongInit,lineSpace, "利息(元): "+lixi);
        printctrl.PrintEx(20, rowInit + 16, fontType, fontSizeInit,vR, fontStrongInit,lineSpace, oneTok(busiStr, "*", 2));
        printctrl.PrintEx(20, rowInit + 17, fontType, fontSizeInit,vR, fontStrongInit,lineSpace, oneTok(busiStr, "*", 1));
         
	    //操作员、收款员
        printctrl.PrintEx(13,29,fontType, fontSizeInit,vR, fontStrongInit,lineSpace,"开票：<%=work_no%>"); //操作员
		printctrl.PrintEx(37,29,fontType, fontSizeInit,vR, fontStrongInit,lineSpace,"收款：<%=work_no%>");//收款员 
        ...
        printctrl.PrintEx(20, rowInit + 9, fontType, fontSizeInit,vR, fontStrongInit,lineSpace, "销号用户预存款退款结算单据");   
        printctrl.PrintEx(20, rowInit + 10, fontType, fontSizeInit,vR, fontStrongInit,lineSpace, "应退金额大写："+chineseNumber(zonghe));
        printctrl.PrintEx(20, rowInit + 11, fontType, fontSizeInit,vR, fontStrongInit,lineSpace, "应退金额小写(元)："+zonghe);
        printctrl.PrintEx(20, rowInit + 12, fontType, fontSizeInit,vR, fontStrongInit,lineSpace, "其中    本金(元)："+benjin);
        printctrl.PrintEx(20, rowInit + 13, fontType, fontSizeInit,vR, fontStrongInit,lineSpace, "利息(元)："+lixi);
        printctrl.PrintEx(20, rowInit + 14, fontType, fontSizeInit,vR, fontStrongInit,lineSpace, "不可退预存(卡类预存或赠送预存)："+noBack);
