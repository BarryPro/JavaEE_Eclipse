...
<%
	String opCode="e054";
	String opName="WLAN网络覆盖查询";
	String workNo=(String)session.getAttribute("workNo");
	String regionCode=(String)session.getAttribute("regCode");
	String sql = "select group_id,group_name from dchngroupmsg where root_distance = '2' and group_type = '2'";
%>
<wtc:pubselect name="sPubSelect" outnum="2" retcode="retCode1" retmsg="retMsg1">
	<wtc:sql><%=sql%></wtc:sql>
</wtc:pubselect>
