...
<%
	...
	<tr>
		...
		<table width="70%" border="0" cellpadding="0" cellspacing="0" class="left table-01" style="margin-bottom:0;">
		  <tr>
			<th width="100">集团客户名称：</th>
			<td width="250"><%=cust_name[0][0]%> </td>

			<th width="100" align="left"> 客户编码： </th>
		  ...
		  <tr>
			...
			<th width="100" align="left"> 打印日期： </th>
 ...
 <script language="javascript">
  ...
  codebase="smsx.cab#Version=6,3,436,14">
	...
	<tr >
	 ...
	 <input type="button"  class="b_foot"value="返回" title="返回" onClick="window.location='q112_1.jsp?opCode=g120&opName=集团客户明细账单查询&crmActiveOpCode=g120'" /> &nbsp;&nbsp;&nbsp;&nbsp;
