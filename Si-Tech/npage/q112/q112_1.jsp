...
function docheck()
{
	if(frm.phoneNo.value=="" )
		{
			 rdShowMessageDialog("请输入合法的集团编码！",0);
			document.frm.phoneNo.focus();
		 	 return false;
		}
    ...
    document.frm.action="q112Cfm.jsp";
...
<form action="" method="post" name="frm"  >
	...
	<div class="title">
		<div id="title_zi">账单查询</div>
	</div>

	<input type="hidden" name="password"/>
	
<input type="hidden" name="busy_type"  value="1">
<input type="hidden" name="op_code"  value="e991">
			...
			<tr> 
				...
				<td>
					<select name="printway" onChange="change();">
						<option value="0" selected>按集团编码</option>
