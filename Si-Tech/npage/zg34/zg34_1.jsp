...
function docheck()
{
	...
	{
		rdShowMessageDialog("通用机打发票查询开始、结束时间必须全部输入!");
		return false;
	}
	else
	{
		document.frm.action="zg34_2.jsp";
		document.frm.submit(); 
	}	
...
<div class="title">
    ...
    <tr> 
      ...
      <td> 
        <input class="button"type="text" name="login_no" maxlength=4 size="20"  colspan=2     >
      </td>
    </tr>
	<tr> 
