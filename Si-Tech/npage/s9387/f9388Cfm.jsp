...
%>
	...
	<wtc:service name="s9388Cfm" routerKey="regionCode" routerValue="<%=regionCode%>"  retcode="errCode" retmsg="errMsg"  outnum="2" >
...
<%
		...
		{
			System.out.println("调用服务s9388Cfm in f9388Cfm.jsp 成功@@@@@@@@@@@@@@@@@@@@@@@@@@");
...
<%
		...
		{
			System.out.println("调用服务s9388Cfm in f9388Cfm.jsp 失败@@@@@@@@@@@@@@@@@@@@@@@@@@");
