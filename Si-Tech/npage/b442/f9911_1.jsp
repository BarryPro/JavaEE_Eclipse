...
function doProcess(packet){
        ...
        if(verifyType=="phoneno"){
                if( parseInt(error_code) == 0 ){
                        ...
                        //判断用户状态 
                       //alert( document.all.runname.value.substring(1,2));
...
function getUserInfo()
{
        ...
        /********* ningtn 2011-2-28 10:31:31 CRM客服系统需求
...
function changeBusyType(){       
        //document.all.phoneno.value=""; --gaopeng 修改 2012/7/12
                  ...
                  <td> 
                    <input type="text" name="phoneno" id="phoneno" maxlength="11" 
                    	readonly value ="<%=activePhone%>" onchange="chgPhone()">
										<input type="hidden" name="accountpassword" />
                  </td>
