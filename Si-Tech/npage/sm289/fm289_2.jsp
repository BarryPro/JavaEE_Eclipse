...
<%
  ...
  String regionCode = (String)session.getAttribute("regCode");
	...
	paraAray[5] = "";                                  //用户号码
	paraAray[6] = "";                                       //用户密码
	paraAray[7] = "特殊号码抽选";  //备注
  paraAray[8] = region_code;
  paraAray[9] = y_year_month;
  
  

	String serverName = "sM289Cfm";
try{
%>
		<wtc:service name="<%=serverName%>" outnum="7" retmsg="msg" retcode="code" routerKey="region" routerValue="<%=regionCode%>">
