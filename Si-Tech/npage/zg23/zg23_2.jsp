...
<%
	...
	inParas2[0]="select to_char(s_bank_code) from s_xf_info where region_code=:s_region ";
	inParas2[1]="s_region="+regionCode;
	String s_xf="";
%>
	<wtc:service name="TlsPubSelBoss" routerKey="phone" routerValue="15004675829"  retcode="retCode_1" retmsg="retMsg_1" outnum="1">
		...
		<HEAD><TITLE>增值税发票打印</TITLE>
			...
			<script language="javascript">
				function docheck()
				{
					...
					{ 
						//alert("营销类"); 
						document.frm1508_2.action="zg23_yx.jsp";//用新的页面 直接入表做审核
					...
					{ 
						...
						var xfxx = document.all.xfxx.value;
						...
						{
							rdShowMessageDialog("请输入销方账号信息!");
							return false;
						}
						else
						{
							document.frm1508_2.action="zg23_yj.jsp";//增加传递s_type_flag 1=营销类 2=月结类
							document.frm1508_2.submit();
						}
		...
		<div class="title">
			<div id="title_zi">请选择打印方式</div>
			  ...
			  <table cellspacing="0">
				...
				<table cellspacing="0">
					<tr>
						<td class="blue" colspan=6>销方单位信息展示</td>
					</tr>
					<tr>
						<td class="blue">销方银行账号:<input type="text" name="xfxx" value="<%=s_xf%>">(请客户经理确认银行账号信息,该账号将打印在专票上.)</td>
					</tr>
				</table>
				<table cellspacing="0">
					<tbody>
