...
%>
	<wtc:service name="bs_9001Cfm" routerKey="region" routerValue="<%=org_code.substring(0,2)%>" outnum="2" retcode="retCode" retmsg="retMsg">
...
%>	
 <script language="javascript">
	  rdShowMessageDialog("新版发票信息录入成功！");
...
%>
		<SCRIPT LANGUAGE="JavaScript">
			rdShowMessageDialog("新版发票信息录入失败!<br>错误代码：'<%=return_code%>'，错误信息：'<%=ret_msg%>'。");
			window.location.href="<%=return_page%>";
		</SCRIPT>
<%}
%>
