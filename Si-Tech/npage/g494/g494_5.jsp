...
function select_yyt()
{
	...
	var myPacket = new AJAXPacket("../e900/e900_select.jsp","正在获得营业厅信息，请稍候......");
	var sqlStr = "30";
...
<BODY>
<form action="g494_5Cfm.jsp" method="post" name="frm">
		<%@ include file="/npage/include/header.jsp" %>   
  	
		<div class="title">
			<div id="title_zi">新版铁通发票信息</div>
		</div> 
  ...
  <table cellspacing="0">
    <tr>
    <td align="left" class="blue" width="20%">起始发票号码:&nbsp;&nbsp;&nbsp;
      ...
      <td align="left" class="blue" width="20%">终止发票号码:&nbsp;&nbsp;&nbsp;
      ...
      <td align="left" class="blue" width="60%">发票代码:&nbsp;&nbsp;&nbsp;
    ...
    <tr>
    	<td align="left" class="blue" >地&nbsp;&nbsp;市&nbsp;&nbsp;名&nbsp;&nbsp;称:&nbsp;&nbsp;&nbsp;
        <select name="s_in_ModeTypeCode" style=width:40% onchange="select_change()">
          	<%=mode_options%>                   
          </select><font color="#FF0000">*</font>
      </td>
      <td align="left" class="blue" >区&nbsp;&nbsp;县&nbsp;&nbsp;名&nbsp;&nbsp;称:&nbsp;&nbsp;&nbsp;
        <select name="s_in_CaseTypeCode" style=width:40% onchange="select_yyt()">
          	<option value="">--请选择--</option>                   
          </select><font color="#FF0000">*</font>
      </td>
      <td align="left" class="blue" >营业厅:&nbsp;
        <select name="yingyt" style=width:85%>
          	<option value="">--请选择--</option>                   
          </select><font color="#FF0000">*</font>
      </td>     
    </tr>
