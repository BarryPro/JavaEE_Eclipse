...
%>
    ...
    <wtc:service name="s6714Init" outnum="19" retmsg="msg1" retcode="code1" routerKey="region" routerValue="<%=regionCode%>">
...
{   
	getAfterPrompt();	
		...
		document.form.action="f6714_2.jsp";
...
function doQuery()
    ...
    if(!forMobil(document.form.phone_no))
    {
	  ...
	  //alert(document.form.phone_no.value);
		document.form.action = "f6714_1.jsp?action=select";
		document.form.submit(); 
	}
              ...
              <td class="blue" >                     
               ...
               <font class="orange">*</font>
                ...
                <tr> 
                  ...
                  <td class="blue"> 
                    <input type="text" name="cust_id" maxlength="6" readOnly class = "InputGrey"   value="<%=sOutCustId%>">
                    <font class="orange">*</font>
                  </td>
                  <td class="blue">&nbsp;</td>
                  <td class="blue">&nbsp;</td>
                ...
                <tr> 
                  ...
                  <td class="blue" width="35%"> 
                    <input type="text" name="cust_name" readOnly class = "InputGrey"  value="<%=sOutCustName%>" >
