...
<%
  ...
  String memberNo = request.getParameter("member_no"); /* 成员号码*/
  String memberNoPass = request.getParameter("cus_pass"); /* 成员号码*/
...
<!--
 ...
 function showPrtDlg(printType,DlgMessage,submitCfm)
  ...
  function printInfo(printType)
  {
		...
		opr_info+="业务类型: 办理加入欢乐家庭业务|";
		opr_info += "<%=phoneNo%>号码办理<%=memberNo%>号码加入家庭，套餐生效后，将享受欢乐家庭优惠套餐。|";
 		note_info1+="您办理的加入办理欢乐家庭套餐当月办理次月生效。|";
