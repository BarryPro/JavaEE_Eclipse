...
<body class="sidebar_hidden">
					...
					<div class="container-fluid">
						...
						<ul class="nav user_menu pull-right">
							...
							<li class="dropdown"><a href="#" class="dropdown-toggle"
								...
								<c:if test="${sessionScope.globalUser!=null}">
										<img src="BBSUserControl?action=pic&id=${sessionScope.globalUser.id}" alt="请登录" class="user_avatar" /> 
										${sessionScope.globalUser.username}
								</c:if>		
									<b class="caret"></b></a>
								<ul class="dropdown-menu">
									<li><a data-toggle="modal" id="myl"
	...
	<script type="text/javascript">
		$(function() {
			var username = $.cookie('com.belong.username'); // 获得cookie
