            ...
            <div class="top-grids">
                ...
                <div class="col-md-4 resent-grid recommended-grid slider-top-grids">
                    ...
                    <div class="resent-grid-info recommended-grid-info">
                        <h3><a href="single.jsp" class="title title-info">Pellentesque vitae pulvinar tortor nullam
                ...
                <div class="col-md-4 resent-grid recommended-grid slider-top-grids">
                    ...
                    <div class="resent-grid-info recommended-grid-info">
                        <h3><a href="single.jsp" class="title title-info">Interdum pellentesque vitae pulvinar tortor
                ...
                <div class="col-md-4 resent-grid recommended-grid slider-top-grids">
                    ...
                    <div class="resent-grid-info recommended-grid-info">
                        <h3><a href="single.jsp" class="title title-info">Nullam interdum metus a imperdiet pellentesque
                            ...
                            <li>
                                <div class="animated-grids">
                                    <div class="col-md-3 resent-grid recommended-grid slider-first">
                                        ...
                                        <div class="resent-grid-info recommended-grid-info">
                                            <h5><a href="single.jsp" class="title">Varius sit sed viverra nullam viverra
                                                nullam interdum metus</a></h5>

                                            <div class="slid-bottom-grids">
                                                <div class="slid-bottom-grid">
                                                    <p class="author author-info"><a href="#" class="author">John
                                                        Maniya</a></p>
                                                </div>
                                    ...
                                    <div class="col-md-3 resent-grid recommended-grid slider-first">
                                        ...
                                        <div class="resent-grid-info recommended-grid-info">
                                            <h5><a href="single.jsp" class="title">Nullam interdum metus varius viverra
                                    ...
                                    <div class="col-md-3 resent-grid recommended-grid slider-first">
                                        ...
                                        <div class="resent-grid-info recommended-grid-info">
                                            <h5><a href="single.jsp" class="title">Nullam interdum metus viverra nullam
                            ...
                            <li>
                                <div class="animated-grids">
                                    <div class="col-md-3 resent-grid recommended-grid slider-first">
                                        ...
                                        <div class="resent-grid-info recommended-grid-info">
                                            <h5><a href="single.jsp" class="title">Varius sit sed viverra viverra nullam
                                                nullam interdum metus</a></h5>
                ...
                <div class="recommended-grids">
                    ...
                    <div class="col-md-3 resent-grid recommended-grid">
                        ...
                        <div class="resent-grid-info recommended-grid-info video-info-grid">
                            <h5><a href="single.jsp" class="title">Varius sit sed viverra viverra nullam nullam interdum
                                metus</a></h5>
                            <ul>
                                <li><p class="author author-info"><a href="#" class="author">John Maniya</a></p></li>
                                <li class="right-list"><p class="views views-info">2,114,200 views</p></li>
                    ...
                    <div class="col-md-3 resent-grid recommended-grid">
                        ...
                        <div class="resent-grid-info recommended-grid-info video-info-grid">
                            <h5><a href="single.jsp" class="title">Nullam interdum metus viverra nullam varius sit sed
                                viverra</a></h5>
                            <ul>
                                <li><p class="author author-info"><a href="#" class="author">John Maniya</a></p></li>
                                <li class="right-list"><p class="views views-info">2,114,200 views</p></li>
                    ...
                    <div class="col-md-3 resent-grid recommended-grid">
                        ...
                        <div class="resent-grid-info recommended-grid-info video-info-grid">
                            <h5><a href="single.jsp" class="title">Varius sit sed viverra nullam viverra nullam interdum
                                metus</a></h5>
                            <ul>
                                <li><p class="author author-info"><a href="#" class="author">John Maniya</a></p></li>
                                <li class="right-list"><p class="views views-info">2,114,200 views</p></li>
                    ...
                    <div class="col-md-3 resent-grid recommended-grid">
                        ...
                        <div class="resent-grid-info recommended-grid-info video-info-grid">
                            <h5><a href="single.jsp" class="title">Nullam interdum viverra nullam metus varius sit sed
                                viverra</a></h5>
                            <ul>
                                <li><p class="author author-info"><a href="#" class="author">John Maniya</a></p></li>
                                <li class="right-list"><p class="views views-info">2,114,200 views</p></li>
            ...
            <div class="footer-grids">
                ...
                <div class="footer-bottom">
                    <ul>
                        ...
                        <li><a href="#small-dialog5" class="play-icon popup-with-zoom-anim f-history f-help">Help</a>
                        </li>
                    </ul>
                </div>
            </div>
